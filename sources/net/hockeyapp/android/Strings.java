...
public class Strings {
    ...
    public static String get(int i) {
        return get((StringListener) null, i);
    }
    ...
    public static String get(StringListener stringListener, int i) {
        ...
        if (stringForResource != null || i < 0) {
            return stringForResource;
        }
        String[] strArr = ENGLISH;
        return i <= strArr.length ? strArr[i] : stringForResource;
    }
}
