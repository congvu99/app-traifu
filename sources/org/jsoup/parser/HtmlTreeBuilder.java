...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    private static final String[] TagSearchEndTags = {"dd", "dt", "li", "option", "optgroup", ContextChain.TAG_PRODUCT, "rp", "rt"};
    private static final String[] TagSearchList = {"ol", "ul"};
    private static final String[] TagSearchSelectScope = {"optgroup", "option"};
    private static final String[] TagSearchSpecial = {IntegrityManager.INTEGRITY_TYPE_ADDRESS, "applet", "area", "article", "aside", "base", "basefont", "bgsound", "blockquote", SDKConstants.PARAM_A2U_BODY, "br", "button", ShareConstants.FEED_CAPTION_PARAM, "center", "col", "colgroup", "command", "dd", "details", "dir", "div", "dl", "dt", "embed", "fieldset", "figcaption", "figure", "footer", "form", TypedValues.AttributesType.S_FRAME, "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "iframe", "img", MetricTracker.Object.INPUT, "isindex", "li", "link", "listing", "marquee", "menu", "meta", "nav", "noembed", "noframes", "noscript", "object", "ol", ContextChain.TAG_PRODUCT, "param", "plaintext", "pre", "script", "section", "select", AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE, "summary", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "title", "tr", "ul", "wbr", "xmp"};
    ...
    public void resetInsertionMode() {
        ...
        while (size >= 0) {
            ...
            if ("select".equals(nodeName)) {
                ...
                return;
            } else if (ShareConstants.FEED_CAPTION_PARAM.equals(nodeName)) {
                ...
                return;
            } else if (SDKConstants.PARAM_A2U_BODY.equals(nodeName)) {
                transition(HtmlTreeBuilderState.InBody);
                return;
    ...
    public String toString() {
        return "TreeBuilder{currentToken=" + this.currentToken + ", state=" + this.state + ", currentElement=" + currentElement() + JsonLexerKt.END_OBJ;
    }
}
