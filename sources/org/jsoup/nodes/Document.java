...
public class Document extends Element {
    ...
    public Element body() {
        return findFirstElementByTagName(SDKConstants.PARAM_A2U_BODY, this);
    }
    ...
    public Document normalise() {
        ...
        if (body() == null) {
            findFirstElementByTagName.appendElement(SDKConstants.PARAM_A2U_BODY);
        }
        normaliseTextNodes(head());
        normaliseTextNodes(findFirstElementByTagName);
        normaliseTextNodes(this);
        normaliseStructure("head", findFirstElementByTagName);
        normaliseStructure(SDKConstants.PARAM_A2U_BODY, findFirstElementByTagName);
        ...
        if (this.updateMetaCharset) {
            ...
            if (syntax == OutputSettings.Syntax.html) {
                ...
                if (node instanceof XmlDeclaration) {
                    ...
                    if (xmlDeclaration.attr("declaration").equals("xml")) {
                        xmlDeclaration.attr("encoding", charset().displayName());
                        if (xmlDeclaration.attr(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION) != null) {
