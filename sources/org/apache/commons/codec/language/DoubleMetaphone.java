...
public class DoubleMetaphone implements StringEncoder {
        ...
        if (charAt(str2, i4) == 'N') {
            ...
            if (contains(str2, i4, 2, "ER") || charAt(str2, i4) == 'Y') {
                ...
                if (!contains(str, 0, 6, "DANGER", "RANGER", "MANGER")) {
                    int i5 = i3 - 1;
                    if (!contains(str2, i5, 1, ExifInterface.LONGITUDE_EAST, "I") && !contains(str2, i5, 3, "RGY", "OGY")) {
            ...
            if (contains(str, i4, 1, ExifInterface.LONGITUDE_EAST, "I", "Y") || contains(str2, i3 - 1, 4, "AGGI", "OGGI")) {
    ...
    private int handleJ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i2 != 0 || contains(str, i2, 4, "JOSE")) {
            ...
            if (i2 == str.length() - 1) {
                doubleMetaphoneResult.append('J', (char) TokenParser.SP);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x007b, code lost:
        if (contains(r16, r9 + 1, 1, "M", "N", "L", androidx.exifinterface.media.ExifInterface.LONGITUDE_WEST) == false) goto L_0x007d;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
