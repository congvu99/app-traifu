...
public class HttpService {
    ...
    public void handleRequest(org.apache.http.HttpServerConnection r9, org.apache.http.protocol.HttpContext r10) throws java.io.IOException, org.apache.http.HttpException {
        /*
            ...
            r1 = 0
            org.apache.http.HttpRequest r2 = r9.receiveRequestHeader()     // Catch:{ HttpException -> 0x0083 }
            boolean r3 = r2 instanceof org.apache.http.HttpEntityEnclosingRequest     // Catch:{ HttpException -> 0x0081 }
            r4 = 200(0xc8, float:2.8E-43)
            if (r3 == 0) goto L_0x005b
            r3 = r2
            org.apache.http.HttpEntityEnclosingRequest r3 = (org.apache.http.HttpEntityEnclosingRequest) r3     // Catch:{ HttpException -> 0x0081 }
            boolean r3 = r3.expectContinue()     // Catch:{ HttpException -> 0x0081 }
            if (r3 == 0) goto L_0x0055
            org.apache.http.HttpResponseFactory r3 = r8.responseFactory     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.HttpVersion r5 = org.apache.http.HttpVersion.HTTP_1_1     // Catch:{ HttpException -> 0x0081 }
            r6 = 100
            org.apache.http.HttpResponse r3 = r3.newHttpResponse(r5, r6, r10)     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.protocol.HttpExpectationVerifier r5 = r8.expectationVerifier     // Catch:{ HttpException -> 0x0081 }
        ...
        L_0x002f:
            r3 = move-exception
            org.apache.http.HttpResponseFactory r5 = r8.responseFactory     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.HttpVersion r6 = org.apache.http.HttpVersion.HTTP_1_0     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.HttpResponse r5 = r5.newHttpResponse(r6, r0, r10)     // Catch:{ HttpException -> 0x0081 }
            r8.handleException(r3, r5)     // Catch:{ HttpException -> 0x0081 }
            r3 = r5
        L_0x003c:
            org.apache.http.StatusLine r5 = r3.getStatusLine()     // Catch:{ HttpException -> 0x0081 }
        ...
        L_0x005b:
            ...
            org.apache.http.HttpResponseFactory r1 = r8.responseFactory     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.HttpVersion r3 = org.apache.http.HttpVersion.HTTP_1_1     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.HttpResponse r1 = r1.newHttpResponse(r3, r4, r10)     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.protocol.HttpProcessor r3 = r8.processor     // Catch:{ HttpException -> 0x0081 }
        ...
        L_0x0072:
            ...
            r3 = r2
            org.apache.http.HttpEntityEnclosingRequest r3 = (org.apache.http.HttpEntityEnclosingRequest) r3     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.HttpEntity r3 = r3.getEntity()     // Catch:{ HttpException -> 0x0081 }
            org.apache.http.util.EntityUtils.consume(r3)     // Catch:{ HttpException -> 0x0081 }
            goto L_0x0093
        L_0x0081:
            r1 = move-exception
            goto L_0x0087
