...
public final class ContentType implements Serializable {
    ...
    public static final ContentType APPLICATION_FORM_URLENCODED = create(AbstractRequest.DEFAULT_CONTENT_TYPE, Consts.ISO_8859_1);
    ...
    public static final ContentType IMAGE_JPEG = create(Utils.MIME_TYPE_JPEG);
    ...
    public static final ContentType IMAGE_WEBP = create(Utils.MIME_TYPE_WEBP);
    ...
    static {
        ...
        WILDCARD = create(MimeType.UNKNOWN, charset2);
