    ...
    static final class Builder {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof DELETE) {
                ...
                parseHttpMethodAndPath(RequestHelper.REQUEST_POST, ((POST) annotation).value(), true);
            } else if (annotation instanceof PUT) {
                parseHttpMethodAndPath(RequestHelper.REQUEST_PUT, ((PUT) annotation).value(), true);
