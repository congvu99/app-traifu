...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public static androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat create(android.content.Context r6, int r7, android.content.res.Resources.Theme r8) {
        /*
            ...
            android.content.res.Resources r1 = r6.getResources()     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
            android.content.res.XmlResourceParser r7 = r1.getXml(r7)     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
            android.util.AttributeSet r2 = android.util.Xml.asAttributeSet(r7)     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
        L_0x000f:
            int r3 = r7.next()     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
            r4 = 2
        ...
        L_0x001a:
            ...
            androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat r6 = createFromXmlInner(r6, r1, r7, r2, r8)     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
            return r6
        L_0x0021:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
            throw r6     // Catch:{ XmlPullParserException -> 0x0030, IOException -> 0x0029 }
        L_0x0029:
            r6 = move-exception
