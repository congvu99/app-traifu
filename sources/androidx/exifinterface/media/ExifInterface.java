...
public class ExifInterface {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x010e, code lost:
        if (android.os.Build.VERSION.SDK_INT >= 21) goto L_0x0110;
     */
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:84:0x011f, code lost:
        r1 = new java.io.FileOutputStream(r14.mFilename);
     */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Removed duplicated region for block: B:108:0x0172  */
    /* JADX WARNING: Removed duplicated region for block: B:71:0x00fa A[ExcHandler: all (th java.lang.Throwable), Splitter:B:30:0x0075] */
    /* JADX WARNING: Removed duplicated region for block: B:81:0x010c A[Catch:{ Exception -> 0x013b, all -> 0x0138 }] */
    /* JADX WARNING: Removed duplicated region for block: B:84:0x011f A[Catch:{ Exception -> 0x013b, all -> 0x0138 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x002e:
            ...
            java.lang.String r3 = r14.mFilename     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            r4 = 0
            r6 = 21
            if (r3 == 0) goto L_0x0052
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            r3.<init>(r7)     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            goto L_0x0066
        L_0x0052:
            int r3 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            if (r3 < r6) goto L_0x0065
            java.io.FileDescriptor r3 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r3, r4, r7)     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            java.io.FileDescriptor r7 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            r3.<init>(r7)     // Catch:{ Exception -> 0x0185, all -> 0x0182 }
            goto L_0x0066
        L_0x0065:
            r3 = r1
        L_0x0066:
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x017e, all -> 0x017a }
            r7.<init>(r2)     // Catch:{ Exception -> 0x017e, all -> 0x017a }
            androidx.exifinterface.media.ExifInterfaceUtils.copy(r3, r7)     // Catch:{ Exception -> 0x0178, all -> 0x0176 }
            ...
            r3 = 0
            java.io.FileInputStream r7 = new java.io.FileInputStream     // Catch:{ Exception -> 0x00fe, all -> 0x00fa }
            r7.<init>(r2)     // Catch:{ Exception -> 0x00fe, all -> 0x00fa }
            java.lang.String r8 = r14.mFilename     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            if (r8 == 0) goto L_0x0086
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            java.lang.String r9 = r14.mFilename     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            r8.<init>(r9)     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            goto L_0x009a
        L_0x0086:
            int r8 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            if (r8 < r6) goto L_0x0099
            java.io.FileDescriptor r8 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            int r9 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r8, r4, r9)     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            java.io.FileDescriptor r9 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            r8.<init>(r9)     // Catch:{ Exception -> 0x00f5, all -> 0x00fa }
            goto L_0x009a
        L_0x0099:
            r8 = r1
        L_0x009a:
            java.io.BufferedInputStream r9 = new java.io.BufferedInputStream     // Catch:{ Exception -> 0x00ef, all -> 0x00fa }
            r9.<init>(r7)     // Catch:{ Exception -> 0x00ef, all -> 0x00fa }
            java.io.BufferedOutputStream r10 = new java.io.BufferedOutputStream     // Catch:{ Exception -> 0x00e9, all -> 0x00e5 }
            r10.<init>(r8)     // Catch:{ Exception -> 0x00e9, all -> 0x00e5 }
            int r11 = r14.mMimeType     // Catch:{ Exception -> 0x00e0 }
            r12 = 4
            if (r11 != r12) goto L_0x00ad
            r14.saveJpegAttributes(r9, r10)     // Catch:{ Exception -> 0x00e0 }
            goto L_0x00d4
        L_0x00ad:
            int r11 = r14.mMimeType     // Catch:{ Exception -> 0x00e0 }
            r12 = 13
            if (r11 != r12) goto L_0x00b7
            r14.savePngAttributes(r9, r10)     // Catch:{ Exception -> 0x00e0 }
            goto L_0x00d4
        L_0x00b7:
            int r11 = r14.mMimeType     // Catch:{ Exception -> 0x00e0 }
            r12 = 14
            if (r11 != r12) goto L_0x00c1
            r14.saveWebpAttributes(r9, r10)     // Catch:{ Exception -> 0x00e0 }
            goto L_0x00d4
        L_0x00c1:
            int r11 = r14.mMimeType     // Catch:{ Exception -> 0x00e0 }
            r12 = 3
        ...
        L_0x00ca:
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataOutputStream r11 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataOutputStream     // Catch:{ Exception -> 0x00e0 }
            java.nio.ByteOrder r12 = java.nio.ByteOrder.BIG_ENDIAN     // Catch:{ Exception -> 0x00e0 }
            r11.<init>(r10, r12)     // Catch:{ Exception -> 0x00e0 }
            r14.writeExifSegment(r11)     // Catch:{ Exception -> 0x00e0 }
        L_0x00d4:
        ...
        L_0x0101:
            ...
            r8 = r10
        L_0x0103:
            java.io.FileInputStream r11 = new java.io.FileInputStream     // Catch:{ Exception -> 0x013f, all -> 0x013d }
            r11.<init>(r2)     // Catch:{ Exception -> 0x013f, all -> 0x013d }
            java.lang.String r1 = r14.mFilename     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            if (r1 != 0) goto L_0x011f
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            if (r1 < r6) goto L_0x0127
            java.io.FileDescriptor r1 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            int r6 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r1, r4, r6)     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            java.io.FileOutputStream r1 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            java.io.FileDescriptor r4 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            r1.<init>(r4)     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            goto L_0x0126
        L_0x011f:
            java.io.FileOutputStream r1 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            java.lang.String r4 = r14.mFilename     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            r1.<init>(r4)     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
        L_0x0126:
            r8 = r1
        L_0x0127:
            androidx.exifinterface.media.ExifInterfaceUtils.copy(r11, r8)     // Catch:{ Exception -> 0x013b, all -> 0x0138 }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r11)     // Catch:{ all -> 0x0168 }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r8)     // Catch:{ all -> 0x0168 }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x0168 }
            java.lang.String r1 = "Failed to save new file"
            r0.<init>(r1, r7)     // Catch:{ all -> 0x0168 }
        ...
        L_0x013f:
            ...
            r1 = r3
        L_0x0142:
            java.io.IOException r3 = new java.io.IOException     // Catch:{ all -> 0x015d }
            ...
            java.lang.String r5 = r2.getAbsolutePath()     // Catch:{ all -> 0x015d }
            r4.append(r5)     // Catch:{ all -> 0x015d }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x015d }
            r3.<init>(r4, r1)     // Catch:{ all -> 0x015d }
        ...
        L_0x015d:
            ...
            r3 = 1
        L_0x0161:
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)     // Catch:{ all -> 0x0168 }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r8)     // Catch:{ all -> 0x0168 }
            throw r0     // Catch:{ all -> 0x0168 }
        L_0x0168:
            r0 = move-exception
    ...
    /* JADX WARNING: Removed duplicated region for block: B:58:0x00a0 A[Catch:{ Exception -> 0x009e }] */
    /* JADX WARNING: Removed duplicated region for block: B:69:0x00b7  */
    ...
    public byte[] getThumbnailBytes() {
        ...
        L_0x0008:
            ...
            return r1
        L_0x000d:
            android.content.res.AssetManager$AssetInputStream r1 = r11.mAssetInputStream     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
        ...
        L_0x002b:
            ...
            goto L_0x00ad
        L_0x0030:
            java.lang.String r1 = r11.mFilename     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
            if (r1 == 0) goto L_0x003c
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
            java.lang.String r3 = r11.mFilename     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
            r1.<init>(r3)     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
            goto L_0x001c
        L_0x003c:
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
            r3 = 21
            if (r1 < r3) goto L_0x0061
            java.io.FileDescriptor r1 = r11.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
            java.io.FileDescriptor r1 = androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.dup(r1)     // Catch:{ Exception -> 0x00a9, all -> 0x00a6 }
            r3 = 0
            int r5 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x005c, all -> 0x0058 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r1, r3, r5)     // Catch:{ Exception -> 0x005c, all -> 0x0058 }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x005c, all -> 0x0058 }
            r3.<init>(r1)     // Catch:{ Exception -> 0x005c, all -> 0x0058 }
            r10 = r3
            r3 = r1
            r1 = r10
            goto L_0x0063
        ...
        L_0x0063:
            ...
            int r4 = r11.mThumbnailOffset     // Catch:{ Exception -> 0x009e }
            int r5 = r11.mOffsetToExifData     // Catch:{ Exception -> 0x009e }
            int r4 = r4 + r5
            long r4 = (long) r4     // Catch:{ Exception -> 0x009e }
            long r4 = r1.skip(r4)     // Catch:{ Exception -> 0x009e }
            int r6 = r11.mThumbnailOffset     // Catch:{ Exception -> 0x009e }
            int r7 = r11.mOffsetToExifData     // Catch:{ Exception -> 0x009e }
            int r6 = r6 + r7
            long r6 = (long) r6
            java.lang.String r8 = "Corrupted image"
            int r9 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r9 != 0) goto L_0x0098
            int r4 = r11.mThumbnailLength     // Catch:{ Exception -> 0x009e }
            byte[] r4 = new byte[r4]     // Catch:{ Exception -> 0x009e }
            int r5 = r1.read(r4)     // Catch:{ Exception -> 0x009e }
            int r6 = r11.mThumbnailLength     // Catch:{ Exception -> 0x009e }
            if (r5 != r6) goto L_0x0092
            r11.mThumbnailBytes = r4     // Catch:{ Exception -> 0x009e }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
        ...
        L_0x0091:
            return r4
        L_0x0092:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ Exception -> 0x009e }
            r4.<init>(r8)     // Catch:{ Exception -> 0x009e }
            throw r4     // Catch:{ Exception -> 0x009e }
        L_0x0098:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ Exception -> 0x009e }
            r4.<init>(r8)     // Catch:{ Exception -> 0x009e }
            throw r4     // Catch:{ Exception -> 0x009e }
        L_0x009e:
            ...
            goto L_0x00ad
        L_0x00a0:
            java.io.FileNotFoundException r4 = new java.io.FileNotFoundException     // Catch:{ Exception -> 0x009e }
        ...
        L_0x00ad:
            ...
            android.util.Log.d(r0, r5, r4)     // Catch:{ all -> 0x00bb }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
    ...
    public void setLatLong(double d, double d2) {
        if (d < -90.0d || d > 90.0d || Double.isNaN(d)) {
            ...
            setAttribute(TAG_GPS_LATITUDE_REF, d >= com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON ? "N" : LATITUDE_SOUTH);
            setAttribute(TAG_GPS_LATITUDE, convertDecimalDegree(Math.abs(d)));
            setAttribute(TAG_GPS_LONGITUDE_REF, d2 >= com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON ? LONGITUDE_EAST : LONGITUDE_WEST);
    ...
    public double getAltitude(double d) {
        ...
        if (attributeDouble < com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON || attributeInt < 0) {
            return d;
        }
        if (attributeInt != 1) {
            i = 1;
    ...
    public void setAltitude(double d) {
        String str = d >= com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON ? AppEventsConstants.EVENT_PARAM_VALUE_NO : "1";
    ...
    /* JADX WARNING: Removed duplicated region for block: B:60:0x018c A[LOOP:0: B:8:0x0038->B:60:0x018c, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:73:0x0196 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void getJpegAttributes(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r22, int r23, int r24) throws java.io.IOException {
        ...
        L_0x0123:
            ...
            boolean r13 = androidx.exifinterface.media.ExifInterfaceUtils.startsWith(r8, r13)
        ...
        L_0x014d:
            ...
            int r5 = r5 + r14
            int r13 = r13.length
            byte[] r8 = java.util.Arrays.copyOfRange(r8, r13, r9)
            java.lang.String r9 = "Xmp"
            java.lang.String r13 = r0.getAttribute(r9)
            if (r13 != 0) goto L_0x0186
    ...
    private void getHeifAttributes(final androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r13) throws java.io.IOException {
        /*
            ...
            r1.<init>()
            androidx.exifinterface.media.ExifInterface$1 r2 = new androidx.exifinterface.media.ExifInterface$1     // Catch:{ RuntimeException -> 0x013c }
            r2.<init>(r13)     // Catch:{ RuntimeException -> 0x013c }
            androidx.exifinterface.media.ExifInterfaceUtils.Api23Impl.setDataSource(r1, r2)     // Catch:{ RuntimeException -> 0x013c }
            r2 = 33
            java.lang.String r2 = r1.extractMetadata(r2)     // Catch:{ RuntimeException -> 0x013c }
            r3 = 34
            java.lang.String r3 = r1.extractMetadata(r3)     // Catch:{ RuntimeException -> 0x013c }
            r4 = 26
            java.lang.String r4 = r1.extractMetadata(r4)     // Catch:{ RuntimeException -> 0x013c }
            r5 = 17
            java.lang.String r5 = r1.extractMetadata(r5)     // Catch:{ RuntimeException -> 0x013c }
            boolean r4 = r0.equals(r4)     // Catch:{ RuntimeException -> 0x013c }
            r6 = 0
            if (r4 == 0) goto L_0x0048
            r0 = 29
            java.lang.String r6 = r1.extractMetadata(r0)     // Catch:{ RuntimeException -> 0x013c }
            r0 = 30
            java.lang.String r0 = r1.extractMetadata(r0)     // Catch:{ RuntimeException -> 0x013c }
            r4 = 31
            java.lang.String r4 = r1.extractMetadata(r4)     // Catch:{ RuntimeException -> 0x013c }
            goto L_0x0063
        L_0x0048:
            boolean r0 = r0.equals(r5)     // Catch:{ RuntimeException -> 0x013c }
        ...
        L_0x0063:
            ...
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r7 = r12.mAttributes     // Catch:{ RuntimeException -> 0x013c }
            r7 = r7[r5]     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r8 = "ImageWidth"
            int r9 = java.lang.Integer.parseInt(r6)     // Catch:{ RuntimeException -> 0x013c }
            java.nio.ByteOrder r10 = r12.mExifByteOrder     // Catch:{ RuntimeException -> 0x013c }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r9 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r9, (java.nio.ByteOrder) r10)     // Catch:{ RuntimeException -> 0x013c }
            r7.put(r8, r9)     // Catch:{ RuntimeException -> 0x013c }
        L_0x0079:
            if (r0 == 0) goto L_0x008e
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r7 = r12.mAttributes     // Catch:{ RuntimeException -> 0x013c }
            r7 = r7[r5]     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r8 = "ImageLength"
            int r9 = java.lang.Integer.parseInt(r0)     // Catch:{ RuntimeException -> 0x013c }
            java.nio.ByteOrder r10 = r12.mExifByteOrder     // Catch:{ RuntimeException -> 0x013c }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r9 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r9, (java.nio.ByteOrder) r10)     // Catch:{ RuntimeException -> 0x013c }
            r7.put(r8, r9)     // Catch:{ RuntimeException -> 0x013c }
        L_0x008e:
            ...
            r8 = 1
            int r9 = java.lang.Integer.parseInt(r4)     // Catch:{ RuntimeException -> 0x013c }
            r10 = 90
        ...
        L_0x00a8:
            r8 = 6
        L_0x00a9:
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r9 = r12.mAttributes     // Catch:{ RuntimeException -> 0x013c }
            r9 = r9[r5]     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r10 = "Orientation"
            java.nio.ByteOrder r11 = r12.mExifByteOrder     // Catch:{ RuntimeException -> 0x013c }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r8 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r8, (java.nio.ByteOrder) r11)     // Catch:{ RuntimeException -> 0x013c }
            r9.put(r10, r8)     // Catch:{ RuntimeException -> 0x013c }
        L_0x00b8:
            if (r2 == 0) goto L_0x010b
            if (r3 == 0) goto L_0x010b
            int r2 = java.lang.Integer.parseInt(r2)     // Catch:{ RuntimeException -> 0x013c }
            int r3 = java.lang.Integer.parseInt(r3)     // Catch:{ RuntimeException -> 0x013c }
            if (r3 <= r7) goto L_0x0103
            long r8 = (long) r2     // Catch:{ RuntimeException -> 0x013c }
            r13.seek(r8)     // Catch:{ RuntimeException -> 0x013c }
            byte[] r8 = new byte[r7]     // Catch:{ RuntimeException -> 0x013c }
            int r9 = r13.read(r8)     // Catch:{ RuntimeException -> 0x013c }
            if (r9 != r7) goto L_0x00fb
            int r2 = r2 + r7
            int r3 = r3 + -6
            byte[] r7 = IDENTIFIER_EXIF_APP1     // Catch:{ RuntimeException -> 0x013c }
            boolean r7 = java.util.Arrays.equals(r8, r7)     // Catch:{ RuntimeException -> 0x013c }
            if (r7 == 0) goto L_0x00f3
            byte[] r7 = new byte[r3]     // Catch:{ RuntimeException -> 0x013c }
            int r13 = r13.read(r7)     // Catch:{ RuntimeException -> 0x013c }
            if (r13 != r3) goto L_0x00eb
            r12.mOffsetToExifData = r2     // Catch:{ RuntimeException -> 0x013c }
            r12.readExifSegment(r7, r5)     // Catch:{ RuntimeException -> 0x013c }
            goto L_0x010b
        L_0x00eb:
            java.io.IOException r13 = new java.io.IOException     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r0 = "Can't read exif"
            r13.<init>(r0)     // Catch:{ RuntimeException -> 0x013c }
            throw r13     // Catch:{ RuntimeException -> 0x013c }
        L_0x00f3:
            java.io.IOException r13 = new java.io.IOException     // Catch:{ RuntimeException -> 0x013c }
        ...
        L_0x0103:
            ...
            throw r13     // Catch:{ RuntimeException -> 0x013c }
        L_0x010b:
            boolean r13 = DEBUG     // Catch:{ RuntimeException -> 0x013c }
            if (r13 == 0) goto L_0x0136
            java.lang.String r13 = "ExifInterface"
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x013c }
            r2.<init>()     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r3 = "Heif meta: "
            r2.append(r3)     // Catch:{ RuntimeException -> 0x013c }
            r2.append(r6)     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r3 = "x"
            r2.append(r3)     // Catch:{ RuntimeException -> 0x013c }
            r2.append(r0)     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r0 = ", rotation "
            r2.append(r0)     // Catch:{ RuntimeException -> 0x013c }
            r2.append(r4)     // Catch:{ RuntimeException -> 0x013c }
            java.lang.String r0 = r2.toString()     // Catch:{ RuntimeException -> 0x013c }
            android.util.Log.d(r13, r0)     // Catch:{ RuntimeException -> 0x013c }
        L_0x0136:
            r1.release()
            return
        L_0x013a:
            ...
            goto L_0x0144
        L_0x013c:
            java.lang.UnsupportedOperationException r13 = new java.lang.UnsupportedOperationException     // Catch:{ all -> 0x013a }
            java.lang.String r0 = "Failed to read EXIF from HEIF file. Given stream is either malformed or unsupported."
            r13.<init>(r0)     // Catch:{ all -> 0x013a }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:58:0x01ba A[Catch:{ Exception -> 0x0201, all -> 0x01fe }] */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x01c6 A[Catch:{ Exception -> 0x0201, all -> 0x01fe }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void saveWebpAttributes(java.io.InputStream r20, java.io.OutputStream r21) throws java.io.IOException {
        ...
        L_0x002e:
            ...
            r3.skipFully(r2)
            r2 = 0
            java.io.ByteArrayOutputStream r6 = new java.io.ByteArrayOutputStream     // Catch:{ Exception -> 0x0206 }
            r6.<init>()     // Catch:{ Exception -> 0x0206 }
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataOutputStream r7 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataOutputStream     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            java.nio.ByteOrder r8 = java.nio.ByteOrder.LITTLE_ENDIAN     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.<init>(r6, r8)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r8 = r1.mOffsetToExifData     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r8 == 0) goto L_0x007a
            byte[] r0 = WEBP_SIGNATURE_1     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r0 = r0.length     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r0 = r0 + r5
            byte[] r2 = WEBP_SIGNATURE_2     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r2 = r2.length     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r0 = r0 + r2
            int r2 = r1.mOffsetToExifData     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r2 = r2 - r0
            int r2 = r2 - r5
            int r2 = r2 - r5
            androidx.exifinterface.media.ExifInterfaceUtils.copy(r3, r7, r2)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r3.skipFully(r5)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r0 = r3.readInt()     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r3.skipFully(r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r1.writeExifSegment(r7)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            goto L_0x01dc
        L_0x007a:
            byte[] r8 = new byte[r5]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r9 = r3.read(r8)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r9 != r5) goto L_0x01f6
            byte[] r9 = WEBP_CHUNK_TYPE_VP8X     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r9 = java.util.Arrays.equals(r8, r9)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r10 = 8
            r11 = 1
            r12 = 0
            if (r9 == 0) goto L_0x00e1
            int r8 = r3.readInt()     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r9 = r8 % 2
        ...
        L_0x0099:
            r9 = r8
        L_0x009a:
            byte[] r9 = new byte[r9]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r3.read(r9)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte r13 = r9[r12]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r10 = r10 | r13
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r9[r12] = r10     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte r10 = r9[r12]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r10 = r10 >> r11
            r10 = r10 & r11
        ...
        L_0x00ac:
            r11 = 0
        L_0x00ad:
            byte[] r10 = WEBP_CHUNK_TYPE_VP8X     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.write(r10)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.writeInt(r8)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.write(r9)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r11 == 0) goto L_0x00d5
            byte[] r8 = WEBP_CHUNK_TYPE_ANIM     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r1.copyChunksUpToGivenChunkType(r3, r7, r8, r2)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
        L_0x00bf:
            byte[] r2 = new byte[r5]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r0.read(r2)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r8 = WEBP_CHUNK_TYPE_ANMF     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r8 = java.util.Arrays.equals(r2, r8)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r8 != 0) goto L_0x00d1
            r1.writeExifSegment(r7)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            goto L_0x01dc
        L_0x00d1:
            r1.copyWebPChunk(r3, r7, r2)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            goto L_0x00bf
        L_0x00d5:
            byte[] r0 = WEBP_CHUNK_TYPE_VP8     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r2 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r1.copyChunksUpToGivenChunkType(r3, r7, r0, r2)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r1.writeExifSegment(r7)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            goto L_0x01dc
        L_0x00e1:
            byte[] r0 = WEBP_CHUNK_TYPE_VP8     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r0 = java.util.Arrays.equals(r8, r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r0 != 0) goto L_0x00f1
            byte[] r0 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r0 = java.util.Arrays.equals(r8, r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
        ...
        L_0x00fd:
            r9 = 3
            byte[] r13 = new byte[r9]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r14 = WEBP_CHUNK_TYPE_VP8     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r14 = java.util.Arrays.equals(r8, r14)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15 = 47
            if (r14 == 0) goto L_0x0134
            r3.read(r13)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r11 = new byte[r9]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r14 = r3.read(r11)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r14 != r9) goto L_0x012c
            byte[] r9 = WEBP_VP8_SIGNATURE     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r9 = java.util.Arrays.equals(r9, r11)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r9 == 0) goto L_0x012c
            int r9 = r3.readInt()     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r11 = r9 << 18
            int r11 = r11 >> 18
            int r14 = r9 << 2
            int r14 = r14 >> 18
            ...
            goto L_0x0166
        L_0x012c:
            java.io.IOException r0 = new java.io.IOException     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            java.lang.String r2 = "Encountered error while checking VP8 signature"
            r0.<init>(r2)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            throw r0     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
        L_0x0134:
            byte[] r9 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r9 = java.util.Arrays.equals(r8, r9)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r9 == 0) goto L_0x0163
            byte r9 = r3.readByte()     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
        ...
        L_0x0166:
            r16 = 0
        L_0x0168:
            byte[] r15 = WEBP_CHUNK_TYPE_VP8X     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.write(r15)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15 = 10
            r7.writeInt(r15)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r15 = new byte[r15]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte r17 = r15[r12]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r5 = r17 | 8
            byte r5 = (byte) r5     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15[r12] = r5     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte r5 = r15[r12]     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r17 = 4
            int r16 = r16 << 4
            r5 = r5 | r16
            byte r5 = (byte) r5     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            ...
            int r11 = r11 + -1
            int r14 = r14 + -1
            byte r5 = (byte) r11     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15[r17] = r5     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r5 = 5
            int r12 = r11 >> 8
            byte r12 = (byte) r12     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15[r5] = r12     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r5 = 6
            int r11 = r11 >> 16
            byte r11 = (byte) r11     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15[r5] = r11     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r5 = 7
            byte r11 = (byte) r14     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15[r5] = r11     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r5 = r14 >> 8
            byte r5 = (byte) r5     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15[r10] = r5     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r5 = 9
            int r10 = r14 >> 16
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r15[r5] = r10     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.write(r15)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.write(r8)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.writeInt(r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r0 = WEBP_CHUNK_TYPE_VP8     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r0 = java.util.Arrays.equals(r8, r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            if (r0 == 0) goto L_0x01c6
            r7.write(r13)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r0 = WEBP_VP8_SIGNATURE     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.write(r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r7.writeInt(r9)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            goto L_0x01d6
        L_0x01c6:
            byte[] r0 = WEBP_CHUNK_TYPE_VP8L     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            boolean r0 = java.util.Arrays.equals(r8, r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
        ...
        L_0x01d6:
            ...
            r1.writeExifSegment(r7)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
        L_0x01dc:
            androidx.exifinterface.media.ExifInterfaceUtils.copy(r3, r7)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r0 = r6.size()     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r2 = WEBP_SIGNATURE_2     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r2 = r2.length     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            int r0 = r0 + r2
            r4.writeInt(r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            byte[] r0 = WEBP_SIGNATURE_2     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r4.write(r0)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
            r6.writeTo(r4)     // Catch:{ Exception -> 0x0201, all -> 0x01fe }
        ...
        L_0x0206:
            r0 = move-exception
        L_0x0207:
            java.io.IOException r3 = new java.io.IOException     // Catch:{ all -> 0x0204 }
            java.lang.String r4 = "Failed to save WebP file"
            r3.<init>(r4, r0)     // Catch:{ all -> 0x0204 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:89:0x0259  */
    ...
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r28, int r29) throws java.io.IOException {
        ...
        L_0x00b0:
            ...
            goto L_0x011d
        L_0x00b8:
            boolean r4 = r11.isFormatCompatible(r13)
        ...
        L_0x0186:
            ...
            r6 = 6
            androidx.exifinterface.media.ExifInterface$ExifAttribute r3 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r6, (java.nio.ByteOrder) r3)
            ...
            androidx.exifinterface.media.ExifInterface$ExifAttribute r10 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createULong((long) r10, (java.nio.ByteOrder) r15)
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r11 = r0.mAttributes
            r15 = 4
            r11 = r11[r15]
            r11.put(r14, r3)
        ...
        L_0x020c:
            ...
            r7 = -1
            r9 = 3
            if (r13 == r9) goto L_0x0232
            r9 = 4
            if (r13 == r9) goto L_0x022d
            if (r13 == r6) goto L_0x0228
            r6 = 9
            if (r13 == r6) goto L_0x0223
            r6 = 13
            if (r13 == r6) goto L_0x0223
            goto L_0x0237
        L_0x0223:
            ...
            goto L_0x0236
        L_0x0228:
            short r6 = r28.readShort()
            goto L_0x0236
        L_0x022d:
            long r7 = r28.readUnsignedInt()
            goto L_0x0237
        L_0x0232:
        ...
        L_0x02b6:
            ...
            java.lang.String r11 = "DNGVersion"
