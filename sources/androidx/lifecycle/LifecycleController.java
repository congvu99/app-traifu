...
public final class LifecycleController {
    ...
    public LifecycleController(Lifecycle lifecycle2, Lifecycle.State state, DispatchQueue dispatchQueue2, Job job) {
        ...
        this.observer = new LifecycleEventObserver(job) {
            ...
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                LifecycleController.m4967observer$lambda0(LifecycleController.this, this.f$1, lifecycleOwner, event);
            }
        };
    ...
    public static final void m4967observer$lambda0(LifecycleController lifecycleController, Job job, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
