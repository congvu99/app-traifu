...
public final class DispatchQueue {
        ...
        if (immediate.isDispatchNeeded(coroutineContext) || canRun()) {
            immediate.dispatch(coroutineContext, new Runnable(runnable) {
                ...
                public final void run() {
                    DispatchQueue.m4964dispatchAndEnqueue$lambda2$lambda1(DispatchQueue.this, this.f$1);
                }
            });
        } else {
            enqueue(runnable);
    ...
    public static final void m4964dispatchAndEnqueue$lambda2$lambda1(DispatchQueue dispatchQueue, Runnable runnable) {
