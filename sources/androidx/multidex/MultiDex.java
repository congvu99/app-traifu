...
public final class MultiDex {
    ...
    private static void doInstallation(android.content.Context r5, java.io.File r6, java.io.File r7, java.lang.String r8, java.lang.String r9, boolean r10) throws java.io.IOException, java.lang.IllegalArgumentException, java.lang.IllegalAccessException, java.lang.NoSuchFieldException, java.lang.reflect.InvocationTargetException, java.lang.NoSuchMethodException, java.lang.SecurityException, java.lang.ClassNotFoundException, java.lang.InstantiationException {
        /*
            ...
            monitor-enter(r0)
            java.util.Set<java.io.File> r1 = installedApk     // Catch:{ all -> 0x009f }
            boolean r1 = r1.contains(r6)     // Catch:{ all -> 0x009f }
        ...
        L_0x000d:
            ...
            int r4 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x009f }
            r3.append(r4)     // Catch:{ all -> 0x009f }
            java.lang.String r4 = ": SDK version higher than "
            r3.append(r4)     // Catch:{ all -> 0x009f }
            r3.append(r2)     // Catch:{ all -> 0x009f }
            ...
            java.lang.String r2 = java.lang.System.getProperty(r2)     // Catch:{ all -> 0x009f }
            r3.append(r2)     // Catch:{ all -> 0x009f }
            java.lang.String r2 = "\""
            r3.append(r2)     // Catch:{ all -> 0x009f }
            java.lang.String r2 = r3.toString()     // Catch:{ all -> 0x009f }
            android.util.Log.w(r1, r2)     // Catch:{ all -> 0x009f }
        L_0x0056:
            java.lang.ClassLoader r1 = getDexClassloader(r5)     // Catch:{ all -> 0x009f }
            if (r1 != 0) goto L_0x005e
            monitor-exit(r0)     // Catch:{ all -> 0x009f }
            return
        L_0x005e:
            clearOldDexDir(r5)     // Catch:{ all -> 0x0062 }
            goto L_0x006a
        L_0x0062:
            r2 = move-exception
            ...
            android.util.Log.w(r3, r4, r2)     // Catch:{ all -> 0x009f }
        L_0x006a:
            java.io.File r7 = getDexDir(r5, r7, r8)     // Catch:{ all -> 0x009f }
            androidx.multidex.MultiDexExtractor r8 = new androidx.multidex.MultiDexExtractor     // Catch:{ all -> 0x009f }
            r8.<init>(r6, r7)     // Catch:{ all -> 0x009f }
            r6 = 0
            r2 = 0
            java.util.List r2 = r8.load(r5, r9, r2)     // Catch:{ all -> 0x009a }
            installSecondaryDexes(r1, r7, r2)     // Catch:{ IOException -> 0x007d }
            goto L_0x008f
        L_0x007d:
            r2 = move-exception
            ...
            android.util.Log.w(r10, r3, r2)     // Catch:{ all -> 0x009a }
            r10 = 1
            java.util.List r5 = r8.load(r5, r9, r10)     // Catch:{ all -> 0x009a }
            installSecondaryDexes(r1, r7, r5)     // Catch:{ all -> 0x009a }
        L_0x008f:
