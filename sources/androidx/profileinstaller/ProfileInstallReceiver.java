    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_INSTALL_PROFILE.equals(action)) {
                ProfileInstaller.writeProfile(context, $$Lambda$_14QHG018Z6p13d3hzJuGTWnNeo.INSTANCE, new ResultDiagnostics(), true);
                ...
                if (EXTRA_SKIP_FILE_OPERATION_WRITE.equals(string)) {
                    ProfileInstaller.writeSkipFile(context, $$Lambda$_14QHG018Z6p13d3hzJuGTWnNeo.INSTANCE, new ResultDiagnostics());
                } else if (EXTRA_SKIP_FILE_OPERATION_DELETE.equals(string)) {
                    ProfileInstaller.deleteSkipFile(context, $$Lambda$_14QHG018Z6p13d3hzJuGTWnNeo.INSTANCE, new ResultDiagnostics());
                }
            }
        }
    }
