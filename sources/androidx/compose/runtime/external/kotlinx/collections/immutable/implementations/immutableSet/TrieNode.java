...
public final class TrieNode<E> {
    ...
    private final TrieNode<E> mutableCollisionAddAll(TrieNode<E> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        ...
        while (i < objArr2.length) {
            boolean z = true;
            CommonFunctionsKt.m1558assert(i2 <= i);
            if (!collisionContainsElement(objArr2[i])) {
                ...
                CommonFunctionsKt.m1558assert(z);
            }
            i++;
        }
            ...
            if (i5 != i3) {
                if (bitCount != 1 || i2 == 0) {
                    ...
                    while (i7 < objArr2.length) {
                        CommonFunctionsKt.m1558assert(i8 <= i7);
                        if (objArr2[i7] != Companion.getEMPTY$runtime_release()) {
                            objArr[0 + i8] = objArr2[i7];
                            i8++;
                            CommonFunctionsKt.m1558assert(0 + i8 <= bitCount);
                        }
                        i7++;
                    }
    ...
    public final Object mutableRemoveAll(TrieNode<E> trieNode, int i, DeltaCounter deltaCounter, PersistentHashSetBuilder<?> persistentHashSetBuilder) {
        ...
        if (this == trieNode3) {
            ...
            if (Intrinsics.areEqual((Object) this.ownedBy, (Object) persistentHashSetBuilder.getOwnership$runtime_release())) {
                ...
                Object[] copyOf = Arrays.copyOf(objArr, objArr.length);
                Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, size)");
                trieNode2 = new TrieNode(i4, copyOf, persistentHashSetBuilder.getOwnership$runtime_release());
            }
            int i5 = this.bitmap;
            while (i3 != 0) {
                ...
                if (z && z2) {
                    ...
                    Intrinsics.checkNotNull(obj2, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.mutableRemoveAll$lambda-11$lambda-10>");
                    obj = ((TrieNode) obj).mutableRemoveAll((TrieNode) obj2, i2 + 5, deltaCounter2, persistentHashSetBuilder2);
                } else if (z) {
                    Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.mutableRemoveAll$lambda-11$lambda-10>");
                    TrieNode trieNode4 = (TrieNode) obj;
                    int size = persistentHashSetBuilder.size();
                    TrieNode<?> mutableRemove = trieNode4.mutableRemove(obj2 != null ? obj2.hashCode() : 0, obj2, i2 + 5, persistentHashSetBuilder2);
            ...
            if (i5 == this.bitmap) {
                ...
                while (i6 < objArr4.length) {
                    CommonFunctionsKt.m1558assert(i7 <= i6);
                    if (objArr4[i6] != Companion.getEMPTY$runtime_release()) {
                        objArr3[0 + i7] = objArr4[i6];
                        i7++;
                        CommonFunctionsKt.m1558assert(0 + i7 <= bitCount);
                    }
                    i6++;
                }
                return new TrieNode(i5, objArr3, persistentHashSetBuilder.getOwnership$runtime_release());
            } else {
                Object obj3 = trieNode2.buffer[trieNode2.indexOfCellAt$runtime_release(i5)];
                if (!(obj3 instanceof TrieNode)) {
                    return obj3;
                }
                return new TrieNode(i5, new Object[]{obj3}, persistentHashSetBuilder.getOwnership$runtime_release());
            }
        }
    }
