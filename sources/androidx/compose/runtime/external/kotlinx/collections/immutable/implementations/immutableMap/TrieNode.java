...
public final class TrieNode<K, V> {
    ...
    private final Object[] bufferMoveEntryToNode(int i, int i2, int i3, K k, V v, int i4, MutabilityOwnership mutabilityOwnership) {
        ...
        int i5 = i2;
        int i6 = i;
        return TrieNodeKt.replaceEntryWithNode(this.buffer, i, nodeIndex$runtime_release(i2) + 1, makeNode(keyAtIndex != null ? keyAtIndex.hashCode() : 0, keyAtIndex, valueAtKeyIndex(i), i3, k, v, i4 + 5, mutabilityOwnership));
    }
    ...
    private final boolean collisionContainsKey(K k) {
        ...
        if ((step2 > 0 && first <= last) || (step2 < 0 && last <= first)) {
            while (!Intrinsics.areEqual((Object) k, this.buffer[first])) {
                if (first != last) {
                    first += step2;
                }
            }
    ...
    private final V collisionGet(K k) {
        ...
        while (!Intrinsics.areEqual((Object) k, keyAtIndex(first))) {
            if (first == last) {
                return null;
            }
            first += step2;
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        CommonFunctionsKt.m1558assert(this.nodeMap == 0);
        CommonFunctionsKt.m1558assert(this.dataMap == 0);
        CommonFunctionsKt.m1558assert(trieNode.nodeMap == 0);
        CommonFunctionsKt.m1558assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> trieNode, int i, int i2, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (trieNode.hasNodeAt(i)) {
            ...
            if (hasEntryAt$runtime_release(i3)) {
                ...
                int i5 = i2 + 5;
                if (nodeAtIndex$runtime_release2.containsKey(keyAtIndex2 != null ? keyAtIndex2.hashCode() : 0, keyAtIndex2, i5)) {
                    deltaCounter2.setCount(deltaCounter.getCount() + 1);
                } else {
                    return nodeAtIndex$runtime_release2.mutablePut(keyAtIndex2 != null ? keyAtIndex2.hashCode() : 0, keyAtIndex2, valueAtKeyIndex(entryKeyIndex$runtime_release2), i5, persistentHashMapBuilder);
                }
            }
        ...
        V valueAtKeyIndex3 = trieNode2.valueAtKeyIndex(entryKeyIndex$runtime_release4);
        int hashCode = keyAtIndex3 != null ? keyAtIndex3.hashCode() : 0;
        if (keyAtIndex4 != null) {
            i4 = keyAtIndex4.hashCode();
        }
        return makeNode(hashCode, keyAtIndex3, valueAtKeyIndex2, i4, keyAtIndex4, valueAtKeyIndex3, i2 + 5, persistentHashMapBuilder.getOwnership$runtime_release());
    }
