...
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    public SmallPersistentVector(Object[] objArr) {
        ...
        this.buffer = objArr;
        CommonFunctionsKt.m1558assert(objArr.length <= 32);
    }
    ...
    public PersistentList<E> removeAll(Function1<? super E, Boolean> function1) {
        ...
        return new SmallPersistentVector<>(ArraysKt.copyOfRange((T[]) objArr, 0, size));
    }
    ...
    public ListIterator<E> listIterator(int i) {
        ...
        return new BufferIterator<>(objArr, i, size());
    }
