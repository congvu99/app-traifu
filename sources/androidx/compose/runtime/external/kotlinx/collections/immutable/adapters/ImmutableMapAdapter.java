...
public final class ImmutableMapAdapter<K, V> implements ImmutableMap<K, V>, Map<K, V>, KMappedMarker {
    private final ImmutableSet<Map.Entry<K, V>> entries = new ImmutableSetAdapter(this.impl.entrySet());
    private final Map<K, V> impl;
    private final ImmutableSet<K> keys;
    private final ImmutableCollection<V> values = new ImmutableCollectionAdapter(this.impl.values());
