...
public final class PersistentVector<E> extends AbstractPersistentList<E> implements PersistentList<E> {
    ...
    public PersistentVector(Object[] objArr, Object[] objArr2, int i, int i2) {
        ...
        boolean z = true;
        if (size() > 32) {
            CommonFunctionsKt.m1558assert(size() - UtilsKt.rootSize(size()) > RangesKt.coerceAtMost(this.tail.length, 32) ? false : z);
            return;
        }
    ...
    private final PersistentList<E> removeFromTailAt(Object[] objArr, int i, int i2, int i3) {
        int size2 = size() - i;
        CommonFunctionsKt.m1558assert(i3 < size2);
        if (size2 == 1) {
    ...
    public ListIterator<E> listIterator(int i) {
        ...
        return new PersistentVectorIterator<>(objArr, objArr2, i, size(), (this.rootShift / 5) + 1);
    }
