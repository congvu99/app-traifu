...
public final class MutableVector<T> implements RandomAccess {
    ...
    public final boolean addAll(int i, List<? extends T> list2) {
        Intrinsics.checkNotNullParameter(list2, MessengerShareContentUtility.ELEMENTS);
        if (list2.isEmpty()) {
            return false;
        }
    ...
    public final boolean addAll(int i, MutableVector<T> mutableVector) {
        Intrinsics.checkNotNullParameter(mutableVector, MessengerShareContentUtility.ELEMENTS);
    ...
    public final boolean contentEquals(MutableVector<T> mutableVector) {
        ...
        if (size2 >= 0) {
            int i = 0;
            while (Intrinsics.areEqual(mutableVector.getContent()[i], getContent()[i])) {
                if (i != size2) {
                    i++;
                }
            }
    ...
    public final /* synthetic */ <R> MutableVector<R> mapIndexedNotNull(Function2<? super Integer, ? super T, ? extends R> function2) {
        ...
        if (size2 > 0) {
            Object[] content2 = getContent();
            Intrinsics.checkNotNull(content2, "null cannot be cast to non-null type kotlin.Array<T of androidx.compose.runtime.collection.MutableVector>");
            Object[] objArr2 = content2;
            int i2 = 0;
            do {
                Object invoke = function2.invoke(Integer.valueOf(i), objArr2[i]);
                if (invoke != null) {
                    objArr[i2] = invoke;
                    i2++;
                }
    ...
    public final /* synthetic */ <R> MutableVector<R> mapNotNull(Function1<? super T, ? extends R> function1) {
        ...
        if (size2 > 0) {
            ...
            int i2 = 0;
            do {
                Object invoke = function1.invoke(objArr2[i]);
                if (invoke != null) {
                    objArr[i2] = invoke;
                    i2++;
                }
    ...
    public final void sortWith(Comparator<T> comparator) {
        ...
        T[] tArr = this.content;
        Intrinsics.checkNotNull(tArr, "null cannot be cast to non-null type kotlin.Array<T of androidx.compose.runtime.collection.MutableVector>");
        ArraysKt.sortWith(tArr, comparator, 0, this.size);
    }
    ...
    private static final class VectorListIterator<T> implements ListIterator<T>, KMutableListIterator {
        ...
        public VectorListIterator(List<T> list2, int i) {
            Intrinsics.checkNotNullParameter(list2, AttributeType.LIST);
            this.list = list2;
            this.index = i;
        }
    ...
    private static final class MutableVectorList<T> implements List<T>, KMutableList {
        ...
        public List<T> subList(int i, int i2) {
            List list = this;
            MutableVectorKt.checkSubIndex(list, i, i2);
    ...
    private static final class SubList<T> implements List<T>, KMutableList {
        ...
        public List<T> subList(int i, int i2) {
            List list2 = this;
            MutableVectorKt.checkSubIndex(list2, i, i2);
    ...
    public final boolean contains(T t) {
        ...
        if (size2 >= 0) {
            int i = 0;
            while (!Intrinsics.areEqual(getContent()[i], (Object) t)) {
                if (i != size2) {
                    i++;
                }
            }
