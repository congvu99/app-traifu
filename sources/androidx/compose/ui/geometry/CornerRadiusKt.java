...
public final class CornerRadiusKt {
    ...
    public static final long m1669lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m1658getXimpl(j), CornerRadius.m1658getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m1659getYimpl(j), CornerRadius.m1659getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        long floatToIntBits = (long) Float.floatToIntBits(f);
        return CornerRadius.m1652constructorimpl((((long) Float.floatToIntBits(f2)) & 4294967295L) | (floatToIntBits << 32));
    }
}
