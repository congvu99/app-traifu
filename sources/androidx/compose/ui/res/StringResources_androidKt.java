...
public final class StringResources_androidKt {
    ...
    public static final String stringResource(int i, Object[] objArr, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2071230100, i2, -1, "androidx.compose.ui.res.stringResource (StringResources.android.kt:47)");
        }
    ...
    public static final String[] stringArrayResource(int i, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1562162650, i2, -1, "androidx.compose.ui.res.stringArrayResource (StringResources.android.kt:60)");
        }
    ...
    public static final String pluralStringResource(int i, int i2, Composer composer, int i3) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1784741530, i3, -1, "androidx.compose.ui.res.pluralStringResource (StringResources.android.kt:75)");
        }
    ...
    public static final String pluralStringResource(int i, int i2, Object[] objArr, Composer composer, int i3) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(523207213, i3, -1, "androidx.compose.ui.res.pluralStringResource (StringResources.android.kt:91)");
        }
