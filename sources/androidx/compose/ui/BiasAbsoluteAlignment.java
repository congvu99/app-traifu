...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long m1562alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, ViewProps.LAYOUT_DIRECTION);
        long IntSize = IntSizeKt.IntSize(IntSize.m4864getWidthimpl(j2) - IntSize.m4864getWidthimpl(j), IntSize.m4863getHeightimpl(j2) - IntSize.m4863getHeightimpl(j));
        float f = (float) 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((((float) IntSize.m4864getWidthimpl(IntSize)) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((((float) IntSize.m4863getHeightimpl(IntSize)) / 2.0f) * (f + this.verticalBias)));
    }
