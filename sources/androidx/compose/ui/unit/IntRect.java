...
public final class IntRect {
    ...
    public final IntRect m4852translategyyYBs(long j) {
        return new IntRect(this.left + IntOffset.m4822getXimpl(j), this.top + IntOffset.m4823getYimpl(j), this.right + IntOffset.m4822getXimpl(j), this.bottom + IntOffset.m4823getYimpl(j));
    }
    ...
    public final boolean m4841containsgyyYBs(long j) {
        return IntOffset.m4822getXimpl(j) >= this.left && IntOffset.m4822getXimpl(j) < this.right && IntOffset.m4823getYimpl(j) >= this.top && IntOffset.m4823getYimpl(j) < this.bottom;
    }
