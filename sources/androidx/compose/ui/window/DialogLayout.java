...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public void Content(Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(Content)271@10674L9:AndroidDialog.android.kt#2oxthz");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1735448596, i, -1, "androidx.compose.ui.window.DialogLayout.Content (AndroidDialog.android.kt:270)");
        }
