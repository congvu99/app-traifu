...
public final class DialogProperties {
    ...
    public int hashCode() {
        return (((((((C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.dismissOnBackPress) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.dismissOnClickOutside)) * 31) + this.securePolicy.hashCode()) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.usePlatformDefaultWidth)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.decorFitsSystemWindows);
    }
}
