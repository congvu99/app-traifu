...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m3490toMotionEventScoped4ec7I(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1) {
        Intrinsics.checkNotNullParameter(pointerEvent, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(function1, "block");
        m3491toMotionEventScopeubNVwUQ(pointerEvent, j, function1, false);
    }

    /* renamed from: toCancelMotionEventScope-d-4ec7I  reason: not valid java name */
    public static final void m3489toCancelMotionEventScoped4ec7I(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1) {
        Intrinsics.checkNotNullParameter(pointerEvent, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(function1, "block");
        m3491toMotionEventScopeubNVwUQ(pointerEvent, j, function1, true);
    }
    ...
    private static final void m3491toMotionEventScopeubNVwUQ(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1, boolean z) {
        ...
        if (motionEvent$ui_release != null) {
            ...
            motionEvent$ui_release.offsetLocation(-Offset.m1683getXimpl(j), -Offset.m1684getYimpl(j));
