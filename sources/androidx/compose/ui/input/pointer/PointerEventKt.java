...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m1680equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.Companion.m1699getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m1680equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.Companion.m1699getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long r0 = Offset.m1687minusMKHz9U(pointerInputChange.m3429getPositionF1C5BW0(), pointerInputChange.m3430getPreviousPositionF1C5BW0());
        return (z || !pointerInputChange.isConsumed()) ? r0 : Offset.Companion.m1699getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (!Offset.m1680equalsimpl0(positionChange(pointerInputChange), Offset.Companion.m1699getZeroF1C5BW0())) {
            pointerInputChange.consume();
        }
    }
    ...
    public static final boolean m3376isOutOfBoundsO0kMr_c(PointerInputChange pointerInputChange, long j) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "$this$isOutOfBounds");
        long r0 = pointerInputChange.m3429getPositionF1C5BW0();
        float r3 = Offset.m1683getXimpl(r0);
        float r02 = Offset.m1684getYimpl(r0);
        return r3 < 0.0f || r3 > ((float) IntSize.m4864getWidthimpl(j)) || r02 < 0.0f || r02 > ((float) IntSize.m4863getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs  reason: not valid java name */
    public static final boolean m3377isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "$this$isOutOfBounds");
        if (!PointerType.m3502equalsimpl0(pointerInputChange.m3432getTypeT8wyACA(), PointerType.Companion.m3509getTouchT8wyACA())) {
            return m3376isOutOfBoundsO0kMr_c(pointerInputChange, j);
        }
        long r0 = pointerInputChange.m3429getPositionF1C5BW0();
        float r4 = Offset.m1683getXimpl(r0);
        float r02 = Offset.m1684getYimpl(r0);
        return r4 < (-Size.m1752getWidthimpl(j2)) || r4 > ((float) IntSize.m4864getWidthimpl(j)) + Size.m1752getWidthimpl(j2) || r02 < (-Size.m1749getHeightimpl(j2)) || r02 > ((float) IntSize.m4863getHeightimpl(j)) + Size.m1749getHeightimpl(j2);
    }
}
