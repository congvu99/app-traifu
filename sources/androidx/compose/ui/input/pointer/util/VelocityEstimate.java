...
final class VelocityEstimate {
    ...
    public static final VelocityEstimate None = new VelocityEstimate(Offset.Companion.m1699getZeroF1C5BW0(), 1.0f, 0, Offset.Companion.m1699getZeroF1C5BW0(), (DefaultConstructorMarker) null);
    ...
    public static /* synthetic */ VelocityEstimate m3554copyPZAlG8E$default(VelocityEstimate velocityEstimate, long j, float f, long j2, long j3, int i, Object obj) {
        VelocityEstimate velocityEstimate2 = velocityEstimate;
        return velocityEstimate.m3557copyPZAlG8E((i & 1) != 0 ? velocityEstimate2.pixelsPerSecond : j, (i & 2) != 0 ? velocityEstimate2.confidence : f, (i & 4) != 0 ? velocityEstimate2.durationMillis : j2, (i & 8) != 0 ? velocityEstimate2.offset : j3);
    }

    /* renamed from: component1-F1C5BW0  reason: not valid java name */
    public final long m3555component1F1C5BW0() {
    ...
    public final long m3556component4F1C5BW0() {
        return this.offset;
    }

    /* renamed from: copy-PZAlG8E  reason: not valid java name */
    public final VelocityEstimate m3557copyPZAlG8E(long j, float f, long j2, long j3) {
    ...
    public boolean equals(Object obj) {
        ...
        return Offset.m1680equalsimpl0(this.pixelsPerSecond, velocityEstimate.pixelsPerSecond) && Intrinsics.areEqual((Object) Float.valueOf(this.confidence), (Object) Float.valueOf(velocityEstimate.confidence)) && this.durationMillis == velocityEstimate.durationMillis && Offset.m1680equalsimpl0(this.offset, velocityEstimate.offset);
    }

    public int hashCode() {
        return (((((Offset.m1685hashCodeimpl(this.pixelsPerSecond) * 31) + Float.floatToIntBits(this.confidence)) * 31) + C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.durationMillis)) * 31) + Offset.m1685hashCodeimpl(this.offset);
    }

    public String toString() {
        return "VelocityEstimate(pixelsPerSecond=" + Offset.m1691toStringimpl(this.pixelsPerSecond) + ", confidence=" + this.confidence + ", durationMillis=" + this.durationMillis + ", offset=" + Offset.m1691toStringimpl(this.offset) + ')';
    }
    ...
    public final long m3559getPixelsPerSecondF1C5BW0() {
        return this.pixelsPerSecond;
    }
    ...
    public final long m3558getOffsetF1C5BW0() {
        return this.offset;
    }
