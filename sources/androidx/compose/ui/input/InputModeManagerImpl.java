...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> function1) {
        ...
        this.inputMode$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m2670boximpl(i), (SnapshotMutationPolicy) null, 2, (Object) null);
    }

    /* renamed from: getInputMode-aOaMEAU  reason: not valid java name */
    public int m2681getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m2676unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m2683setInputModeiuPiT84(int i) {
        this.inputMode$delegate.setValue(InputMode.m2670boximpl(i));
    }

    @ExperimentalComposeUiApi
    /* renamed from: requestInputMode-iuPiT84  reason: not valid java name */
    public boolean m2682requestInputModeiuPiT84(int i) {
        return this.onRequestInputModeChange.invoke(InputMode.m2670boximpl(i)).booleanValue();
    }
}
