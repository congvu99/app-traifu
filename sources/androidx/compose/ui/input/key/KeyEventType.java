...
public final class KeyEventType {
    ...
    public static final int KeyDown = m3273constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int KeyUp = m3273constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Unknown = m3273constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ KeyEventType m3272boximpl(int i) {
    ...
    public static boolean m3274equalsimpl(int i, Object obj) {
        return (obj instanceof KeyEventType) && i == ((KeyEventType) obj).m3278unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3275equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3276hashCodeimpl(int i) {
        return i;
    }
    ...
    public static String m3277toStringimpl(int i) {
        if (m3275equalsimpl0(i, KeyUp)) {
            return "KeyUp";
        }
        if (m3275equalsimpl0(i, KeyDown)) {
            return "KeyDown";
        }
        return m3275equalsimpl0(i, Unknown) ? AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN : "Invalid";
    }
