...
public final class ComposeView extends AbstractComposeView {
    ...
    public void Content(Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(Content)403@15629L8:ComposeView.android.kt#itgzvw");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(420213850, i, -1, "androidx.compose.ui.platform.ComposeView.Content (ComposeView.android.kt:402)");
        }
