...
final class AndroidComposeView$_inputModeManager$1 extends Lambda implements Function1<InputMode, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m3984invokeiuPiT84(((InputMode) obj).m2676unboximpl());
    }

    /* renamed from: invoke-iuPiT84  reason: not valid java name */
    public final Boolean m3984invokeiuPiT84(int i) {
        boolean z;
        if (InputMode.m2673equalsimpl0(i, InputMode.Companion.m2678getTouchaOaMEAU())) {
            z = this.this$0.isInTouchMode();
        } else {
            z = InputMode.m2673equalsimpl0(i, InputMode.Companion.m2677getKeyboardaOaMEAU()) ? this.this$0.isInTouchMode() ? this.this$0.requestFocusFromTouch() : true : false;
        }
