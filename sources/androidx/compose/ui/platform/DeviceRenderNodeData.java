...
public final class DeviceRenderNodeData {
    ...
    public static /* synthetic */ DeviceRenderNodeData copy$default(DeviceRenderNodeData deviceRenderNodeData, long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect2, int i9, Object obj) {
        DeviceRenderNodeData deviceRenderNodeData2 = deviceRenderNodeData;
        int i10 = i9;
        return deviceRenderNodeData.copy((i10 & 1) != 0 ? deviceRenderNodeData2.uniqueId : j, (i10 & 2) != 0 ? deviceRenderNodeData2.left : i, (i10 & 4) != 0 ? deviceRenderNodeData2.top : i2, (i10 & 8) != 0 ? deviceRenderNodeData2.right : i3, (i10 & 16) != 0 ? deviceRenderNodeData2.bottom : i4, (i10 & 32) != 0 ? deviceRenderNodeData2.width : i5, (i10 & 64) != 0 ? deviceRenderNodeData2.height : i6, (i10 & 128) != 0 ? deviceRenderNodeData2.scaleX : f, (i10 & 256) != 0 ? deviceRenderNodeData2.scaleY : f2, (i10 & 512) != 0 ? deviceRenderNodeData2.translationX : f3, (i10 & 1024) != 0 ? deviceRenderNodeData2.translationY : f4, (i10 & 2048) != 0 ? deviceRenderNodeData2.elevation : f5, (i10 & 4096) != 0 ? deviceRenderNodeData2.ambientShadowColor : i7, (i10 & 8192) != 0 ? deviceRenderNodeData2.spotShadowColor : i8, (i10 & 16384) != 0 ? deviceRenderNodeData2.rotationZ : f6, (i10 & 32768) != 0 ? deviceRenderNodeData2.rotationX : f7, (i10 & 65536) != 0 ? deviceRenderNodeData2.rotationY : f8, (i10 & 131072) != 0 ? deviceRenderNodeData2.cameraDistance : f9, (i10 & 262144) != 0 ? deviceRenderNodeData2.pivotX : f10, (i10 & 524288) != 0 ? deviceRenderNodeData2.pivotY : f11, (i10 & 1048576) != 0 ? deviceRenderNodeData2.clipToOutline : z, (i10 & 2097152) != 0 ? deviceRenderNodeData2.clipToBounds : z2, (i10 & 4194304) != 0 ? deviceRenderNodeData2.alpha : f12, (i10 & 8388608) != 0 ? deviceRenderNodeData2.renderEffect : renderEffect2);
    }
    ...
    public final DeviceRenderNodeData copy(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect2) {
        return new DeviceRenderNodeData(j, i, i2, i3, i4, i5, i6, f, f2, f3, f4, f5, i7, i8, f6, f7, f8, f9, f10, f11, z, z2, f12, renderEffect2);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((((((((((((((((((((((((((C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.uniqueId) * 31) + this.left) * 31) + this.top) * 31) + this.right) * 31) + this.bottom) * 31) + this.width) * 31) + this.height) * 31) + Float.floatToIntBits(this.scaleX)) * 31) + Float.floatToIntBits(this.scaleY)) * 31) + Float.floatToIntBits(this.translationX)) * 31) + Float.floatToIntBits(this.translationY)) * 31) + Float.floatToIntBits(this.elevation)) * 31) + this.ambientShadowColor) * 31) + this.spotShadowColor) * 31) + Float.floatToIntBits(this.rotationZ)) * 31) + Float.floatToIntBits(this.rotationX)) * 31) + Float.floatToIntBits(this.rotationY)) * 31) + Float.floatToIntBits(this.cameraDistance)) * 31) + Float.floatToIntBits(this.pivotX)) * 31) + Float.floatToIntBits(this.pivotY)) * 31;
    ...
    public DeviceRenderNodeData(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect2) {
        this.uniqueId = j;
        this.left = i;
        this.top = i2;
        this.right = i3;
