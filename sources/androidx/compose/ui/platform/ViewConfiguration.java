...
public interface ViewConfiguration {
    ...
    long m4057getMinimumTouchTargetSizeMYxV2XQ();
    ...
    public static final class DefaultImpls {
        @Deprecated
        /* renamed from: getMinimumTouchTargetSize-MYxV2XQ  reason: not valid java name */
        public static long m4060getMinimumTouchTargetSizeMYxV2XQ(ViewConfiguration viewConfiguration) {
            return CC.m4058$default$getMinimumTouchTargetSizeMYxV2XQ(viewConfiguration);
        }
    }
    ...
    public final /* synthetic */ class CC {
        ...
        public static long m4058$default$getMinimumTouchTargetSizeMYxV2XQ(ViewConfiguration _this) {
            float f = (float) 48;
            return DpKt.m4726DpSizeYgX7TsA(Dp.m4704constructorimpl(f), Dp.m4704constructorimpl(f));
        }
    }
}
