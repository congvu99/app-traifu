...
public final class AndroidCompositionLocals_androidKt {
    ...
    public static final void ProvideAndroidCompositionLocals(AndroidComposeView androidComposeView, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        if (viewTreeOwners != null) {
            ...
            Intrinsics.checkNotNullExpressionValue(context, "context");
            ImageVectorCache obtainImageVectorCache = obtainImageVectorCache(context, m3994ProvideAndroidCompositionLocals$lambda1(mutableState), startRestartGroup, 72);
            ProvidableCompositionLocal<Configuration> providableCompositionLocal = LocalConfiguration;
            Configuration r3 = m3994ProvideAndroidCompositionLocals$lambda1(mutableState);
    ...
    private static final Configuration m3994ProvideAndroidCompositionLocals$lambda1(MutableState<Configuration> mutableState) {
    ...
    public static final void m3995ProvideAndroidCompositionLocals$lambda2(MutableState<Configuration> mutableState, Configuration configuration) {
