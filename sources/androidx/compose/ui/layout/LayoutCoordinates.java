...
public interface LayoutCoordinates {
    ...
    long m3612localPositionOfR5De75A(LayoutCoordinates layoutCoordinates, long j);

    /* renamed from: localToRoot-MK-Hz9U  reason: not valid java name */
    long m3613localToRootMKHz9U(long j);

    /* renamed from: localToWindow-MK-Hz9U  reason: not valid java name */
    long m3614localToWindowMKHz9U(long j);

    /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
    void m3615transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, float[] fArr);

    /* renamed from: windowToLocal-MK-Hz9U  reason: not valid java name */
    long m3616windowToLocalMKHz9U(long j);
    ...
    public final /* synthetic */ class CC {
        ...
        public static void m3617$default$transformFromEL8BTi8(LayoutCoordinates _this, LayoutCoordinates layoutCoordinates, float[] fArr) {
    ...
    public static final class DefaultImpls {
        @Deprecated
        /* renamed from: transformFrom-EL8BTi8  reason: not valid java name */
        public static void m3619transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, float[] fArr) {
            Intrinsics.checkNotNullParameter(layoutCoordinates2, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(fArr, "matrix");
            CC.m3617$default$transformFromEL8BTi8(layoutCoordinates, layoutCoordinates2, fArr);
        }
    }
}
