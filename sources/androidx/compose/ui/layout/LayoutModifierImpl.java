...
final class LayoutModifierImpl extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult m3622measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return this.measureBlock.invoke(measureScope, measurable, Constraints.m4612boximpl(j));
    }
