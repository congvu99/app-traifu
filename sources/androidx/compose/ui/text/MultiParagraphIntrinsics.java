...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString2, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, Density density, FontFamily.Resolver resolver) {
        ...
        AnnotatedString annotatedString4 = this.annotatedString;
        List<AnnotatedString.Range<ParagraphStyle>> normalizedParagraphStyles = AnnotatedStringKt.normalizedParagraphStyles(annotatedString4, paragraphStyle);
        ArrayList arrayList = new ArrayList(normalizedParagraphStyles.size());
        int size = normalizedParagraphStyles.size();
        int i = 0;
        while (i < size) {
            AnnotatedString.Range range = normalizedParagraphStyles.get(i);
            AnnotatedString access$substringWithoutParagraphStyles = AnnotatedStringKt.substringWithoutParagraphStyles(annotatedString4, range.getStart(), range.getEnd());
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle paragraphStyle, ParagraphStyle paragraphStyle2) {
        TextDirection r0 = paragraphStyle.m4145getTextDirectionmmuk1to();
        if (r0 != null) {
            r0.m4566unboximpl();
        ...
        return ParagraphStyle.m4137copyElsmlbk$default(paragraphStyle, (TextAlign) null, paragraphStyle2.m4145getTextDirectionmmuk1to(), 0, (TextIndent) null, 13, (Object) null);
    }
}
