...
public final class SegmentBreaker {
    ...
    private final List<Segment> breakSegmentWithParagraph(LayoutHelper layoutHelper) {
        ...
        for (int i = 0; i < paragraphCount; i++) {
            ...
            int lineForOffset = LayoutCompatKt.getLineForOffset(layout, paragraphStart, false);
            int lineForOffset2 = LayoutCompatKt.getLineForOffset(layout, paragraphEnd, true);
            arrayList.add(new Segment(paragraphStart, paragraphEnd, 0, layout.getLineTop(lineForOffset), layout.getWidth(), layout.getLineBottom(lineForOffset2)));
        }
        return arrayList;
    }
