...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph m4434ActualParagraphO3s9Psw(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z, long j, Density density, FontFamily.Resolver resolver) {
        Intrinsics.checkNotNullParameter(str, "text");
    ...
    public static final Paragraph m4433ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
