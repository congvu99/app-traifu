...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public final Size m4460getSizeVsRJwc0() {
        return this.size;
    }

    /* renamed from: setSize-iaC8Vc4  reason: not valid java name */
    public final void m4461setSizeiaC8Vc4(Size size2) {
        this.size = size2;
    }
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (size2 != null) {
                textPaint.setShader(this.shaderBrush.m2251createShaderuvyYCjk(size2.m1757unboximpl()));
            }
