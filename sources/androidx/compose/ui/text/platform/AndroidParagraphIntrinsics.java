...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    private final int textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m4431resolveTextDirectionHeuristics9GRLPo0(this.style.m4245getTextDirectionmmuk1to(), this.style.getLocaleList());
    private final AndroidTextPaint textPaint = new AndroidTextPaint(1, this.density.getDensity());
    ...
    public AndroidParagraphIntrinsics(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver resolver, Density density2) {
        ...
        Function4 androidParagraphIntrinsics$resolveTypeface$1 = new AndroidParagraphIntrinsics$resolveTypeface$1(this);
        this.charSequence = AndroidParagraphHelper_androidKt.createCharSequence(this.text, this.textPaint.getTextSize(), this.style, CollectionsKt.plus(CollectionsKt.listOf(new AnnotatedString.Range(TextPaintExtensions_androidKt.applySpanStyle(this.textPaint, this.style.toSpanStyle(), androidParagraphIntrinsics$resolveTypeface$1, this.density), 0, this.text.length())), this.spanStyles), this.placeholders, this.density, androidParagraphIntrinsics$resolveTypeface$1);
