...
final class SpannableExtensions_androidKt$setFontAttributes$1 extends Lambda implements Function3<SpanStyle, Integer, Integer, Unit> {
    ...
    public final void invoke(SpanStyle spanStyle, int i, int i2) {
        ...
        FontStyle r5 = spanStyle.m4185getFontStyle4Lr2A7w();
        FontStyle r52 = FontStyle.m4305boximpl(r5 != null ? r5.m4311unboximpl() : FontStyle.Companion.m4313getNormal_LCdwA());
        FontSynthesis r7 = spanStyle.m4186getFontSynthesisZQGJjVo();
        spannable.setSpan(new TypefaceSpan(function4.invoke(fontFamily, fontWeight, r52, FontSynthesis.m4314boximpl(r7 != null ? r7.m4322unboximpl() : FontSynthesis.Companion.m4323getAllGVVA2EU()))), i, i2, 33);
    }
}
