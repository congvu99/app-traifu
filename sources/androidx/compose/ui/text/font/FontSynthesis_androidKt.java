...
public final class FontSynthesis_androidKt {
    ...
    public static final Object m4327synthesizeTypefaceFxwP2eA(int i, Object obj, Font font, FontWeight fontWeight, int i2) {
        Typeface typeface;
        int i3;
        boolean z;
        ...
        boolean z2 = true;
        boolean z3 = FontSynthesis.m4320isWeightOnimpl$ui_text_release(i) && !Intrinsics.areEqual((Object) font.getWeight(), (Object) fontWeight) && fontWeight.compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.Companion)) >= 0 && font.getWeight().compareTo(AndroidFontUtils_androidKt.getAndroidBold(FontWeight.Companion)) < 0;
        boolean z4 = FontSynthesis.m4319isStyleOnimpl$ui_text_release(i) && !FontStyle.m4308equalsimpl0(i2, font.m4281getStyle_LCdwA());
        if (!z4 && !z3) {
            return obj;
        }
        if (Build.VERSION.SDK_INT < 28) {
            if (!z4 || !FontStyle.m4308equalsimpl0(i2, FontStyle.Companion.m4312getItalic_LCdwA())) {
                z2 = false;
            }
            ...
            if (z4) {
                z = FontStyle.m4308equalsimpl0(i2, FontStyle.Companion.m4312getItalic_LCdwA());
            } else {
                z = FontStyle.m4308equalsimpl0(font.m4281getStyle_LCdwA(), FontStyle.Companion.m4312getItalic_LCdwA());
            }
