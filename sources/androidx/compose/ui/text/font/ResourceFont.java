...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m4354getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L_0x000a:
            ...
            int r10 = r9.m4313getNormal_LCdwA()
        L_0x0015:
            r3 = r10
            r9 = r13 & 8
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m4328Settings6EWAqTQ(r2, r3, r10)
        L_0x0023:
            r4 = r11
            r9 = r13 & 16
            ...
            int r12 = r9.m4299getAsyncPKNRLFQ()
        L_0x002e:
            r5 = r12
            r6 = 0
            r0 = r7
    ...
    public int m4358getStyle_LCdwA() {
        return this.style;
    }
    ...
    public int m4357getLoadingStrategyPKNRLFQ() {
        return this.loadingStrategy;
    }

    /* renamed from: copy-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m4353copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.m4358getStyle_LCdwA();
        }
        return resourceFont.m4356copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m4356copyRetOiIg(int i, FontWeight fontWeight, int i2) {
        Intrinsics.checkNotNullParameter(fontWeight, "weight");
        return m4352copyF3nL8kk$default(this, i, fontWeight, i2, m4357getLoadingStrategyPKNRLFQ(), (FontVariation.Settings) null, 16, (Object) null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m4352copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        int i5 = i2;
        if ((i4 & 8) != 0) {
            i3 = resourceFont.m4357getLoadingStrategyPKNRLFQ();
        }
        int i6 = i3;
        if ((i4 & 16) != 0) {
            settings = resourceFont.variationSettings;
        }
        return resourceFont.m4355copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    @ExperimentalTextApi
    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m4355copyF3nL8kk(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings) {
        Intrinsics.checkNotNullParameter(fontWeight, "weight");
    ...
    public boolean equals(Object obj) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual((Object) getWeight(), (Object) resourceFont.getWeight()) && FontStyle.m4308equalsimpl0(m4358getStyle_LCdwA(), resourceFont.m4358getStyle_LCdwA()) && Intrinsics.areEqual((Object) this.variationSettings, (Object) resourceFont.variationSettings) && FontLoadingStrategy.m4295equalsimpl0(m4357getLoadingStrategyPKNRLFQ(), resourceFont.m4357getLoadingStrategyPKNRLFQ());
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m4309hashCodeimpl(m4358getStyle_LCdwA())) * 31) + FontLoadingStrategy.m4296hashCodeimpl(m4357getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + FontStyle.m4310toStringimpl(m4358getStyle_LCdwA()) + ", loadingStrategy=" + FontLoadingStrategy.m4297toStringimpl(m4357getLoadingStrategyPKNRLFQ()) + ')';
    }
}
