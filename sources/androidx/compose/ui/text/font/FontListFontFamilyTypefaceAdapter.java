...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m4295equalsimpl0(font.m4280getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m4299getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        List list = arrayList;
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList2.add(TuplesKt.to(font2.getWeight(), FontStyle.m4305boximpl(font2.m4281getStyle_LCdwA())));
        }
        ...
        while (i4 < size4) {
            ...
            int r4 = ((FontStyle) pair.component2()).m4311unboximpl();
            List<Font> r15 = fontMatcher.m4304matchFontRetOiIg((List<? extends Font>) fonts, fontWeight, r4);
            TypefaceRequest typefaceRequest = r1;
            TypefaceRequest typefaceRequest2 = new TypefaceRequest(fontFamily, fontWeight, r4, FontSynthesis.Companion.m4323getAllGVVA2EU(), platformFontLoader.getCacheKey(), (DefaultConstructorMarker) null);
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        ...
        Pair access$firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m4304matchFontRetOiIg((List<? extends Font>) ((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m4363getFontStyle_LCdwA()), typefaceRequest2, this.asyncTypefaceCache, platformFontLoader2, function13);
