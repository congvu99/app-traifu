...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public State<Object> m4285resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        Intrinsics.checkNotNullParameter(fontWeight, ViewProps.FONT_WEIGHT);
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m4331interceptFontStyleT2F_aPo(i), this.platformResolveInterceptor.m4332interceptFontSynthesisMscr08Y(i2), this.platformFontLoader.getCacheKey(), (DefaultConstructorMarker) null));
    }
