...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        ...
        if (z) {
            typeface = this.platformTypefaceResolver.m4337createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4363getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typeface = this.platformTypefaceResolver.m4338createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4363getFontStyle_LCdwA());
            ...
            typeface = ((AndroidTypeface) typeface2).m4445getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4363getFontStyle_LCdwA(), typefaceRequest.m4364getFontSynthesisGVVA2EU());
        }
