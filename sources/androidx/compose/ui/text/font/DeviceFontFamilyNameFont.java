...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    public int m4277getStyle_LCdwA() {
        return this.style;
    }

    private DeviceFontFamilyNameFont(String str, FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m4301getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, settings, (DefaultConstructorMarker) null);
        this.familyName = str;
    ...
    public final Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().m4339optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), m4277getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return DeviceFontFamilyName.m4273equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual((Object) getWeight(), (Object) deviceFontFamilyNameFont.getWeight()) && FontStyle.m4308equalsimpl0(m4277getStyle_LCdwA(), deviceFontFamilyNameFont.m4277getStyle_LCdwA()) && Intrinsics.areEqual((Object) getVariationSettings(), (Object) deviceFontFamilyNameFont.getVariationSettings());
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m4274hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m4309hashCodeimpl(m4277getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + DeviceFontFamilyName.m4275toStringimpl(this.familyName) + "\", weight=" + getWeight() + ", style=" + FontStyle.m4310toStringimpl(m4277getStyle_LCdwA()) + ')';
    }
}
