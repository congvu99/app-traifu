...
public final class AndroidFileDescriptorFont extends AndroidPreloadedFont {
    ...
    public /* synthetic */ AndroidFileDescriptorFont(ParcelFileDescriptor parcelFileDescriptor, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(parcelFileDescriptor, (i2 & 2) != 0 ? FontWeight.Companion.getNormal() : fontWeight, (i2 & 4) != 0 ? FontStyle.Companion.m4313getNormal_LCdwA() : i, settings, (DefaultConstructorMarker) null);
    }
    ...
    public String toString() {
        return "Font(fileDescriptor=" + this.fileDescriptor + ", weight=" + getWeight() + ", style=" + FontStyle.m4310toStringimpl(m4260getStyle_LCdwA()) + ')';
    }
}
