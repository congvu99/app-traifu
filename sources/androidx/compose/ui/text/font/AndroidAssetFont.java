...
public final class AndroidAssetFont extends AndroidPreloadedFont {
    ...
    public /* synthetic */ AndroidAssetFont(AssetManager assetManager2, String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(assetManager2, str, (i2 & 4) != 0 ? FontWeight.Companion.getNormal() : fontWeight, (i2 & 8) != 0 ? FontStyle.Companion.m4313getNormal_LCdwA() : i, settings, (DefaultConstructorMarker) null);
    }
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + FontStyle.m4310toStringimpl(m4260getStyle_LCdwA()) + ')';
    }
