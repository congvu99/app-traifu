...
public final class AsyncTypefaceCache {
    private final Object PermanentFailure = AsyncTypefaceResult.m4263constructorimpl((Object) null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m4262boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static Object m4263constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m4264equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m4269unboximpl());
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m4265equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m4266hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static final boolean m4267isPermanentFailureimpl(Object obj) {
            return obj == null;
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m4268toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m4264equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m4266hashCodeimpl(this.result);
        }

        public String toString() {
            return m4268toStringimpl(this.result);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ Object m4269unboximpl() {
            return this.result;
        }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object obj, boolean z) {
        ...
        synchronized (this.cacheLock) {
            if (obj == null) {
                try {
                    AsyncTypefaceResult put = this.permanentCache.put(key, AsyncTypefaceResult.m4262boximpl(this.PermanentFailure));
                } catch (Throwable th) {
                    throw th;
                }
            } else if (z) {
                AsyncTypefaceResult put2 = this.permanentCache.put(key, AsyncTypefaceResult.m4262boximpl(AsyncTypefaceResult.m4263constructorimpl(obj)));
            } else {
                AsyncTypefaceResult put3 = this.resultCache.put(key, AsyncTypefaceResult.m4262boximpl(AsyncTypefaceResult.m4263constructorimpl(obj)));
            }
        }
    }

    /* renamed from: get-1ASDuI8  reason: not valid java name */
    public final AsyncTypefaceResult m4261get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
    ...
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r6, androidx.compose.ui.text.font.PlatformFontLoader r7, boolean r8, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<java.lang.Object> r10) {
        ...
        L_0x005d:
            ...
            java.lang.Object r7 = r7.m4269unboximpl()     // Catch:{ all -> 0x00b1 }
            monitor-exit(r6)
            return r7
        L_0x0065:
        ...
        L_0x007b:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r7 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4262boximpl(r7)     // Catch:{ all -> 0x008c }
        ...
        L_0x008e:
            ...
            java.lang.Object r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4263constructorimpl(r10)     // Catch:{ all -> 0x008c }
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m4262boximpl(r8)     // Catch:{ all -> 0x008c }
    ...
    public final java.lang.Object runCachedBlocking(androidx.compose.ui.text.font.Font r11, androidx.compose.ui.text.font.PlatformFontLoader r12, kotlin.jvm.functions.Function0<? extends java.lang.Object> r13) {
        /*
            ...
            monitor-enter(r0)
            r1 = 1
            androidx.compose.ui.text.font.AsyncTypefaceCache$Key r2 = new androidx.compose.ui.text.font.AsyncTypefaceCache$Key     // Catch:{ all -> 0x005e }
            java.lang.Object r3 = r12.getCacheKey()     // Catch:{ all -> 0x005e }
            r2.<init>(r11, r3)     // Catch:{ all -> 0x005e }
            androidx.compose.ui.text.caches.LruCache r3 = r10.resultCache     // Catch:{ all -> 0x005e }
            java.lang.Object r3 = r3.get(r2)     // Catch:{ all -> 0x005e }
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r3 = (androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult) r3     // Catch:{ all -> 0x005e }
            if (r3 != 0) goto L_0x0036
            androidx.compose.ui.text.caches.SimpleArrayMap r3 = r10.permanentCache     // Catch:{ all -> 0x005e }
            java.lang.Object r2 = r3.get(r2)     // Catch:{ all -> 0x005e }
            r3 = r2
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r3 = (androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult) r3     // Catch:{ all -> 0x005e }
        L_0x0036:
            if (r3 == 0) goto L_0x0045
            java.lang.Object r11 = r3.m4269unboximpl()     // Catch:{ all -> 0x005e }
            r12 = 2
