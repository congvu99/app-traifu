...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m4259getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, ViewProps.FONT_WEIGHT);
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m4308equalsimpl0(i, FontStyle.Companion.m4312getItalic_LCdwA()));
    }
}
