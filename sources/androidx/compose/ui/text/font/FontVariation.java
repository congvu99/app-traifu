...
public final class FontVariation {
            ...
            while (true) {
                ...
                if (it.hasNext()) {
                    ...
                    if (list.size() != 1 ? false : z2) {
                        ...
                        throw new IllegalArgumentException(('\'' + str + "' must be unique. Actual [ [" + CollectionsKt.joinToString$default(list, (CharSequence) null, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 63, (Object) null) + JsonLexerKt.END_LIST).toString());
                    }
                } else {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public final long m4330getValueXSAIIZE() {
            return this.value;
        }

        public float toVariationValue(Density density) {
            if (density != null) {
                return TextUnit.m4885getValueimpl(this.value) * density.getFontScale();
            }
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual((Object) getAxisName(), (Object) settingTextUnit.getAxisName()) && TextUnit.m4882equalsimpl0(this.value, settingTextUnit.value);
        }

        public int hashCode() {
            return (getAxisName().hashCode() * 31) + TextUnit.m4886hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + TextUnit.m4892toStringimpl(this.value) + ')';
        }
    }
    ...
    public final Setting m4329opticalSizingR2X_6o(long j) {
        if (TextUnit.m4888isSpimpl(j)) {
    ...
    public final Settings m4328Settings6EWAqTQ(FontWeight fontWeight, int i, Setting... settingArr) {
