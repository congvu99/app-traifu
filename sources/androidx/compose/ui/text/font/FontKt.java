...
public final class FontKt {
    ...
    public static /* synthetic */ Font m4289FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i3 & 4) != 0) {
            i2 = FontStyle.Companion.m4313getNormal_LCdwA();
        }
        return Intrinsics.checkNotNullParameter(fontWeight, "weight");
    }

    /* renamed from: Font-YpTlLL0$default  reason: not valid java name */
    public static /* synthetic */ Font m4291FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.Companion.m4300getBlockingPKNRLFQ();
        }
        return m4290FontYpTlLL0(i, fontWeight, i2, i3);
    }

    /* renamed from: Font-YpTlLL0  reason: not valid java name */
    public static final Font m4290FontYpTlLL0(int i, FontWeight fontWeight, int i2, int i3) {
    ...
    public static /* synthetic */ Font m4287FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m4328Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m4286FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }

    @ExperimentalTextApi
    /* renamed from: Font-F3nL8kk  reason: not valid java name */
    public static final Font m4286FontF3nL8kk(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings) {
        Intrinsics.checkNotNullParameter(fontWeight, "weight");
