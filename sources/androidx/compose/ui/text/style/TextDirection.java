...
public final class TextDirection {
    ...
    public static final int Content = m4561constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int ContentOrLtr = m4561constructorimpl(4);
    /* access modifiers changed from: private */
    public static final int ContentOrRtl = m4561constructorimpl(5);
    /* access modifiers changed from: private */
    public static final int Ltr = m4561constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Rtl = m4561constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextDirection m4560boximpl(int i) {
    ...
    public static boolean m4562equalsimpl(int i, Object obj) {
        return (obj instanceof TextDirection) && i == ((TextDirection) obj).m4566unboximpl();
    }
    ...
    public static String m4565toStringimpl(int i) {
        if (m4563equalsimpl0(i, Ltr)) {
            return "Ltr";
        }
        if (m4563equalsimpl0(i, Rtl)) {
            return "Rtl";
        }
        if (m4563equalsimpl0(i, Content)) {
            return "Content";
        }
        if (m4563equalsimpl0(i, ContentOrLtr)) {
            return "ContentOrLtr";
        }
        return m4563equalsimpl0(i, ContentOrRtl) ? "ContentOrRtl" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4570getLtrs_7Xco() {
            return TextDirection.Ltr;
        }

        /* renamed from: getRtl-s_7X-co  reason: not valid java name */
        public final int m4571getRtls_7Xco() {
            return TextDirection.Rtl;
        }

        /* renamed from: getContent-s_7X-co  reason: not valid java name */
        public final int m4567getContents_7Xco() {
            return TextDirection.Content;
        }

        /* renamed from: getContentOrLtr-s_7X-co  reason: not valid java name */
        public final int m4568getContentOrLtrs_7Xco() {
            return TextDirection.ContentOrLtr;
        }

        /* renamed from: getContentOrRtl-s_7X-co  reason: not valid java name */
        public final int m4569getContentOrRtls_7Xco() {
