...
public final class BaselineShift {
    ...
    public static final float None = m4463constructorimpl(0.0f);
    /* access modifiers changed from: private */
    public static final float Subscript = m4463constructorimpl(-0.5f);
    /* access modifiers changed from: private */
    public static final float Superscript = m4463constructorimpl(0.5f);
    private final float multiplier;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BaselineShift m4462boximpl(float f) {
        return new BaselineShift(f);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static float m4463constructorimpl(float f) {
        return f;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4464equalsimpl(float f, Object obj) {
        if (!(obj instanceof BaselineShift)) {
            return false;
        }
        return Intrinsics.areEqual((Object) Float.valueOf(f), (Object) Float.valueOf(((BaselineShift) obj).m4468unboximpl()));
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4465equalsimpl0(float f, float f2) {
        return Intrinsics.areEqual((Object) Float.valueOf(f), (Object) Float.valueOf(f2));
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4466hashCodeimpl(float f) {
        return Float.floatToIntBits(f);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4467toStringimpl(float f) {
        return "BaselineShift(multiplier=" + f + ')';
    }

    public boolean equals(Object obj) {
        return m4464equalsimpl(this.multiplier, obj);
    }

    public int hashCode() {
        return m4466hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m4467toStringimpl(this.multiplier);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ float m4468unboximpl() {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4469getNoney9eOQZs$annotations() {
        }

        /* renamed from: getSubscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m4470getSubscripty9eOQZs$annotations() {
        }

        /* renamed from: getSuperscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m4471getSuperscripty9eOQZs$annotations() {
        }
