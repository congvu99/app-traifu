...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m4574from8_81llA(ColorKt.m1984lerpjxsXWHM(textForegroundStyle.m4573getColor0d7_KjU(), textForegroundStyle2.m4573getColor0d7_KjU(), f));
        }
        if (!z || !(textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m4572modulateDxMtmZc(long j, float f) {
