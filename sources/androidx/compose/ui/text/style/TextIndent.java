...
public final class TextIndent {
    ...
    public final long m4578getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE  reason: not valid java name */
    public final long m4579getRestLineXSAIIZE() {
    ...
    public static /* synthetic */ TextIndent m4576copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m4577copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo  reason: not valid java name */
    public final TextIndent m4577copyNB67dxo(long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        return TextUnit.m4882equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m4882equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m4886hashCodeimpl(this.firstLine) * 31) + TextUnit.m4886hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + TextUnit.m4892toStringimpl(this.firstLine) + ", restLine=" + TextUnit.m4892toStringimpl(this.restLine) + ')';
    }
}
