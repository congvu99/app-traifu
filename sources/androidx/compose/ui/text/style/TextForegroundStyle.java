...
public interface TextForegroundStyle {
    ...
    public final /* synthetic */ class CC {
        public static TextForegroundStyle $default$merge(TextForegroundStyle _this, TextForegroundStyle textForegroundStyle) {
            ...
            if (z && (_this instanceof BrushStyle)) {
                return new BrushStyle(((BrushStyle) textForegroundStyle).getValue(), TextDrawStyleKt.takeOrElse(textForegroundStyle.getAlpha(), new TextForegroundStyle$merge$1(_this)));
            }
            if (z && !(_this instanceof BrushStyle)) {
                return textForegroundStyle;
            }
            if (z || !(_this instanceof BrushStyle)) {
                return textForegroundStyle.takeOrElse(new TextForegroundStyle$merge$2(_this));
            }
            return _this;
        }
        ...
        public static TextForegroundStyle $default$takeOrElse(TextForegroundStyle _this, Function0 function0) {
            ...
            return !Intrinsics.areEqual((Object) _this, (Object) Unspecified.INSTANCE) ? _this : (TextForegroundStyle) function0.invoke();
        }
    }
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public /* synthetic */ TextForegroundStyle takeOrElse(Function0<? extends TextForegroundStyle> function0) {
        ...
        /* renamed from: getColor-0d7_KjU  reason: not valid java name */
        public long m4575getColor0d7_KjU() {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float f) {
            ...
            if (brush instanceof SolidColor) {
                return m4574from8_81llA(TextDrawStyleKt.m4572modulateDxMtmZc(((SolidColor) brush).m2269getValue0d7_KjU(), f));
            }
        ...
        public final TextForegroundStyle m4574from8_81llA(long j) {
            return (j > Color.Companion.m1968getUnspecified0d7_KjU() ? 1 : (j == Color.Companion.m1968getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(j, (DefaultConstructorMarker) null) : Unspecified.INSTANCE;
        }
    }
}
