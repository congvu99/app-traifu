...
public final class TextOverflow {
    ...
    public static final int Clip = m4581constructorimpl(1);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Ellipsis = m4581constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int Visible = m4581constructorimpl(3);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextOverflow m4580boximpl(int i) {
        return new TextOverflow(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4581constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4582equalsimpl(int i, Object obj) {
        return (obj instanceof TextOverflow) && i == ((TextOverflow) obj).m4586unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m4582equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4584hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m4585toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4585toStringimpl(int i) {
        if (m4583equalsimpl0(i, Clip)) {
            return "Clip";
        }
        if (m4583equalsimpl0(i, Ellipsis)) {
            return "Ellipsis";
        }
        return m4583equalsimpl0(i, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4587getClipgIe3tQ8$annotations() {
        }

        /* renamed from: getEllipsis-gIe3tQ8$annotations  reason: not valid java name */
        public static /* synthetic */ void m4588getEllipsisgIe3tQ8$annotations() {
        }

        /* renamed from: getVisible-gIe3tQ8$annotations  reason: not valid java name */
        public static /* synthetic */ void m4589getVisiblegIe3tQ8$annotations() {
        }
        ...
        public final int m4590getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8  reason: not valid java name */
        public final int m4591getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8  reason: not valid java name */
        public final int m4592getVisiblegIe3tQ8() {
