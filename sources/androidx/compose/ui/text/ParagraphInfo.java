...
public final class ParagraphInfo {
    ...
    public final long m4132toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1683getXimpl(j), Offset.m1684getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m1720translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.m2187translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m4131toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4220getStartimpl(j)), toGlobalIndex(TextRange.m4215getEndimpl(j)));
    }
}
