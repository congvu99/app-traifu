...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.Companion.m4398getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.Companion.m4415getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.Companion.m4375getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }

    /* renamed from: getCapitalization-IUNYP9k  reason: not valid java name */
    public final int m4385getCapitalizationIUNYP9k() {
    ...
    public final int m4387getKeyboardTypePjHm6EE() {
        return this.keyboardType;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m4386getImeActioneUduSuo() {
    ...
    public static /* synthetic */ ImeOptions m4383copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m4384copyuxg59PA(z, i5, z3, i6, i3);
    }

    /* renamed from: copy-uxg59PA  reason: not valid java name */
    public final ImeOptions m4384copyuxg59PA(boolean z, int i, boolean z2, int i2, int i3) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m4393equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m4404equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m4371equalsimpl0(this.imeAction, imeOptions.imeAction);
    }

    public int hashCode() {
        return (((((((C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.singleLine) * 31) + KeyboardCapitalization.m4394hashCodeimpl(this.capitalization)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4405hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4372hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + KeyboardCapitalization.m4395toStringimpl(this.capitalization) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + KeyboardType.m4406toStringimpl(this.keyboardType) + ", imeAction=" + ImeAction.m4373toStringimpl(this.imeAction) + ')';
    }
}
