...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue textFieldValue, InputMethodManager inputMethodManager, View view) {
        ...
        if (this.isActive) {
            ...
            TextRange r0 = textFieldValue.m4421getCompositionMzsxiRA();
            int r6 = r0 != null ? TextRange.m4218getMinimpl(r0.m4224unboximpl()) : -1;
            TextRange r02 = textFieldValue.m4421getCompositionMzsxiRA();
            inputMethodManager.updateSelection(view, TextRange.m4218getMinimpl(textFieldValue.m4422getSelectiond9O1mEE()), TextRange.m4217getMaximpl(textFieldValue.m4422getSelectiond9O1mEE()), r6, r02 != null ? TextRange.m4217getMaximpl(r02.m4224unboximpl()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m4214getCollapsedimpl(this.mTextFieldValue.m4422getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4218getMinimpl(this.mTextFieldValue.m4422getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        ...
        if (i != 0) {
            switch (i) {
                case 2:
                    i2 = ImeAction.Companion.m4377getGoeUduSuo();
                    break;
                case 3:
                    i2 = ImeAction.Companion.m4381getSearcheUduSuo();
                    break;
                case 4:
                    i2 = ImeAction.Companion.m4382getSendeUduSuo();
                    break;
                case 5:
                    i2 = ImeAction.Companion.m4378getNexteUduSuo();
                    break;
                case 6:
                    i2 = ImeAction.Companion.m4376getDoneeUduSuo();
                    break;
                case 7:
                    i2 = ImeAction.Companion.m4380getPreviouseUduSuo();
                    break;
                default:
                    Log.w(RecordingInputConnection_androidKt.TAG, "IME sends unsupported Editor Action: " + i);
                    i2 = ImeAction.Companion.m4375getDefaulteUduSuo();
                    break;
            }
        } else {
            i2 = ImeAction.Companion.m4375getDefaulteUduSuo();
        }
        this.eventCallback.m4389onImeActionKlQnJC8(i2);
        return true;
    }
