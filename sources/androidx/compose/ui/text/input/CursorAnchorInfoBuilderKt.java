...
public final class CursorAnchorInfoBuilderKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, TextLayoutResult textLayoutResult, Matrix matrix) {
        ...
        int r5 = TextRange.m4218getMinimpl(textFieldValue.m4422getSelectiond9O1mEE());
        builder.setSelectionRange(r5, TextRange.m4217getMaximpl(textFieldValue.m4422getSelectiond9O1mEE()));
        setInsertionMarker(builder, r5, textLayoutResult);
        TextRange r4 = textFieldValue.m4421getCompositionMzsxiRA();
        int i = -1;
        int r42 = r4 != null ? TextRange.m4218getMinimpl(r4.m4224unboximpl()) : -1;
        TextRange r0 = textFieldValue.m4421getCompositionMzsxiRA();
        if (r0 != null) {
            i = TextRange.m4217getMaximpl(r0.m4224unboximpl());
        }
        boolean z = false;
        if (r42 >= 0 && r42 < i) {
            z = true;
