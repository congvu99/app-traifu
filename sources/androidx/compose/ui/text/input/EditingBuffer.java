...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString annotatedString, long j) {
        ...
        this.selectionStart = TextRange.m4218getMinimpl(j);
        this.selectionEnd = TextRange.m4217getMaximpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int r0 = TextRange.m4218getMinimpl(j);
        int r5 = TextRange.m4217getMaximpl(j);
    ...
    public final TextRange m4365getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4208boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }

    /* renamed from: getSelection-d9O1mEE$ui_text_release  reason: not valid java name */
    public final long m4366getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int i, int i2) {
        ...
        long r5 = EditingBufferKt.m4367updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m4218getMinimpl(r5));
        setSelectionEnd(TextRange.m4217getMaximpl(r5));
        if (hasComposition$ui_text_release()) {
            long r52 = EditingBufferKt.m4367updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m4214getCollapsedimpl(r52)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m4218getMinimpl(r52);
            this.compositionEnd = TextRange.m4217getMaximpl(r52);
        }
    }
