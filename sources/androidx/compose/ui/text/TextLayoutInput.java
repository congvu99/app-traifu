...
public final class TextLayoutInput {
    ...
    public final int m4192getOverflowgIe3tQ8() {
    ...
    public final long m4191getConstraintsmsEJaDk() {
    ...
    public static /* synthetic */ TextLayoutInput m4189copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List list, int i, boolean z, int i2, Density density2, LayoutDirection layoutDirection2, Font.ResourceLoader resourceLoader, long j, int i3, Object obj) {
        long j2;
        TextLayoutInput textLayoutInput2 = textLayoutInput;
        int i4 = i3;
        AnnotatedString annotatedString2 = (i4 & 1) != 0 ? textLayoutInput2.text : annotatedString;
        TextStyle textStyle2 = (i4 & 2) != 0 ? textLayoutInput2.style : textStyle;
        List list2 = (i4 & 4) != 0 ? textLayoutInput2.placeholders : list;
        int i5 = (i4 & 8) != 0 ? textLayoutInput2.maxLines : i;
        boolean z2 = (i4 & 16) != 0 ? textLayoutInput2.softWrap : z;
        int i6 = (i4 & 32) != 0 ? textLayoutInput2.overflow : i2;
        Density density3 = (i4 & 64) != 0 ? textLayoutInput2.density : density2;
        LayoutDirection layoutDirection3 = (i4 & 128) != 0 ? textLayoutInput2.layoutDirection : layoutDirection2;
        Font.ResourceLoader resourceLoader2 = (i4 & 256) != 0 ? textLayoutInput.getResourceLoader() : resourceLoader;
        if ((i4 & 512) != 0) {
            j2 = textLayoutInput2.constraints;
        } else {
            j2 = j;
        }
        return textLayoutInput.m4190copyhu1Yfo(annotatedString2, textStyle2, list2, i5, z2, i6, density3, layoutDirection3, resourceLoader2, j2);
    }
    ...
    public final TextLayoutInput m4190copyhu1Yfo(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z, int i2, Density density2, LayoutDirection layoutDirection2, Font.ResourceLoader resourceLoader, long j) {
        ...
        Intrinsics.checkNotNullParameter(layoutDirection3, ViewProps.LAYOUT_DIRECTION);
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.text, (Object) textLayoutInput.text) && Intrinsics.areEqual((Object) this.style, (Object) textLayoutInput.style) && Intrinsics.areEqual((Object) this.placeholders, (Object) textLayoutInput.placeholders) && this.maxLines == textLayoutInput.maxLines && this.softWrap == textLayoutInput.softWrap && TextOverflow.m4583equalsimpl0(this.overflow, textLayoutInput.overflow) && Intrinsics.areEqual((Object) this.density, (Object) textLayoutInput.density) && this.layoutDirection == textLayoutInput.layoutDirection && Intrinsics.areEqual((Object) this.fontFamilyResolver, (Object) textLayoutInput.fontFamilyResolver) && Constraints.m4617equalsimpl0(this.constraints, textLayoutInput.constraints);
    }

    public int hashCode() {
        return (((((((((((((((((this.text.hashCode() * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.softWrap)) * 31) + TextOverflow.m4584hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m4627hashCodeimpl(this.constraints);
    }

    public String toString() {
        return "TextLayoutInput(text=" + this.text + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + TextOverflow.m4585toStringimpl(this.overflow) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + Constraints.m4629toStringimpl(this.constraints) + ')';
    }
}
