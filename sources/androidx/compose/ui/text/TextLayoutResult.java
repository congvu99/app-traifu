...
public final class TextLayoutResult {
    ...
    public final long m4196getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m4863getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m4864getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m4195getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m4122getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m4197getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m4123getWordBoundaryjx7JFs(i);
    }
    ...
    public static /* synthetic */ TextLayoutResult m4193copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m4194copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m4194copyO0kMr_c(TextLayoutInput textLayoutInput, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.layoutInput, (Object) textLayoutResult.layoutInput) || !Intrinsics.areEqual((Object) this.multiParagraph, (Object) textLayoutResult.multiParagraph) || !IntSize.m4862equalsimpl0(this.size, textLayoutResult.size)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m4865hashCodeimpl(this.size)) * 31) + Float.floatToIntBits(this.firstBaseline)) * 31) + Float.floatToIntBits(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + IntSize.m4867toStringimpl(this.size) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
