...
public final class SimpleArrayMap<K, V> {
    ...
    public final V put(K k, V v) {
        ...
        if (i3 >= this.hashes.length) {
            ...
            int[] copyOf = Arrays.copyOf(this.hashes, i6);
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
            this.hashes = copyOf;
        ...
        if (i5 < i3) {
            int[] iArr = this.hashes;
            int i7 = i5 + 1;
            ArraysKt.copyInto(iArr, iArr, i7, i5, i3);
            Object[] objArr = this.keyValues;
        ...
        if (i3 <= 1) {
            ...
            if (iArr.length <= 8 || i3 >= iArr.length / 3) {
                if (i < i4) {
                    ...
                    int i6 = i + 1;
                    int i7 = i4 + 1;
                    ArraysKt.copyInto(iArr2, iArr2, i, i6, i7);
                    Object[] objArr = this.keyValues;
                    ArraysKt.copyInto((T[]) objArr, (T[]) objArr, i2, i6 << 1, i7 << 1);
                }
                Object[] objArr2 = this.keyValues;
                int i8 = i4 << 1;
                objArr2[i8] = null;
                ...
                if (i3 == this._size) {
                    if (i > 0) {
                        ArraysKt.copyInto(iArr3, iArr4, 0, 0, i);
                        ArraysKt.copyInto((T[]) objArr3, (T[]) this.keyValues, 0, 0, i2);
                    }
                    if (i < i4) {
                        int i9 = i + 1;
                        int i10 = i4 + 1;
                        ArraysKt.copyInto(iArr3, this.hashes, i, i9, i10);
                        ArraysKt.copyInto((T[]) objArr3, (T[]) this.keyValues, i2, i9 << 1, i10 << 1);
                    }
                } else {
                    throw new ConcurrentModificationException();
                }
    ...
    public boolean equals(Object obj) {
        ...
        try {
            if (obj instanceof SimpleArrayMap) {
                ...
                if (this._size != simpleArrayMap._size) {
                    return false;
                }
                int i = this._size;
                for (int i2 = 0; i2 < i; i2++) {
