...
public class LruCache<K, V> {
    ...
    public String toString() {
        ...
        synchronized (this.monitor) {
            ...
            str = "LruCache[maxSize=" + this.maxSize + ",hits=" + this.hitCount + ",misses=" + this.missCount + ",hitRate=" + (i != 0 ? (this.hitCount * 100) / i : 0) + "%]";
        }
        return str;
    }
