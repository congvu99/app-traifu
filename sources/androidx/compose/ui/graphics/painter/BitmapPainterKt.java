...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m2607BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.Companion.m4832getZeronOccac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
        ...
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.Companion.m2018getLowfv9h1I();
        }
        return m2606BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m2606BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        ...
        bitmapPainter.m2605setFilterQualityvDHp3xo$ui_graphics_release(i);
