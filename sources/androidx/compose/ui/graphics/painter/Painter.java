...
public abstract class Painter {
    ...
    public abstract long m2613getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m2611drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter2, int i, Object obj) {
        if (obj == null) {
            float f2 = (i & 2) != 0 ? 1.0f : f;
            if ((i & 4) != 0) {
                colorFilter2 = null;
            }
            painter.m2612drawx_KDEd0(drawScope, j, f2, colorFilter2);
            return;
        }
    ...
    public final void m2612drawx_KDEd0(DrawScope drawScope, long j, float f, ColorFilter colorFilter2) {
        ...
        float r8 = Size.m1752getWidthimpl(drawScope.m2478getSizeNHjbRc()) - Size.m1752getWidthimpl(j);
        float r0 = Size.m1749getHeightimpl(drawScope.m2478getSizeNHjbRc()) - Size.m1749getHeightimpl(j);
        drawScope.getDrawContext().getTransform().inset(0.0f, 0.0f, r8, r0);
        if (f > 0.0f && Size.m1752getWidthimpl(j) > 0.0f && Size.m1749getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect r5 = RectKt.m1723Recttz77jQw(Offset.Companion.m1699getZeroF1C5BW0(), SizeKt.Size(Size.m1752getWidthimpl(j), Size.m1749getHeightimpl(j)));
