...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m1791actualTintColorFilterxETnrds(long j, int i) {
        ColorFilter colorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            colorFilter = BlendModeColorFilterHelper.INSTANCE.m1866BlendModeColorFilterxETnrds(j, i);
        } else {
            colorFilter = new PorterDuffColorFilter(ColorKt.m1987toArgb8_81llA(j), AndroidBlendMode_androidKt.m1776toPorterDuffModes9anfk8(i));
        }
        return new ColorFilter(colorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final ColorFilter m1789actualColorMatrixColorFilterjHGOpc(float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(fArr));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final ColorFilter m1790actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m1987toArgb8_81llA(j), ColorKt.m1987toArgb8_81llA(j2)));
    }
}
