...
public final class AndroidPath implements Path {
    ...
    public int m1816getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.Companion.m2199getEvenOddRgk1Os();
        }
        return PathFillType.Companion.m2200getNonZeroRgk1Os();
    }

    /* renamed from: setFillType-oQ8Xj4U  reason: not valid java name */
    public void m1818setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m2195equalsimpl0(i, PathFillType.Companion.m2199getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m1658getXimpl(roundRect.m1733getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m1659getYimpl(roundRect.m1733getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m1658getXimpl(roundRect.m1734getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m1659getYimpl(roundRect.m1734getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m1658getXimpl(roundRect.m1732getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m1659getYimpl(roundRect.m1732getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m1658getXimpl(roundRect.m1731getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m1659getYimpl(roundRect.m1731getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    /* renamed from: addPath-Uv8p0NA  reason: not valid java name */
    public void m1815addPathUv8p0NA(Path path, long j) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m1683getXimpl(j), Offset.m1684getYimpl(j));
            return;
        }
    ...
    public void m1819translatek4lQ0M(long j) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m1683getXimpl(j), Offset.m1684getYimpl(j));
    ...
    public boolean m1817opN5in7k0(Path path, Path path2, int i) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m2204equalsimpl0(i, PathOperation.Companion.m2208getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m2204equalsimpl0(i, PathOperation.Companion.m2209getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m2204equalsimpl0(i, PathOperation.Companion.m2210getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else if (PathOperation.m2204equalsimpl0(i, PathOperation.Companion.m2211getUnionb3I0S0c())) {
            op = Path.Op.UNION;
        } else {
            op = Path.Op.XOR;
        }
