...
public interface Canvas {
    ...
    void m1891clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    void m1892clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    void m1893clipRectmtrdDE(Rect rect, int i);

    /* renamed from: concat-58bKbWc  reason: not valid java name */
    void m1894concat58bKbWc(float[] fArr);
    ...
    void m1895drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I  reason: not valid java name */
    void m1896drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0  reason: not valid java name */
    void m1897drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    void m1898drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void m1899drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY  reason: not valid java name */
    void m1900drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void m1901drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m1906clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m1921getIntersectrtfAjoo();
                }
                canvas.m1893clipRectmtrdDE(rect, i);
                return;
            }
        ...
        public static void m1902$default$clipRectmtrdDE(Canvas _this, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            _this.m1892clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
        public static /* synthetic */ void m1905clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 16) != 0) {
                    i = ClipOp.Companion.m1921getIntersectrtfAjoo();
                }
                canvas.m1892clipRectN_I0leg(f, f2, f3, f4, i);
                return;
            }
        ...
        public static /* synthetic */ void m1904clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m1921getIntersectrtfAjoo();
                }
                canvas.m1891clipPathmtrdDE(path, i);
                return;
            }
        ...
        public static /* synthetic */ void m1907drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj == null) {
                long r4 = (i & 2) != 0 ? IntOffset.Companion.m4832getZeronOccac() : j;
                long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
                canvas.m1897drawImageRectHPBpro0(imageBitmap, r4, IntSize, (i & 8) != 0 ? IntOffset.Companion.m4832getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
                return;
            }
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
        public static void m1910clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            CC.m1902$default$clipRectmtrdDE(canvas, rect, i);
        }
