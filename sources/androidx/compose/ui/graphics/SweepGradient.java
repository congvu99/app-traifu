...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader m2300createShaderuvyYCjk(long j) {
        long j2;
        if (OffsetKt.m1704isUnspecifiedk4lQ0M(this.center)) {
            j2 = SizeKt.m1762getCenteruvyYCjk(j);
        } else {
            boolean z = true;
            float r0 = (Offset.m1683getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m1683getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m1752getWidthimpl(j) : Offset.m1683getXimpl(this.center);
            if (Offset.m1684getYimpl(this.center) != Float.POSITIVE_INFINITY) {
                z = false;
            }
            j2 = OffsetKt.Offset(r0, z ? Size.m1749getHeightimpl(j) : Offset.m1684getYimpl(this.center));
        }
        return ShaderKt.m2258SweepGradientShader9KIMszo(j2, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Offset.m1680equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual((Object) this.colors, (Object) sweepGradient.colors) && Intrinsics.areEqual((Object) this.stops, (Object) sweepGradient.stops);
    }

    public int hashCode() {
        int r0 = ((Offset.m1685hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
