...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m2191stampedPathEffect7aD1DOk(Path path, float f, float f2, int i) {
            Intrinsics.checkNotNullParameter(path, "shape");
            return AndroidPathEffect_androidKt.m1820actualStampedPathEffect7aD1DOk(path, f, f2, i);
        }
    }
}
