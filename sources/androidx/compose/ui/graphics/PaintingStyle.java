...
public final class PaintingStyle {
    ...
    public static final int Fill = m2175constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Stroke = m2175constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m2174boximpl(int i) {
        return new PaintingStyle(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2175constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2176equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).m2180unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2181getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m2182getStrokeTiuSbCo() {
    ...
    public static String m2179toStringimpl(int i) {
        if (m2177equalsimpl0(i, Fill)) {
            return "Fill";
        }
        return m2177equalsimpl0(i, Stroke) ? "Stroke" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
