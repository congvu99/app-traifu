...
public final class GraphicsLayerModifierKt$graphicsLayerpANQ8Wg$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m2313boximpl(this.$transformOrigin$inlined));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m1922boximpl(this.$ambientShadowColor$inlined));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m1922boximpl(this.$spotShadowColor$inlined));
    }
}
