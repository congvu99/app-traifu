...
final class RenderEffectVerificationHelper {
    ...
    public final RenderEffect m2230createBlurEffect8A3gB4(RenderEffect renderEffect, float f, float f2, int i) {
        if (renderEffect == null) {
            RenderEffect createBlurEffect = RenderEffect.createBlurEffect(f, f2, AndroidTileMode_androidKt.m1827toAndroidTileMode0vamqd0(i));
            Intrinsics.checkNotNullExpressionValue(createBlurEffect, "{\n            android.gr…)\n            )\n        }");
            return createBlurEffect;
        }
        RenderEffect createBlurEffect2 = RenderEffect.createBlurEffect(f, f2, renderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m1827toAndroidTileMode0vamqd0(i));
    ...
    public final RenderEffect m2231createOffsetEffectUv8p0NA(RenderEffect renderEffect, long j) {
        if (renderEffect == null) {
            RenderEffect createOffsetEffect = RenderEffect.createOffsetEffect(Offset.m1683getXimpl(j), Offset.m1684getYimpl(j));
            Intrinsics.checkNotNullExpressionValue(createOffsetEffect, "{\n            android.gr…et.x, offset.y)\n        }");
            return createOffsetEffect;
        }
        RenderEffect createOffsetEffect2 = RenderEffect.createOffsetEffect(Offset.m1683getXimpl(j), Offset.m1684getYimpl(j), renderEffect.asAndroidRenderEffect());
