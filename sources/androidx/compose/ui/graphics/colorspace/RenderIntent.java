...
public final class RenderIntent {
    ...
    public static final int Absolute = m2359constructorimpl(3);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Perceptual = m2359constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Relative = m2359constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Saturation = m2359constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ RenderIntent m2358boximpl(int i) {
        return new RenderIntent(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2359constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2360equalsimpl(int i, Object obj) {
        return (obj instanceof RenderIntent) && i == ((RenderIntent) obj).m2364unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2361equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2362hashCodeimpl(int i) {
        return i;
    }

    public boolean equals(Object obj) {
        return m2360equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2362hashCodeimpl(this.value);
    }
    ...
    public static String m2363toStringimpl(int i) {
        if (m2361equalsimpl0(i, Perceptual)) {
            return "Perceptual";
        }
        if (m2361equalsimpl0(i, Relative)) {
            return "Relative";
        }
        if (m2361equalsimpl0(i, Saturation)) {
            return ExifInterface.TAG_SATURATION;
        }
        return m2361equalsimpl0(i, Absolute) ? "Absolute" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
