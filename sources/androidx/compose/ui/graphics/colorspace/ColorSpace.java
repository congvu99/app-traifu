...
public abstract class ColorSpace {
    ...
    public final long m2351getModelxdoWZVw() {
        return this.model;
    }
    ...
    public final int getComponentCount() {
        return ColorModel.m2343getComponentCountimpl(this.model);
    }
    ...
    public final float[] fromXyz(float f, float f2, float f3) {
        float[] fArr = new float[ColorModel.m2343getComponentCountimpl(this.model)];
        fArr[0] = f;
        fArr[1] = f2;
        fArr[2] = f3;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ColorModel.m2345toStringimpl(this.model) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual((Object) this.name, (Object) colorSpace.name)) {
            return ColorModel.m2342equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m2344hashCodeimpl(this.model)) * 31) + this.id;
    }
