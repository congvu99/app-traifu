...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m2353connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m2366getPerceptualuksYyKA();
        }
        return m2352connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4  reason: not valid java name */
    public static final Connector m2352connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if (!ColorModel.m2342equalsimpl0(colorSpace.m2351getModelxdoWZVw(), ColorModel.Companion.m2349getRgbxdoWZVw()) || !ColorModel.m2342equalsimpl0(colorSpace2.m2351getModelxdoWZVw(), ColorModel.Companion.m2349getRgbxdoWZVw())) {
    ...
    public static final double absRcpResponse(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d;
        return Math.copySign(rcpResponse(d7 < Utils.DOUBLE_EPSILON ? -d7 : d7, d2, d3, d4, d5, d6), d7);
    }

    public static final double absResponse(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d;
        return Math.copySign(response(d7 < Utils.DOUBLE_EPSILON ? -d7 : d7, d2, d3, d4, d5, d6), d7);
    }
