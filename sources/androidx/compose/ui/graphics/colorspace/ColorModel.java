...
public final class ColorModel {
    ...
    public static final /* synthetic */ ColorModel m2339boximpl(long j) {
    ...
    public static boolean m2341equalsimpl(long j, Object obj) {
        return (obj instanceof ColorModel) && j == ((ColorModel) obj).m2346unboximpl();
    }
    ...
    public static final int m2343getComponentCountimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public static final class Companion {
        ...
        public final long m2349getRgbxdoWZVw() {
            return ColorModel.Rgb;
        }

        /* renamed from: getXyz-xdoWZVw  reason: not valid java name */
        public final long m2350getXyzxdoWZVw() {
            return ColorModel.Xyz;
        }

        /* renamed from: getLab-xdoWZVw  reason: not valid java name */
        public final long m2348getLabxdoWZVw() {
            return ColorModel.Lab;
        }

        /* renamed from: getCmyk-xdoWZVw  reason: not valid java name */
        public final long m2347getCmykxdoWZVw() {
    ...
    static {
        long j = (long) 3;
        long j2 = j << 32;
        Rgb = m2340constructorimpl((((long) 0) & 4294967295L) | j2);
        Xyz = m2340constructorimpl((((long) 1) & 4294967295L) | j2);
        Lab = m2340constructorimpl(j2 | (((long) 2) & 4294967295L));
        Cmyk = m2340constructorimpl((j & 4294967295L) | (((long) 4) << 32));
    }
    ...
    public static String m2345toStringimpl(long j) {
        if (m2342equalsimpl0(j, Rgb)) {
            return "Rgb";
        }
        if (m2342equalsimpl0(j, Xyz)) {
            return "Xyz";
        }
        if (m2342equalsimpl0(j, Lab)) {
            return "Lab";
        }
        return m2342equalsimpl0(j, Cmyk) ? "Cmyk" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
