...
public final class ColorSpaces {
    ...
    private static final Rgb Bt2020 = new Rgb("Rec. ITU-R BT.2020-1", new float[]{0.708f, 0.292f, 0.17f, 0.797f, 0.131f, 0.046f}, Illuminant.INSTANCE.getD65(), new TransferParameters(2.2222222222222223d, 0.9096697898662786d, 0.09033021013372146d, 0.2222222222222222d, 0.08145d, Utils.DOUBLE_EPSILON, Utils.DOUBLE_EPSILON, 96, (DefaultConstructorMarker) null), 5);
    private static final Rgb Bt709 = new Rgb("Rec. ITU-R BT.709-5", new float[]{0.64f, 0.33f, 0.3f, 0.6f, 0.15f, 0.06f}, Illuminant.INSTANCE.getD65(), new TransferParameters(2.2222222222222223d, 0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, Utils.DOUBLE_EPSILON, Utils.DOUBLE_EPSILON, 96, (DefaultConstructorMarker) null), 4);
    ...
    private static final Rgb ExtendedSrgb = new Rgb("scRGB-nl IEC 61966-2-2:2003", SrgbPrimaries, Illuminant.INSTANCE.getD65(), (float[]) null, ColorSpaces$ExtendedSrgb$1.INSTANCE, ColorSpaces$ExtendedSrgb$2.INSTANCE, -0.799f, 2.399f, SrgbTransferParameters, 2);
    ...
    private static final TransferParameters NoneTransferParameters = new TransferParameters(2.2d, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, Utils.DOUBLE_EPSILON, Utils.DOUBLE_EPSILON, 96, (DefaultConstructorMarker) null);
    private static final Rgb Ntsc1953 = new Rgb("NTSC (1953)", Ntsc1953Primaries, Illuminant.INSTANCE.getC(), new TransferParameters(2.2222222222222223d, 0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, Utils.DOUBLE_EPSILON, Utils.DOUBLE_EPSILON, 96, (DefaultConstructorMarker) null), 8);
    private static final float[] Ntsc1953Primaries = {0.67f, 0.33f, 0.21f, 0.71f, 0.14f, 0.08f};
    private static final ColorSpace Oklab;
    private static final Rgb ProPhotoRgb = new Rgb("ROMM RGB ISO 22028-2:2013", new float[]{0.7347f, 0.2653f, 0.1596f, 0.8404f, 0.0366f, 1.0E-4f}, Illuminant.INSTANCE.getD50(), new TransferParameters(1.8d, 1.0d, Utils.DOUBLE_EPSILON, 0.0625d, 0.031248d, Utils.DOUBLE_EPSILON, Utils.DOUBLE_EPSILON, 96, (DefaultConstructorMarker) null), 11);
    private static final Rgb SmpteC = new Rgb("SMPTE-C RGB", new float[]{0.63f, 0.34f, 0.31f, 0.595f, 0.155f, 0.07f}, Illuminant.INSTANCE.getD65(), new TransferParameters(2.2222222222222223d, 0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, Utils.DOUBLE_EPSILON, Utils.DOUBLE_EPSILON, 96, (DefaultConstructorMarker) null), 9);
    ...
    private static final TransferParameters SrgbTransferParameters = new TransferParameters(2.4d, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, Utils.DOUBLE_EPSILON, Utils.DOUBLE_EPSILON, 96, (DefaultConstructorMarker) null);
    ...
    static {
        ...
        Oklab = oklab;
        ColorSpacesArray = new ColorSpace[]{Srgb, LinearSrgb, ExtendedSrgb, LinearExtendedSrgb, Bt709, Bt2020, DciP3, DisplayP3, Ntsc1953, SmpteC, AdobeRgb, ProPhotoRgb, Aces, Acescg, CieXyz, CieLab, Unspecified, oklab};
    }
    ...
    public final ColorSpace match(float[] fArr, TransferParameters transferParameters) {
        ...
        for (ColorSpace colorSpace : ColorSpacesArray) {
            if (ColorModel.m2342equalsimpl0(colorSpace.m2351getModelxdoWZVw(), ColorModel.Companion.m2349getRgbxdoWZVw())) {
