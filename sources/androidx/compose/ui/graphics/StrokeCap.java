...
public final class StrokeCap {
    ...
    public static final int Butt = m2281constructorimpl(0);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Round = m2281constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Square = m2281constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StrokeCap m2280boximpl(int i) {
    ...
    public static boolean m2282equalsimpl(int i, Object obj) {
        return (obj instanceof StrokeCap) && i == ((StrokeCap) obj).m2286unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2287getButtKaPHkGw() {
            return StrokeCap.Butt;
        }

        /* renamed from: getRound-KaPHkGw  reason: not valid java name */
        public final int m2288getRoundKaPHkGw() {
            return StrokeCap.Round;
        }

        /* renamed from: getSquare-KaPHkGw  reason: not valid java name */
        public final int m2289getSquareKaPHkGw() {
    ...
    public static String m2285toStringimpl(int i) {
        if (m2283equalsimpl0(i, Butt)) {
            return "Butt";
        }
        if (m2283equalsimpl0(i, Round)) {
            return "Round";
        }
        return m2283equalsimpl0(i, Square) ? "Square" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
