...
public final class ImageVector {
    ...
    public final float m2616getDefaultWidthD9Ej5fM() {
        return this.defaultWidth;
    }

    /* renamed from: getDefaultHeight-D9Ej5fM  reason: not valid java name */
    public final float m2615getDefaultHeightD9Ej5fM() {
    ...
    public final long m2618getTintColor0d7_KjU() {
        return this.tintColor;
    }

    /* renamed from: getTintBlendMode-0nO6VwU  reason: not valid java name */
    public final int m2617getTintBlendMode0nO6VwU() {
    ...
    public static final class Builder {
        ...
        private Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z) {
            ...
            this.tintBlendMode = i;
            this.autoMirror = z;
            this.nodes = Stack.m2631constructorimpl$default((ArrayList) null, 1, (DefaultConstructorMarker) null);
            ...
            Stack.m2638pushimpl(this.nodes, groupParams);
        }
        ...
        public /* synthetic */ Builder(java.lang.String r14, float r15, float r16, float r17, float r18, long r19, int r21, boolean r22, int r23, kotlin.jvm.internal.DefaultConstructorMarker r24) {
            ...
            L_0x0019:
                ...
                int r1 = r1.m1862getSrcIn0nO6VwU()
                r10 = r1
                goto L_0x0027
            L_0x0025:
                r10 = r21
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m1968getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m1862getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        private final GroupParams getCurrentGroup() {
            return (GroupParams) Stack.m2636peekimpl(this.nodes);
        }
        ...
        public final Builder addGroup(String str, float f, float f2, float f3, float f4, float f5, float f6, float f7, List<? extends PathNode> list) {
            ...
            ensureNotConsumed();
            Stack.m2638pushimpl(this.nodes, new GroupParams(str2, f, f2, f3, f4, f5, f6, f7, list2, (List) null, 512, (DefaultConstructorMarker) null));
            return this;
        }

        public final Builder clearGroup() {
            ensureNotConsumed();
            getCurrentGroup().getChildren().add(asVectorGroup((GroupParams) Stack.m2637popimpl(this.nodes)));
            return this;
        }

        /* renamed from: addPath-oIyEayM$default  reason: not valid java name */
        public static /* synthetic */ Builder m2619addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, Object obj) {
            int i5;
            int i6 = i4;
            ...
            return builder.m2620addPathoIyEayM(list, defaultFillType, str2, brush4, f9, brush3, f10, f12, defaultStrokeLineCap, i5, f13, f14, f8, f11);
        }

        /* renamed from: addPath-oIyEayM  reason: not valid java name */
        public final Builder m2620addPathoIyEayM(List<? extends PathNode> list, int i, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7) {
            List<? extends PathNode> list2 = list;
        ...
        public final ImageVector build() {
            ensureNotConsumed();
            while (Stack.m2634getSizeimpl(this.nodes) > 1) {
                clearGroup();
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.name, (Object) imageVector.name) || !Dp.m4709equalsimpl0(this.defaultWidth, imageVector.defaultWidth) || !Dp.m4709equalsimpl0(this.defaultHeight, imageVector.defaultHeight)) {
            return false;
        }
        if (!(this.viewportWidth == imageVector.viewportWidth)) {
            return false;
        }
        return ((this.viewportHeight > imageVector.viewportHeight ? 1 : (this.viewportHeight == imageVector.viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual((Object) this.root, (Object) imageVector.root) && Color.m1933equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m1833equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
    }

    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m4710hashCodeimpl(this.defaultWidth)) * 31) + Dp.m4710hashCodeimpl(this.defaultHeight)) * 31) + Float.floatToIntBits(this.viewportWidth)) * 31) + Float.floatToIntBits(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m1939hashCodeimpl(this.tintColor)) * 31) + BlendMode.m1834hashCodeimpl(this.tintBlendMode)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.autoMirror);
    }
}
