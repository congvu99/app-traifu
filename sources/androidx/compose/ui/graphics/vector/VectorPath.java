...
public final class VectorPath extends VectorNode {
    ...
    public final int m2650getPathFillTypeRgk1Os() {
    ...
    public final int m2651getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8  reason: not valid java name */
    public final int m2652getStrokeLineJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(this.strokeLineWidth == vectorPath.strokeLineWidth) || !StrokeCap.m2283equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) || !StrokeJoin.m2293equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
            return false;
        }
        ...
        return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m2195equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual((Object) this.pathData, (Object) vectorPath.pathData);
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((hashCode2 + i) * 31) + Float.floatToIntBits(this.strokeAlpha)) * 31) + Float.floatToIntBits(this.strokeLineWidth)) * 31) + StrokeCap.m2284hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m2294hashCodeimpl(this.strokeLineJoin)) * 31) + Float.floatToIntBits(this.strokeLineMiter)) * 31) + Float.floatToIntBits(this.trimPathStart)) * 31) + Float.floatToIntBits(this.trimPathEnd)) * 31) + Float.floatToIntBits(this.trimPathOffset)) * 31) + PathFillType.m2196hashCodeimpl(this.pathFillType);
    }
}
