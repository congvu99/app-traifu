...
public interface VectorConfig {
    ...
    public final /* synthetic */ class CC {
        public static <T> Object $default$getOrDefault(VectorConfig vectorConfig, VectorProperty vectorProperty, Object obj) {
    ...
    public static final class DefaultImpls {
        ...
        public static <T> T getOrDefault(VectorConfig vectorConfig, VectorProperty<T> vectorProperty, T t) {
            Intrinsics.checkNotNullParameter(vectorProperty, "property");
            return CC.$default$getOrDefault(vectorConfig, vectorProperty, t);
        }
    }
}
