...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m2133constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m2142resetimpl(fArr);
        }
        Matrix.m2153translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, (Object) null);
        Matrix.m2145rotateZimpl(fArr, this.rotation);
        Matrix.m2146scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m2153translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, (Object) null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        long r2 = drawContext.m2456getSizeNHjbRc();
        drawContext.getCanvas().save();
        DrawTransform transform = drawContext.getTransform();
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.m2571transform58bKbWc((fArr != null ? Matrix.m2131boximpl(fArr) : null).m2154unboximpl());
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.CC.m2574clipPathmtrdDE$default(transform, path, 0, 2, (Object) null);
        }
        List<VNode> list = this.children;
        int size = list.size();
        for (int i = 0; i < size; i++) {
        ...
        drawContext.m2457setSizeuvyYCjk(r2);
    }
