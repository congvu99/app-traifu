...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m2654getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m2287getButtKaPHkGw();
        }
        return m2653getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m2653getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.Companion.m2287getButtKaPHkGw();
        }
        if (i == 1) {
            return StrokeCap.Companion.m2288getRoundKaPHkGw();
        }
        if (i != 2) {
            return i2;
        }
        return StrokeCap.Companion.m2289getSquareKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default  reason: not valid java name */
    static /* synthetic */ int m2656getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m2298getMiterLxFBmk8();
        }
        return m2655getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m2655getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.Companion.m2298getMiterLxFBmk8();
        }
        if (i == 1) {
            return StrokeJoin.Companion.m2299getRoundLxFBmk8();
        }
        if (i != 2) {
            return i2;
        }
        return StrokeJoin.Companion.m2297getBevelLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) {
        ...
        if (namedFloat <= 0.0f) {
            ...
            if (i2 == -1) {
                i = BlendMode.Companion.m1862getSrcIn0nO6VwU();
            } else if (i2 == 3) {
                i = BlendMode.Companion.m1864getSrcOver0nO6VwU();
            } else if (i2 == 5) {
                i = BlendMode.Companion.m1862getSrcIn0nO6VwU();
            } else if (i2 != 9) {
                switch (i2) {
                    case 14:
                        i = BlendMode.Companion.m1853getModulate0nO6VwU();
                        break;
                    case 15:
                        i = BlendMode.Companion.m1858getScreen0nO6VwU();
                        break;
                    case 16:
                        i = BlendMode.Companion.m1856getPlus0nO6VwU();
                        break;
                    default:
                        i = BlendMode.Companion.m1862getSrcIn0nO6VwU();
                        break;
                ...
                i = BlendMode.Companion.m1861getSrcAtop0nO6VwU();
            }
            int i3 = i;
            float r9 = Dp.m4704constructorimpl(dimension / resources.getDisplayMetrics().density);
            float r10 = Dp.m4704constructorimpl(dimension2 / resources.getDisplayMetrics().density);
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        if (TypedArrayUtils.hasAttribute(androidVectorParser.getXmlParser(), "pathData")) {
            ...
            int r15 = m2653getStrokeLineCapCSYIeUk(androidVectorParser2.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m2287getButtKaPHkGw());
            int r16 = m2655getStrokeLineJoinkLtJ_vA(androidVectorParser2.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m2297getBevelLxFBmk8());
            ...
            builder.m2620addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m2200getNonZeroRgk1Os() : companion.m2199getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, r15, r16, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
            return;
        }
