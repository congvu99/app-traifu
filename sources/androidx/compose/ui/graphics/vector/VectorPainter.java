...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m1740boximpl(Size.Companion.m1761getZeroNHjbRc()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final long m2646getSizeNHjbRc$ui_release() {
        return ((Size) this.size$delegate.getValue()).m1757unboximpl();
    }

    /* renamed from: setSize-uvyYCjk$ui_release  reason: not valid java name */
    public final void m2647setSizeuvyYCjk$ui_release(long j) {
        this.size$delegate.setValue(Size.m1740boximpl(j));
    }
    ...
    public final void RenderVector$ui_release(String str, float f, float f2, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(RenderVector)P(1,3,2)232@8731L28,236@8800L117:VectorPainter.kt#huu6hf");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1264894527, i, -1, "androidx.compose.ui.graphics.vector.VectorPainter.RenderVector (VectorPainter.kt:220)");
        }
    ...
    public long m2645getIntrinsicSizeNHjbRc() {
        return m2646getSizeNHjbRc$ui_release();
    }
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        if (!getAutoMirror$ui_release() || drawScope.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long r4 = drawScope.m2477getCenterF1C5BW0();
            DrawContext drawContext = drawScope.getDrawContext();
            long r7 = drawContext.m2456getSizeNHjbRc();
            drawContext.getCanvas().save();
            drawContext.getTransform().m2570scale0AR0LA0(-1.0f, 1.0f, r4);
            vectorComponent.draw(drawScope, this.currentAlpha, colorFilter);
