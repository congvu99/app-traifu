...
public final class VectorKt {
    private static final int DefaultFillType = PathFillType.Companion.m2200getNonZeroRgk1Os();
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m2287getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m2298getMiterLxFBmk8();
    public static final float DefaultStrokeLineMiter = 4.0f;
    public static final float DefaultStrokeLineWidth = 0.0f;
    private static final int DefaultTintBlendMode = BlendMode.Companion.m1862getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m1967getTransparent0d7_KjU();
