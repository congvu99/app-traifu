...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m4869getZeroYbymL2g();
    ...
    public final void m2614drawCachedImageCJJARo(long j, Density density, LayoutDirection layoutDirection2, Function1<? super DrawScope, Unit> function1) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m4864getWidthimpl(j) > imageBitmap.getWidth() || IntSize.m4863getHeightimpl(j) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2128ImageBitmapx__hDU$default(IntSize.m4864getWidthimpl(j), IntSize.m4863getHeightimpl(j), 0, false, (ColorSpace) null, 28, (Object) null);
        ...
        drawParams3.m2416setSizeuvyYCjk(r13);
    ...
    public final void drawInto(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        ImageBitmap imageBitmap = this.mCachedImage;
        if (imageBitmap != null) {
            DrawScope.CC.m2503drawImageAZ2fEMs$default(drawScope, imageBitmap, 0, this.size, 0, 0, f, (DrawStyle) null, colorFilter, 0, 0, 858, (Object) null);
            return;
        }
    ...
    private final void clear(DrawScope drawScope) {
        DrawScope.CC.m2514drawRectnJ9OG0$default(drawScope, Color.Companion.m1958getBlack0d7_KjU(), 0, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, BlendMode.Companion.m1837getClear0nO6VwU(), 62, (Object) null);
    }
}
