...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m1973tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m1862getSrcIn0nO6VwU();
            }
            return companion.m1976tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m1976tintxETnrds(long j, int i) {
            return AndroidColorFilter_androidKt.m1791actualTintColorFilterxETnrds(j, i);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m1974colorMatrixjHGOpc(float[] fArr) {
            Intrinsics.checkNotNullParameter(fArr, "colorMatrix");
            return AndroidColorFilter_androidKt.m1789actualColorMatrixColorFilterjHGOpc(fArr);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m1975lightingOWjLjI(long j, long j2) {
            return AndroidColorFilter_androidKt.m1790actualLightingColorFilterOWjLjI(j, j2);
        }
    }
