...
public final class AndroidPaint implements Paint {
    private int _blendMode = BlendMode.Companion.m1864getSrcOver0nO6VwU();
    ...
    public long m1798getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public void m1804setColor8_81llA(long j) {
        AndroidPaint_androidKt.m1810setNativeColor4WTKRHQ(this.internalPaint, j);
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public int m1797getBlendMode0nO6VwU() {
        return this._blendMode;
    }

    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public void m1803setBlendModes9anfk8(int i) {
        this._blendMode = i;
        AndroidPaint_androidKt.m1809setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    /* renamed from: getStyle-TiuSbCo  reason: not valid java name */
    public int m1802getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    /* renamed from: setStyle-k9PVt8s  reason: not valid java name */
    public void m1808setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m1814setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int m1800getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    /* renamed from: setStrokeCap-BeK7IIE  reason: not valid java name */
    public void m1806setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m1812setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    /* renamed from: getStrokeJoin-LxFBmk8  reason: not valid java name */
    public int m1801getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    /* renamed from: setStrokeJoin-Ww9F2mQ  reason: not valid java name */
    public void m1807setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m1813setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int m1799getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    /* renamed from: setFilterQuality-vDHp3xo  reason: not valid java name */
    public void m1805setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m1811setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
