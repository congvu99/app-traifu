...
final class SimpleGraphicsLayerModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape2, boolean z, RenderEffect renderEffect2, long j2, long j3, Function1 function1, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, f2, f3, f4, f5, f6, f7, f8, f9, f10, j, shape2, z, renderEffect2, j2, j3, function1);
    }
    ...
    private SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape2, boolean z, RenderEffect renderEffect2, long j2, long j3, Function1<? super InspectorInfo, Unit> function1) {
        super(function1);
        this.scaleX = f;
        this.scaleY = f2;
        this.alpha = f3;
    ...
    public MeasureResult m2267measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable r9 = measurable.m3649measureBRTryo0(j);
        return MeasureScope.CC.layout$default(measureScope, r9.getWidth(), r9.getHeight(), (Map) null, new SimpleGraphicsLayerModifier$measure$1(r9, this), 4, (Object) null);
    }

    public int hashCode() {
        int floatToIntBits = ((((((((((((((((((((((((Float.floatToIntBits(this.scaleX) * 31) + Float.floatToIntBits(this.scaleY)) * 31) + Float.floatToIntBits(this.alpha)) * 31) + Float.floatToIntBits(this.translationX)) * 31) + Float.floatToIntBits(this.translationY)) * 31) + Float.floatToIntBits(this.shadowElevation)) * 31) + Float.floatToIntBits(this.rotationX)) * 31) + Float.floatToIntBits(this.rotationY)) * 31) + Float.floatToIntBits(this.rotationZ)) * 31) + Float.floatToIntBits(this.cameraDistance)) * 31) + TransformOrigin.m2323hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.clip)) * 31;
        RenderEffect renderEffect2 = this.renderEffect;
        return ((((floatToIntBits + (renderEffect2 != null ? renderEffect2.hashCode() : 0)) * 31) + Color.m1939hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m1939hashCodeimpl(this.spotShadowColor);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(this.cameraDistance == simpleGraphicsLayerModifier.cameraDistance) || !TransformOrigin.m2320equalsimpl0(this.transformOrigin, simpleGraphicsLayerModifier.transformOrigin) || !Intrinsics.areEqual((Object) this.shape, (Object) simpleGraphicsLayerModifier.shape) || this.clip != simpleGraphicsLayerModifier.clip || !Intrinsics.areEqual((Object) this.renderEffect, (Object) simpleGraphicsLayerModifier.renderEffect) || !Color.m1933equalsimpl0(this.ambientShadowColor, simpleGraphicsLayerModifier.ambientShadowColor) || !Color.m1933equalsimpl0(this.spotShadowColor, simpleGraphicsLayerModifier.spotShadowColor)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "SimpleGraphicsLayerModifier(scaleX=" + this.scaleX + ", scaleY=" + this.scaleY + ", alpha = " + this.alpha + ", translationX=" + this.translationX + ", translationY=" + this.translationY + ", shadowElevation=" + this.shadowElevation + ", rotationX=" + this.rotationX + ", rotationY=" + this.rotationY + ", rotationZ=" + this.rotationZ + ", cameraDistance=" + this.cameraDistance + ", transformOrigin=" + TransformOrigin.m2324toStringimpl(this.transformOrigin) + ", shape=" + this.shape + ", clip=" + this.clip + ", renderEffect=" + this.renderEffect + ", ambientShadowColor=" + Color.m1940toStringimpl(this.ambientShadowColor) + ", spotShadowColor=" + Color.m1940toStringimpl(this.spotShadowColor) + ')';
    }
}
