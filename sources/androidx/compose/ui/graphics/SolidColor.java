...
public final class SolidColor extends Brush {
    ...
    public final long m2269getValue0d7_KjU() {
        return this.value;
    }

    /* renamed from: applyTo-Pq9zytI  reason: not valid java name */
    public void m2268applyToPq9zytI(long j, Paint paint, float f) {
        long j2;
        Intrinsics.checkNotNullParameter(paint, ContextChain.TAG_PRODUCT);
        paint.setAlpha(1.0f);
        if (!(f == 1.0f)) {
            long j3 = this.value;
            j2 = Color.m1931copywmQWz5c$default(j3, Color.m1934getAlphaimpl(j3) * f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        } else {
            j2 = this.value;
        }
        paint.m2169setColor8_81llA(j2);
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m1933equalsimpl0(this.value, ((SolidColor) obj).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + Color.m1940toStringimpl(this.value) + ')';
    }
}
