...
public final class PointMode {
    ...
    public static final int Lines = m2215constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Points = m2215constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Polygon = m2215constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PointMode m2214boximpl(int i) {
    ...
    public static boolean m2216equalsimpl(int i, Object obj) {
        return (obj instanceof PointMode) && i == ((PointMode) obj).m2220unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2222getPointsr_lszbg() {
            return PointMode.Points;
        }

        /* renamed from: getLines-r_lszbg  reason: not valid java name */
        public final int m2221getLinesr_lszbg() {
            return PointMode.Lines;
        }

        /* renamed from: getPolygon-r_lszbg  reason: not valid java name */
        public final int m2223getPolygonr_lszbg() {
    ...
    public static String m2219toStringimpl(int i) {
        if (m2217equalsimpl0(i, Points)) {
            return "Points";
        }
        if (m2217equalsimpl0(i, Lines)) {
            return "Lines";
        }
        return m2217equalsimpl0(i, Polygon) ? "Polygon" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
