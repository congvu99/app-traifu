...
public final class CanvasDrawScopeKt$asDrawTransform$1 implements DrawTransform {
    ...
    public long m2422getSizeNHjbRc() {
        return this.$this_asDrawTransform.m2456getSizeNHjbRc();
    }

    /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
    public long m2421getCenterF1C5BW0() {
        return SizeKt.m1762getCenteruvyYCjk(m2422getSizeNHjbRc());
    }
    ...
    public void inset(float f, float f2, float f3, float f4) {
        ...
        long Size = SizeKt.Size(Size.m1752getWidthimpl(m2422getSizeNHjbRc()) - (f3 + f), Size.m1749getHeightimpl(m2422getSizeNHjbRc()) - (f4 + f2));
        if (Size.m1752getWidthimpl(Size) >= 0.0f && Size.m1749getHeightimpl(Size) >= 0.0f) {
            drawContext.m2457setSizeuvyYCjk(Size);
    ...
    public void m2420clipRectN_I0leg(float f, float f2, float f3, float f4, int i) {
        this.$this_asDrawTransform.getCanvas().m1892clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void m2419clipPathmtrdDE(Path path, int i) {
        Intrinsics.checkNotNullParameter(path, "path");
        this.$this_asDrawTransform.getCanvas().m1891clipPathmtrdDE(path, i);
    }
    ...
    public void m2423rotateUv8p0NA(float f, long j) {
        Canvas canvas = this.$this_asDrawTransform.getCanvas();
        canvas.translate(Offset.m1683getXimpl(j), Offset.m1684getYimpl(j));
        canvas.rotate(f);
        canvas.translate(-Offset.m1683getXimpl(j), -Offset.m1684getYimpl(j));
    }

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    public void m2424scale0AR0LA0(float f, float f2, long j) {
        Canvas canvas = this.$this_asDrawTransform.getCanvas();
        canvas.translate(Offset.m1683getXimpl(j), Offset.m1684getYimpl(j));
        canvas.scale(f, f2);
        canvas.translate(-Offset.m1683getXimpl(j), -Offset.m1684getYimpl(j));
    ...
    public void m2425transform58bKbWc(float[] fArr) {
        Intrinsics.checkNotNullParameter(fArr, "matrix");
        this.$this_asDrawTransform.getCanvas().m1894concat58bKbWc(fArr);
    }
}
