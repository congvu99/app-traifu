...
public final class Stroke extends DrawStyle {
    ...
    public static final int DefaultCap = StrokeCap.Companion.m2287getButtKaPHkGw();
    /* access modifiers changed from: private */
    public static final int DefaultJoin = StrokeJoin.Companion.m2298getMiterLxFBmk8();
    ...
    public /* synthetic */ Stroke(float f, float f2, int i, int i2, PathEffect pathEffect2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? 0.0f : f, (i3 & 2) != 0 ? 4.0f : f2, (i3 & 4) != 0 ? StrokeCap.Companion.m2287getButtKaPHkGw() : i, (i3 & 8) != 0 ? StrokeJoin.Companion.m2298getMiterLxFBmk8() : i2, (i3 & 16) != 0 ? null : pathEffect2, (DefaultConstructorMarker) null);
    }

    /* renamed from: getCap-KaPHkGw  reason: not valid java name */
    public final int m2598getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m2599getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m2600getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m2601getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        return ((this.miter > stroke.miter ? 1 : (this.miter == stroke.miter ? 0 : -1)) == 0) && StrokeCap.m2283equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2293equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual((Object) this.pathEffect, (Object) stroke.pathEffect);
    }

    public int hashCode() {
        int floatToIntBits = ((((((Float.floatToIntBits(this.width) * 31) + Float.floatToIntBits(this.miter)) * 31) + StrokeCap.m2284hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2294hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect2 = this.pathEffect;
        return floatToIntBits + (pathEffect2 != null ? pathEffect2.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + StrokeCap.m2285toStringimpl(this.cap) + ", join=" + StrokeJoin.m2295toStringimpl(this.join) + ", pathEffect=" + this.pathEffect + ')';
    }
}
