...
public final class AndroidViewHolder$layoutNode$1$5 implements MeasurePolicy {
    ...
    public MeasureResult m4941measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(list, "measurables");
        if (Constraints.m4626getMinWidthimpl(j) != 0) {
            this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m4626getMinWidthimpl(j));
        }
        if (Constraints.m4625getMinHeightimpl(j) != 0) {
            this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m4625getMinHeightimpl(j));
        }
        ...
        int r10 = Constraints.m4623getMaxHeightimpl(j);
        ...
        return MeasureScope.CC.layout$default(measureScope, this.$this_run.getMeasuredWidth(), this.$this_run.getMeasuredHeight(), (Map) null, new AndroidViewHolder$layoutNode$1$5$measure$1(this.$this_run, this.$layoutNode), 4, (Object) null);
    }
