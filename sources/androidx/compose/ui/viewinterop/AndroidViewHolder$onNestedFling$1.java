...
final class AndroidViewHolder$onNestedFling$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!this.$consumed) {
                this.label = 1;
                if (this.this$0.dispatcher.m3311dispatchPostFlingRZ2iAVY(Velocity.Companion.m4940getZero9UxMQ8M(), this.$viewVelocity, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                this.label = 2;
                if (this.this$0.dispatcher.m3311dispatchPostFlingRZ2iAVY(this.$viewVelocity, Velocity.Companion.m4940getZero9UxMQ8M(), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else if (i == 1 || i == 2) {
