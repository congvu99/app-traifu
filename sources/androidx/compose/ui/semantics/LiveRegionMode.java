...
public final class LiveRegionMode {
    ...
    public static final int Assertive = m4076constructorimpl(1);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int Polite = m4076constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m4075boximpl(int i) {
    ...
    public static boolean m4077equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).m4081unboximpl();
    }
    ...
    public static String m4080toStringimpl(int i) {
        if (m4078equalsimpl0(i, Polite)) {
            return "Polite";
        }
        return m4078equalsimpl0(i, Assertive) ? "Assertive" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
