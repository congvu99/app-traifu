...
public final class SemanticsNode {
    ...
    public final long m4100getSizeYbymL2g() {
        return findCoordinatorToGetBounds$ui_release().m3895getSizeYbymL2g();
    }
    ...
    public final long m4098getPositionInRootF1C5BW0() {
        if (!this.layoutNode.isAttached()) {
    ...
    public final long m4099getPositionInWindowF1C5BW0() {
        if (!this.layoutNode.isAttached()) {
            return Offset.Companion.m1699getZeroF1C5BW0();
        }
    ...
    public final List<SemanticsNode> unmergedChildren$ui_release(boolean z, boolean z2) {
        ...
        int size = list.size();
        for (int i = 0; i < size; i++) {
            arrayList.add(new SemanticsNode((SemanticsModifierNode) list.get(i), this.mergingEnabled, (LayoutNode) null, 4, (DefaultConstructorMarker) null));
        }
        if (z2) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        if (!this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            return DelegatableNodeKt.m3750requireCoordinator64DMado(this.outerSemanticsNode, Nodes.INSTANCE.m3941getSemanticsOLwlOKw());
        }
        SemanticsModifierNode outerMergingSemantics = SemanticsNodeKt.getOuterMergingSemantics(this.layoutNode);
        if (outerMergingSemantics == null) {
            outerMergingSemantics = this.outerSemanticsNode;
        }
        return DelegatableNodeKt.m3750requireCoordinator64DMado(outerMergingSemantics, Nodes.INSTANCE.m3941getSemanticsOLwlOKw());
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> list) {
        ...
        if (access$getRole != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && (!list.isEmpty())) {
            list.add(m4097fakeSemanticsNodeypyhhiA(access$getRole, new SemanticsNode$emitFakeNodes$fakeNode$1(access$getRole)));
        }
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && (!list.isEmpty()) && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                list.add(0, m4097fakeSemanticsNodeypyhhiA((Role) null, new SemanticsNode$emitFakeNodes$fakeNode$2(str)));
            }
        }
    }

    /* renamed from: fakeSemanticsNode-ypyhhiA  reason: not valid java name */
    private final SemanticsNode m4097fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> function1) {
