...
public final class ShadowKt$shadows4CzXII$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", Dp.m4702boximpl(this.$elevation$inlined));
        ...
        inspectorInfo.getProperties().set("ambientColor", Color.m1922boximpl(this.$ambientColor$inlined));
        inspectorInfo.getProperties().set("spotColor", Color.m1922boximpl(this.$spotColor$inlined));
    }
}
