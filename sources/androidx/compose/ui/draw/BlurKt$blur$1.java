...
final class BlurKt$blur$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    public final void invoke(GraphicsLayerScope graphicsLayerScope) {
        ...
        float r0 = graphicsLayerScope.m4649toPx0680j_4(this.$radiusX);
        float r1 = graphicsLayerScope.m4649toPx0680j_4(this.$radiusY);
        if (r0 <= 0.0f || r1 <= 0.0f) {
            renderEffect = null;
        } else {
            renderEffect = RenderEffectKt.m2228BlurEffect3YTHUZs(r0, r1, this.$tileMode);
        }
