...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m1602shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
        ...
        return m1601shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m1601shadowziNgDLE(Modifier modifier, float f, Shape shape, boolean z) {
        Intrinsics.checkNotNullParameter(modifier, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m1599shadows4CzXII(modifier, f, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* renamed from: shadow-s4CzXII$default  reason: not valid java name */
    public static /* synthetic */ Modifier m1600shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        Shape shape2;
        boolean z2;
        long j3;
        if ((i & 2) != 0) {
        ...
        return m1599shadows4CzXII(modifier, f, shape2, z2, defaultShadowColor, j3);
    }

    /* renamed from: shadow-s4CzXII  reason: not valid java name */
    public static final Modifier m1599shadows4CzXII(Modifier modifier, float f, Shape shape, boolean z, long j, long j2) {
        Modifier modifier2 = modifier;
        Intrinsics.checkNotNullParameter(modifier, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        float f2 = f;
        if (Dp.m4703compareTo0680j_4(f, Dp.m4704constructorimpl((float) 0)) <= 0 && !z) {
            return modifier2;
        }
