...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    public final <T extends Modifier.Node> T delegated(Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(function0, UserDataStore.FIRST_NAME);
        Modifier.Node node = getNode();
        T t = (Modifier.Node) function0.invoke();
    ...
    public final <T extends Modifier.Node> Lazy<T> lazyDelegated(Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(function0, UserDataStore.FIRST_NAME);
        return LazyKt.lazy(LazyThreadSafetyMode.NONE, new DelegatingNode$lazyDelegated$1(this, function0));
    }
