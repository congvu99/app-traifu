...
public final class BackwardsCompatNode$onModifierUpdated$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    final /* synthetic */ FocusOrderModifierToProperties $scope$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BackwardsCompatNode$onModifierUpdated$$inlined$debugInspectorInfo$1(FocusOrderModifierToProperties focusOrderModifierToProperties) {
        super(1);
