...
final class NodeCoordinator$hitNear$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m3885hitNearJHbHoSQ((DelegatableNode) NodeCoordinatorKt.m3920nextUncheckedUntilhw7D004(this.$this_hitNear, this.$hitTestSource.m3918entityTypeOLwlOKw(), Nodes.INSTANCE.m3936getLayoutOLwlOKw()), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
