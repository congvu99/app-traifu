...
final class LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        ...
        float f = this.$zIndex;
        if (function1 == null) {
            companion.m3693place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), j, f);
        } else {
            companion.m3698placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), j, f, function1);
        }
    }
}
