...
final class NodeCoordinator$speculativeHit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m3887speculativeHitJHbHoSQ((DelegatableNode) NodeCoordinatorKt.m3920nextUncheckedUntilhw7D004(this.$this_speculativeHit, this.$hitTestSource.m3918entityTypeOLwlOKw(), Nodes.INSTANCE.m3936getLayoutOLwlOKw()), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
