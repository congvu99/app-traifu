...
public final class NodeCoordinator$Companion$SemanticsSource$1 implements NodeCoordinator.HitTestSource<SemanticsModifierNode> {
    ...
    public int m3916entityTypeOLwlOKw() {
        return Nodes.INSTANCE.m3941getSemanticsOLwlOKw();
    }
    ...
    public void m3915childHitTestYqVAtuI(LayoutNode layoutNode, long j, HitTestResult<SemanticsModifierNode> hitTestResult, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        layoutNode.m3788hitTestSemanticsM_7yMNQ$ui_release(j, hitTestResult, z, z2);
    }
}
