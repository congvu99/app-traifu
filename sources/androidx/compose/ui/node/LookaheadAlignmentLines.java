...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    public long m3844calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j) {
        Intrinsics.checkNotNullParameter(nodeCoordinator, "$this$calculatePositionInParent");
        LookaheadDelegate lookaheadDelegate$ui_release = nodeCoordinator.getLookaheadDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadDelegate$ui_release);
        long r0 = lookaheadDelegate$ui_release.m3859getPositionnOccac();
        return Offset.m1688plusMKHz9U(OffsetKt.Offset((float) IntOffset.m4822getXimpl(r0), (float) IntOffset.m4823getYimpl(r0)), j);
    }
}
