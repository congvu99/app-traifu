...
final class DistanceAndInLayer {
    ...
    public static final /* synthetic */ DistanceAndInLayer m3757boximpl(long j) {
    ...
    public static boolean m3760equalsimpl(long j, Object obj) {
        return (obj instanceof DistanceAndInLayer) && j == ((DistanceAndInLayer) obj).m3766unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3761equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3763hashCodeimpl(long j) {
        return C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(j);
    }

    /* renamed from: isInLayer-impl  reason: not valid java name */
    public static final boolean m3764isInLayerimpl(long j) {
        return ((int) (j & 4294967295L)) != 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3765toStringimpl(long j) {
    ...
    public static final int m3758compareToS_HNhKs(long j, long j2) {
        boolean r0 = m3764isInLayerimpl(j);
        if (r0 != m3764isInLayerimpl(j2)) {
            return r0 ? -1 : 1;
        }
        return (int) Math.signum(m3762getDistanceimpl(j) - m3762getDistanceimpl(j2));
    }

    /* renamed from: getDistance-impl  reason: not valid java name */
    public static final float m3762getDistanceimpl(long j) {
