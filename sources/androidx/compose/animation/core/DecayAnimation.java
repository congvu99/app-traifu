...
public final class DecayAnimation<T, V extends AnimationVector> implements Animation<T, V> {
    ...
    public DecayAnimation(VectorizedDecayAnimationSpec<V> vectorizedDecayAnimationSpec, TwoWayConverter<T, V> twoWayConverter, T t, V v) {
        ...
        this.targetValue = getTypeConverter().getConvertFromVector().invoke(this.animationSpec.getTargetValue(this.initialValueVector, v));
        this.durationNanos = this.animationSpec.getDurationNanos(this.initialValueVector, v);
        V copy = AnimationVectorsKt.copy(this.animationSpec.getVelocityFromNanos(getDurationNanos(), this.initialValueVector, v));
