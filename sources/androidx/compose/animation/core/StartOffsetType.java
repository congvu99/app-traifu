...
public final class StartOffsetType {
    ...
    public static final /* synthetic */ StartOffsetType m139boximpl(int i) {
        return new StartOffsetType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m140constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m141equalsimpl(int i, Object obj) {
        return (obj instanceof StartOffsetType) && i == ((StartOffsetType) obj).m145unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m142equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m143hashCodeimpl(int i) {
        return i;
    }
