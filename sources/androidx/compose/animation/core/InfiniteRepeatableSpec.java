...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode2, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(durationBasedAnimationSpec, (i & 2) != 0 ? RepeatMode.Restart : repeatMode2, (i & 4) != 0 ? StartOffset.m131constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public <V extends AnimationVector> VectorizedAnimationSpec<V> vectorize(TwoWayConverter<T, V> twoWayConverter) {
        ...
        return new VectorizedInfiniteRepeatableSpec<>((VectorizedDurationBasedAnimationSpec) this.animation.vectorize(twoWayConverter), this.repeatMode, m113getInitialStartOffsetRmkjzm4(), (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) infiniteRepeatableSpec.animation, (Object) this.animation) || infiniteRepeatableSpec.repeatMode != this.repeatMode || !StartOffset.m133equalsimpl0(infiniteRepeatableSpec.m113getInitialStartOffsetRmkjzm4(), m113getInitialStartOffsetRmkjzm4())) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m136hashCodeimpl(m113getInitialStartOffsetRmkjzm4());
    }
}
