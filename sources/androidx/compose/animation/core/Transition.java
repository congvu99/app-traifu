...
public final class Transition<S> {
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        public TransitionAnimationState(Transition transition, T t, V v, TwoWayConverter<T, V> twoWayConverter, String str) {
            ...
            this.animation$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TargetBasedAnimation(getAnimationSpec(), this.typeConverter, t, getTargetValue(), v), (SnapshotMutationPolicy) null, 2, (Object) null);
            ...
            Float f = (Float) VisibilityThresholdsKt.getVisibilityThresholdMap().get(this.typeConverter);
            if (f == null) {
                obj = null;
            } else {
