...
public final class TargetBasedAnimation<T, V extends AnimationVector> implements Animation<T, V> {
    ...
    public TargetBasedAnimation(VectorizedAnimationSpec<V> vectorizedAnimationSpec, TwoWayConverter<T, V> twoWayConverter, T t, T t2, V v) {
        ...
        this.targetValueVector = (AnimationVector) getTypeConverter().getConvertToVector().invoke(getTargetValue());
        if (v == null) {
            v2 = null;
        } else {
            v2 = AnimationVectorsKt.copy(v);
        }
        v2 = v2 == null ? AnimationVectorsKt.newInstance((AnimationVector) getTypeConverter().getConvertToVector().invoke(this.initialValue)) : v2;
        this.initialVelocityVector = v2;
        this.durationNanos = this.animationSpec.getDurationNanos(this.initialValueVector, this.targetValueVector, v2);
