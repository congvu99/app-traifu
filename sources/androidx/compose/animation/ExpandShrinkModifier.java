...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m77sizeByStateUzc_VyU(EnterExitState enterExitState, long j) {
        Intrinsics.checkNotNullParameter(enterExitState, "targetState");
        ChangeSize value = this.expand.getValue();
        long r0 = value == null ? j : value.getSize().invoke(IntSize.m4856boximpl(j)).m4868unboximpl();
        ChangeSize value2 = this.shrink.getValue();
        long r2 = value2 == null ? j : value2.getSize().invoke(IntSize.m4856boximpl(j)).m4868unboximpl();
    ...
    public final long m78targetOffsetByStateoFUgxo0(EnterExitState enterExitState, long j) {
        IntOffset intOffset;
        Intrinsics.checkNotNullParameter(enterExitState, "targetState");
        if (this.currentAlignment == null) {
            return IntOffset.Companion.m4832getZeronOccac();
        }
        ...
        if (i == 3) {
            ...
            if (value == null) {
                ...
                long r6 = value.getSize().invoke(IntSize.m4856boximpl(j)).m4868unboximpl();
                Alignment value2 = getAlignment().getValue();
                Intrinsics.checkNotNull(value2);
                long j2 = j;
                long j3 = r6;
                long r8 = value2.m1561alignKFBX0sM(j2, j3, LayoutDirection.Ltr);
                Alignment currentAlignment2 = getCurrentAlignment();
                Intrinsics.checkNotNull(currentAlignment2);
                long r11 = currentAlignment2.m1561alignKFBX0sM(j2, j3, LayoutDirection.Ltr);
                intOffset = IntOffset.m4813boximpl(IntOffsetKt.IntOffset(IntOffset.m4822getXimpl(r8) - IntOffset.m4822getXimpl(r11), IntOffset.m4823getYimpl(r8) - IntOffset.m4823getYimpl(r11)));
            }
            return intOffset == null ? IntOffset.Companion.m4832getZeronOccac() : intOffset.m4831unboximpl();
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m76measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        IntOffset intOffset;
        long j2;
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable r4 = measurable.m3649measureBRTryo0(j);
        long IntSize = IntSizeKt.IntSize(r4.getWidth(), r4.getHeight());
        long r11 = this.sizeAnimation.animate(this.sizeTransitionSpec, new ExpandShrinkModifier$measure$currentSize$1(this, IntSize)).getValue().m4868unboximpl();
        long r13 = this.offsetAnimation.animate(ExpandShrinkModifier$measure$offsetDelta$1.INSTANCE, new ExpandShrinkModifier$measure$offsetDelta$2(this, IntSize)).getValue().m4831unboximpl();
        Alignment alignment2 = this.currentAlignment;
        if (alignment2 == null) {
            intOffset = null;
        } else {
            intOffset = IntOffset.m4813boximpl(alignment2.m1561alignKFBX0sM(IntSize, r11, LayoutDirection.Ltr));
        }
        if (intOffset == null) {
            j2 = IntOffset.Companion.m4832getZeronOccac();
        } else {
            j2 = intOffset.m4831unboximpl();
        }
        int r1 = IntSize.m4864getWidthimpl(r11);
        return MeasureScope.CC.layout$default(measureScope, r1, IntSize.m4863getHeightimpl(r11), (Map) null, new ExpandShrinkModifier$measure$1(r4, j2, r13), 4, (Object) null);
    }
}
