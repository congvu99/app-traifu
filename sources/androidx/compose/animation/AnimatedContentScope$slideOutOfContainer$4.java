...
final class AnimatedContentScope$slideOutOfContainer$4 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m4823getYimpl(this.this$0.m13calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), intSize == null ? IntSize.Companion.m4869getZeroYbymL2g() : intSize.m4868unboximpl()))) - i));
    }
}
