...
final class AnimatedContentScope$slideOutOfContainer$5 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        ...
        long r0 = intSize == null ? IntSize.Companion.m4869getZeroYbymL2g() : intSize.m4868unboximpl();
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m4823getYimpl(this.this$0.m13calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), r0))) + IntSize.m4863getHeightimpl(r0)));
    }
}
