...
final class AnimatedContentScope$slideIntoContainer$5 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        return this.$initialOffset.invoke(Integer.valueOf((-IntOffset.m4823getYimpl(this.this$0.m13calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.this$0.m16getCurrentSizeYbymL2g()))) - i));
    }
}
