...
public final class Strings {
    ...
    public static final int CloseDrawer = m1404constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int CloseSheet = m1404constructorimpl(2);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int DefaultErrorMessage = m1404constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int ExposedDropdownMenu = m1404constructorimpl(4);
    /* access modifiers changed from: private */
    public static final int NavigationMenu = m1404constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int SliderRangeEnd = m1404constructorimpl(6);
    /* access modifiers changed from: private */
    public static final int SliderRangeStart = m1404constructorimpl(5);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Strings m1403boximpl(int i) {
        return new Strings(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1404constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1405equalsimpl(int i, Object obj) {
        return (obj instanceof Strings) && i == ((Strings) obj).m1409unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1405equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1407hashCodeimpl(this.value);
    }

    public String toString() {
        return m1408toStringimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m1409unboximpl() {
        return this.value;
    }
