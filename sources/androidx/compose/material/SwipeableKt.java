...
public final class SwipeableKt {
    ...
    public static /* synthetic */ Modifier m1430swipeablepPrIpRY$default(Modifier modifier, SwipeableState swipeableState, Map map, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, Function2 function2, ResistanceConfig resistanceConfig, float f, int i, Object obj) {
        int i2 = i;
        return m1429swipeablepPrIpRY(modifier, swipeableState, map, orientation, (i2 & 8) != 0 ? true : z, (i2 & 16) != 0 ? false : z2, (i2 & 32) != 0 ? null : mutableInteractionSource, (i2 & 64) != 0 ? SwipeableKt$swipeable$1.INSTANCE : function2, (i2 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, map.keySet(), 0.0f, 0.0f, 6, (Object) null) : resistanceConfig, (i2 & 256) != 0 ? SwipeableDefaults.INSTANCE.m1428getVelocityThresholdD9Ej5fM() : f);
    }
    ...
    public static final <T> Modifier m1429swipeablepPrIpRY(Modifier modifier, SwipeableState<T> swipeableState, Map<Float, ? extends T> map, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, Function2<? super T, ? super T, ? extends ThresholdConfig> function2, ResistanceConfig resistanceConfig, float f) {
