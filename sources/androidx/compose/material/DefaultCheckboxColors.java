...
final class DefaultCheckboxColors implements CheckboxColors {
    ...
    public State<Color> checkmarkColor(ToggleableState toggleableState, Composer composer, int i) {
        ...
        State<Color> r10 = SingleValueAnimationKt.m86animateColorAsStateKTwxG1Y(j, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, (Easing) null, 6, (Object) null), (Function1<? super Color, Unit>) null, composer, 0, 4);
    ...
    public State<Color> boxColor(boolean z, ToggleableState toggleableState, Composer composer, int i) {
        ...
        if (z) {
            ...
            state = SingleValueAnimationKt.m86animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, (Easing) null, 6, (Object) null), (Function1<? super Color, Unit>) null, composer, 0, 4);
            composer.endReplaceableGroup();
        } else {
