...
final class OutlinedTextFieldKt$OutlinedTextField$2 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer2, "C183@9550L834:OutlinedTextField.kt#jmzs0o");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 91) != 18 || !composer.getSkipping()) {
            ...
            Function2 composableLambda = ComposableLambdaKt.composableLambda(composer2, 329542189, true, new Function2<Composer, Integer, Unit>() {
                ...
                public final void invoke(Composer composer, int i) {
                    ComposerKt.sourceInformation(composer, "C197@10149L203:OutlinedTextField.kt#jmzs0o");
            ...
            int i5 = this.$$dirty;
            int i6 = this.$$dirty1;
            int i7 = (i5 & 14) | ((i2 << 3) & 112) | ((i5 >> 3) & 896) | ((i6 >> 3) & 7168) | (57344 & (i6 << 9)) | (458752 & (i6 >> 3)) | (3670016 & (i6 << 18)) | (29360128 & (i5 << 3)) | (234881024 & (i5 << 3)) | (1879048192 & (i5 << 3));
