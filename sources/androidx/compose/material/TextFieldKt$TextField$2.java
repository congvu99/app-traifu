...
final class TextFieldKt$TextField$2 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer2, "C208@10466L538:TextField.kt#jmzs0o");
        if ((i & 14) == 0) {
        ...
        if ((i2 & 91) != 18 || !composer.getSkipping()) {
            ...
            int i3 = this.$$dirty;
            int i4 = this.$$dirty1;
            TextFieldDefaults.INSTANCE.TextFieldDecorationBox(this.$value, function2, this.$enabled, this.$singleLine, this.$visualTransformation, this.$interactionSource, z, function23, function24, function25, function26, textFieldColors, (PaddingValues) null, composer, ((i4 >> 3) & 7168) | (i3 & 14) | ((i2 << 3) & 112) | ((i3 >> 3) & 896) | ((i4 << 9) & 57344) | ((i4 >> 3) & 458752) | ((i4 << 18) & 3670016) | ((i3 << 3) & 29360128) | ((i3 << 3) & 234881024) | ((i3 << 3) & 1879048192), ((i3 >> 27) & 14) | 3072 | ((i4 >> 21) & 112), 4096);
            return;
        }
