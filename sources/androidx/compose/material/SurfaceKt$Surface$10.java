...
final class SurfaceKt$Surface$10 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer2, "C465@23267L7,463@23138L221,474@23616L16,458@22960L910:Surface.kt#jmzs0o");
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Shape shape2 = shape;
            Modifier modifier2 = ToggleableKt.m820toggleableO2vRcR0(SurfaceKt.m1425surface8ww4TTg(modifier, shape2, SurfaceKt.m1426surfaceColorAtElevationcq6XJ1M(j, (ElevationOverlay) consume, this.$absoluteElevation, composer, (this.$$dirty >> 15) & 14), this.$border, this.$elevation), this.$checked, this.$interactionSource, RippleKt.m1521rememberRipple9IZ8Weo(false, 0.0f, 0, composer, 0, 7), this.$enabled, Role.m4084boximpl(Role.Companion.m4095getSwitcho7Vup1c()), this.$onCheckedChange);
            ...
            ComposerKt.sourceInformation(composer2, "C481@23851L9:Surface.kt#jmzs0o");
