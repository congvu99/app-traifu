...
public final class RippleKt {
    ...
    public static final Indication m1521rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1922boximpl(j), composer, (i >> 6) & 14);
        Boolean valueOf = Boolean.valueOf(z);
        Dp r6 = Dp.m4702boximpl(f);
    ...
    public static final AnimationSpec<Float> outgoingStateLayerAnimationSpecFor(Interaction interaction) {
        ...
        if (interaction instanceof DragInteraction.Start) {
            return new TweenSpec<>(TextFieldImplKt.AnimationDuration, 0, EasingKt.getLinearEasing(), 2, (DefaultConstructorMarker) null);
        }
        return DefaultTweenSpec;
    }
}
