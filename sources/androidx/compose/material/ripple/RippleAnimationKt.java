...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m4704constructorimpl((float) 10);
    ...
    public static final float m1515getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m1752getWidthimpl(j), Size.m1749getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA  reason: not valid java name */
    public static final float m1514getRippleEndRadiuscSwnlzA(Density density, boolean z, long j) {
        Intrinsics.checkNotNullParameter(density, "$this$getRippleEndRadius");
        float r3 = Offset.m1681getDistanceimpl(OffsetKt.Offset(Size.m1752getWidthimpl(j), Size.m1749getHeightimpl(j))) / 2.0f;
        return z ? r3 + density.m4649toPx0680j_4(BoundedRippleExtraRadius) : r3;
    }
}
