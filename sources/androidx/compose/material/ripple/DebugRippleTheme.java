...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long m1510defaultColorWaAFU9c(Composer composer, int i) {
        composer.startReplaceableGroup(2042140174);
        ComposerKt.sourceInformation(composer, "C(defaultColor):RippleTheme.kt#vhb33q");
        long r0 = RippleTheme.Companion.m1524defaultRippleColor5vOe2sY(Color.Companion.m1958getBlack0d7_KjU(), true);
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha r5 = RippleTheme.Companion.m1523defaultRippleAlphaDxMtmZc(Color.Companion.m1958getBlack0d7_KjU(), true);
        composer.endReplaceableGroup();
        return r5;
    }
}
