...
public final class RippleContainer extends ViewGroup {
    ...
    private final RippleHostMap rippleHostMap = new RippleHostMap();
    private final List<RippleHostView> rippleHosts = new ArrayList();
    private final List<RippleHostView> unusedRippleHosts = new ArrayList();
