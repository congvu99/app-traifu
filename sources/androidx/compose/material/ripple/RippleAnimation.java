...
public final class RippleAnimation {
    ...
    public final void m1513draw4WTKRHQ(DrawScope drawScope, long j) {
        float f;
        Float f2;
        DrawScope drawScope2 = drawScope;
        Intrinsics.checkNotNullParameter(drawScope2, "$this$draw");
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1515getRippleStartRadiusuvyYCjk(drawScope.m2478getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                f2 = Float.valueOf(RippleAnimationKt.m1514getRippleEndRadiuscSwnlzA(drawScope2, this.bounded, drawScope.m2478getSizeNHjbRc()));
            } else {
                f2 = Float.valueOf(drawScope2.m4649toPx0680j_4(this.radius));
            }
            this.targetRadius = f2;
        }
        if (this.origin == null) {
            this.origin = Offset.m1672boximpl(drawScope.m2477getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m1672boximpl(OffsetKt.Offset(Size.m1752getWidthimpl(drawScope.m2478getSizeNHjbRc()) / 2.0f, Size.m1749getHeightimpl(drawScope.m2478getSizeNHjbRc()) / 2.0f));
        }
        ...
        float r3 = Offset.m1683getXimpl(offset.m1693unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(r3, Offset.m1683getXimpl(offset2.m1693unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float r5 = Offset.m1684getYimpl(offset3.m1693unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(r5, Offset.m1684getYimpl(offset4.m1693unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long r2 = Color.m1931copywmQWz5c$default(j, Color.m1934getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        if (this.bounded) {
            float r11 = Size.m1752getWidthimpl(drawScope.m2478getSizeNHjbRc());
            float r12 = Size.m1749getHeightimpl(drawScope.m2478getSizeNHjbRc());
            int r13 = ClipOp.Companion.m1921getIntersectrtfAjoo();
            DrawContext drawContext = drawScope.getDrawContext();
            long r7 = drawContext.m2456getSizeNHjbRc();
            drawContext.getCanvas().save();
            drawContext.getTransform().m2566clipRectN_I0leg(0.0f, 0.0f, r11, r12, r13);
            DrawScope.CC.m2501drawCircleVaOC9Bg$default(drawScope, r2, lerp, Offset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
            drawContext.getCanvas().restore();
            drawContext.m2457setSizeuvyYCjk(r7);
            return;
        }
        DrawScope.CC.m2501drawCircleVaOC9Bg$default(drawScope, r2, lerp, Offset, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 120, (Object) null);
    }
