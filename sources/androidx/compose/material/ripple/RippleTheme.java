...
public interface RippleTheme {
    ...
    long m1522defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1524defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m1985luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m1969getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m1523defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (!z) {
                return RippleThemeKt.DarkThemeRippleAlpha;
            }
            if (((double) ColorKt.m1985luminance8_81llA(j)) > 0.5d) {
