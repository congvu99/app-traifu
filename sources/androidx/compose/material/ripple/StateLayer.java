...
final class StateLayer {
    ...
    public final void m1525drawStateLayerH2RKhps(DrawScope drawScope, float f, long j) {
        float f2;
        DrawScope drawScope2 = drawScope;
        Intrinsics.checkNotNullParameter(drawScope2, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m1514getRippleEndRadiuscSwnlzA(drawScope2, this.bounded, drawScope.m2478getSizeNHjbRc());
        } else {
            f2 = drawScope.m4649toPx0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long r2 = Color.m1931copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, (Object) null);
            if (this.bounded) {
                float r9 = Size.m1752getWidthimpl(drawScope.m2478getSizeNHjbRc());
                float r10 = Size.m1749getHeightimpl(drawScope.m2478getSizeNHjbRc());
                int r11 = ClipOp.Companion.m1921getIntersectrtfAjoo();
                DrawContext drawContext = drawScope.getDrawContext();
                long r14 = drawContext.m2456getSizeNHjbRc();
                drawContext.getCanvas().save();
                drawContext.getTransform().m2566clipRectN_I0leg(0.0f, 0.0f, r9, r10, r11);
                DrawScope.CC.m2501drawCircleVaOC9Bg$default(drawScope, r2, f3, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 124, (Object) null);
                drawContext.getCanvas().restore();
                drawContext.m2457setSizeuvyYCjk(r14);
                return;
            }
            DrawScope.CC.m2501drawCircleVaOC9Bg$default(drawScope, r2, f3, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, 0, 124, (Object) null);
        }
