...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1527setColorDxMtmZc(long j, float f) {
        long r3 = m1526calculateRippleColor5vOe2sY(j, f);
        Color color = this.rippleColor;
        if (!(color == null ? false : Color.m1933equalsimpl0(color.m1942unboximpl(), r3))) {
            this.rippleColor = Color.m1922boximpl(r3);
            setColor(ColorStateList.valueOf(ColorKt.m1987toArgb8_81llA(r3)));
        }
    }
    ...
    private final long m1526calculateRippleColor5vOe2sY(long j, float f) {
        if (Build.VERSION.SDK_INT < 28) {
            f *= (float) 2;
        }
        return Color.m1931copywmQWz5c$default(j, RangesKt.coerceAtMost(f, 1.0f), 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }
