...
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        ...
        long r0 = this.color.getValue().m1942unboximpl();
        contentDrawScope.drawContent();
        DrawScope drawScope = contentDrawScope;
        m1520drawStateLayerH2RKhps(drawScope, this.radius, r0);
        m1509drawRipples4WTKRHQ(drawScope, r0);
    }
    ...
    public void addRipple(PressInteraction.Press press, CoroutineScope coroutineScope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m1672boximpl(press.m380getPressPositionF1C5BW0()) : null, this.radius, this.bounded, (DefaultConstructorMarker) null);
    ...
    private final void m1509drawRipples4WTKRHQ(DrawScope drawScope, long j) {
        for (Map.Entry value : this.ripples.entrySet()) {
            RippleAnimation rippleAnimation = (RippleAnimation) value.getValue();
            float pressedAlpha = this.rippleAlpha.getValue().getPressedAlpha();
            if (!(pressedAlpha == 0.0f)) {
                rippleAnimation.m1513draw4WTKRHQ(drawScope, Color.m1931copywmQWz5c$default(j, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, (Object) null));
            }
        }
    }
