...
public abstract class Ripple implements Indication {
    ...
    public abstract RippleIndicationInstance m1512rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i);
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (this.color.getValue().m1942unboximpl() != Color.Companion.m1968getUnspecified0d7_KjU()) {
            j = this.color.getValue().m1942unboximpl();
        } else {
            j = rippleTheme.m1522defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance r0 = m1512rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m1922boximpl(j), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | (458752 & (i << 12)));
    ...
    public boolean equals(Object obj) {
        ...
        return this.bounded == ripple.bounded && Dp.m4709equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual((Object) this.color, (Object) ripple.color);
    }

    public int hashCode() {
        return (((C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.bounded) * 31) + Dp.m4710hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
}
