...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long m1248apply7g2Lkgo(long j, float f, Composer composer, int i) {
        ...
        if (Dp.m4703compareTo0680j_4(f, Dp.m4704constructorimpl((float) 0)) > 0 && !colors.isLight()) {
            j = ColorKt.m1978compositeOverOWjLjI(ElevationOverlayKt.m1284calculateForegroundColorCLU3JFs(j, f, composer, (i & 112) | (i & 14)), j);
        }
