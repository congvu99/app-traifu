...
final class DefaultTextFieldColors implements TextFieldColors {
    ...
    public State<Color> indicatorColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        } else if (m1249indicatorColor$lambda0(collectIsFocusedAsState)) {
    ...
    public State<Color> labelColor(boolean z, boolean z2, InteractionSource interactionSource, Composer composer, int i) {
        ...
        } else if (m1250labelColor$lambda1(collectIsFocusedAsState)) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m1933equalsimpl0(this.textColor, defaultTextFieldColors.textColor) && Color.m1933equalsimpl0(this.disabledTextColor, defaultTextFieldColors.disabledTextColor) && Color.m1933equalsimpl0(this.cursorColor, defaultTextFieldColors.cursorColor) && Color.m1933equalsimpl0(this.errorCursorColor, defaultTextFieldColors.errorCursorColor) && Color.m1933equalsimpl0(this.focusedIndicatorColor, defaultTextFieldColors.focusedIndicatorColor) && Color.m1933equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldColors.unfocusedIndicatorColor) && Color.m1933equalsimpl0(this.errorIndicatorColor, defaultTextFieldColors.errorIndicatorColor) && Color.m1933equalsimpl0(this.disabledIndicatorColor, defaultTextFieldColors.disabledIndicatorColor) && Color.m1933equalsimpl0(this.leadingIconColor, defaultTextFieldColors.leadingIconColor) && Color.m1933equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldColors.disabledLeadingIconColor) && Color.m1933equalsimpl0(this.errorLeadingIconColor, defaultTextFieldColors.errorLeadingIconColor) && Color.m1933equalsimpl0(this.trailingIconColor, defaultTextFieldColors.trailingIconColor) && Color.m1933equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldColors.disabledTrailingIconColor) && Color.m1933equalsimpl0(this.errorTrailingIconColor, defaultTextFieldColors.errorTrailingIconColor) && Color.m1933equalsimpl0(this.backgroundColor, defaultTextFieldColors.backgroundColor) && Color.m1933equalsimpl0(this.focusedLabelColor, defaultTextFieldColors.focusedLabelColor) && Color.m1933equalsimpl0(this.unfocusedLabelColor, defaultTextFieldColors.unfocusedLabelColor) && Color.m1933equalsimpl0(this.disabledLabelColor, defaultTextFieldColors.disabledLabelColor) && Color.m1933equalsimpl0(this.errorLabelColor, defaultTextFieldColors.errorLabelColor) && Color.m1933equalsimpl0(this.placeholderColor, defaultTextFieldColors.placeholderColor) && Color.m1933equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldColors.disabledPlaceholderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((Color.m1939hashCodeimpl(this.textColor) * 31) + Color.m1939hashCodeimpl(this.disabledTextColor)) * 31) + Color.m1939hashCodeimpl(this.cursorColor)) * 31) + Color.m1939hashCodeimpl(this.errorCursorColor)) * 31) + Color.m1939hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m1939hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m1939hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m1939hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m1939hashCodeimpl(this.leadingIconColor)) * 31) + Color.m1939hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m1939hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m1939hashCodeimpl(this.trailingIconColor)) * 31) + Color.m1939hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m1939hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m1939hashCodeimpl(this.backgroundColor)) * 31) + Color.m1939hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m1939hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m1939hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m1939hashCodeimpl(this.errorLabelColor)) * 31) + Color.m1939hashCodeimpl(this.placeholderColor)) * 31) + Color.m1939hashCodeimpl(this.disabledPlaceholderColor);
    }

    /* renamed from: indicatorColor$lambda-0  reason: not valid java name */
    private static final boolean m1249indicatorColor$lambda0(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: labelColor$lambda-1  reason: not valid java name */
    private static final boolean m1250labelColor$lambda1(State<Boolean> state) {
        return state.getValue().booleanValue();
    }
}
