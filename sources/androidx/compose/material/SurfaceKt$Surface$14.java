...
final class SurfaceKt$Surface$14 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        SurfaceKt.m1418Surface9VG74zQ(function02, this.$modifier, this.$shape, this.$color, this.$contentColor, this.$border, this.$elevation, this.$interactionSource, this.$indication, this.$enabled, this.$onClickLabel, this.$role, this.$content, composer2, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
