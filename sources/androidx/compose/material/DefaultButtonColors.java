...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m1933equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m1933equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m1933equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m1933equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m1939hashCodeimpl(this.backgroundColor) * 31) + Color.m1939hashCodeimpl(this.contentColor)) * 31) + Color.m1939hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m1939hashCodeimpl(this.disabledContentColor);
    }
}
