...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult m976measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable r11 = measurable.m3649measureBRTryo0(Constraints.m4615copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, (Object) null));
        int min = Math.min(r11.getHeight(), Constraints.m4623getMaxHeightimpl(j));
        return MeasureScope.CC.layout$default(measureScope, r11.getWidth(), min, (Map) null, new VerticalScrollLayoutModifier$measure$1(measureScope, this, r11, min), 4, (Object) null);
    }
}
