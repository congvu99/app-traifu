...
public final class UndoManager {
    ...
    public final void snapshotIfNeeded(TextFieldValue textFieldValue, long j) {
        ...
        if (!this.forceNextSnapshot) {
            ...
            if (j <= (l != null ? l.longValue() : 0) + ((long) UndoManagerKt.getSNAPSHOTS_INTERVAL_MILLIS())) {
                return;
            }
        }
    ...
    public final void makeSnapshot(TextFieldValue textFieldValue) {
        ...
        if (!Intrinsics.areEqual((Object) textFieldValue, (Object) entry != null ? entry.getValue() : null)) {
