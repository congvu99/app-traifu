...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m966getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m968getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m968getOffsetForPosition3MmeM6k(long j, boolean z) {
        if (z) {
            j = m965coercedInVisibleBoundsOfInputTextMKHz9U(j);
        }
        return this.value.m4195getOffsetForPositionk4lQ0M(m967relativeToInputTextMKHz9U(j));
    }

    public final int getLineForVerticalPosition(float f) {
        return this.value.getLineForVerticalPosition(Offset.m1684getYimpl(m967relativeToInputTextMKHz9U(m965coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, f)))));
    }
    ...
    public final boolean m969isPositionOnTextk4lQ0M(long j) {
        long r4 = m967relativeToInputTextMKHz9U(m965coercedInVisibleBoundsOfInputTextMKHz9U(j));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m1684getYimpl(r4));
        return Offset.m1683getXimpl(r4) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m1683getXimpl(r4) <= this.value.getLineRight(lineForVerticalPosition);
    }
    ...
    private final long m967relativeToInputTextMKHz9U(long j) {
        Offset offset;
        ...
        if (layoutCoordinates2 != null) {
            offset = Offset.m1672boximpl((!layoutCoordinates.isAttached() || !layoutCoordinates2.isAttached()) ? j : layoutCoordinates.m3612localPositionOfR5De75A(layoutCoordinates2, j));
        } else {
            offset = null;
        }
        return offset != null ? offset.m1693unboximpl() : j;
    }
    ...
    private final long m965coercedInVisibleBoundsOfInputTextMKHz9U(long r6) {
        /*
            r5 = this;
        ...
        L_0x001e:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L_0x0024:
            long r6 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m971coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m965coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
