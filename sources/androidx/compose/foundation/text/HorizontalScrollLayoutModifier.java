...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult m883measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long j2;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        if (measurable.maxIntrinsicWidth(Constraints.m4623getMaxHeightimpl(j)) < Constraints.m4624getMaxWidthimpl(j)) {
            j2 = j;
        } else {
            j2 = Constraints.m4615copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null);
        }
        Placeable r12 = measurable.m3649measureBRTryo0(j2);
        int min = Math.min(r12.getWidth(), Constraints.m4624getMaxWidthimpl(j));
        return MeasureScope.CC.layout$default(measureScope, min, r12.getHeight(), (Map) null, new HorizontalScrollLayoutModifier$measure$1(measureScope, this, r12, min), 4, (Object) null);
    }
}
