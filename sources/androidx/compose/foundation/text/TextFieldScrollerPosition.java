...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.Companion.m4225getZerod9O1mEE();
    ...
    public final long m953getPreviousSelectiond9O1mEE() {
        return this.previousSelection;
    }

    /* renamed from: setPreviousSelection-5zc-tL8  reason: not valid java name */
    public final void m954setPreviousSelection5zctL8(long j) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0036, code lost:
        if ((r6.getTop() == r4.previousCursorRect.getTop()) == false) goto L_0x0038;
     */
    ...
    public final int m952getOffsetToFollow5zctL8(long j) {
        if (TextRange.m4220getStartimpl(j) != TextRange.m4220getStartimpl(this.previousSelection)) {
            return TextRange.m4220getStartimpl(j);
        }
        if (TextRange.m4215getEndimpl(j) != TextRange.m4215getEndimpl(this.previousSelection)) {
            return TextRange.m4215getEndimpl(j);
        }
        return TextRange.m4218getMinimpl(j);
    }
