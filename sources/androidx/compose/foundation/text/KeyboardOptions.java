...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.Companion.m4398getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.Companion.m4415getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.Companion.m4375getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }

    /* renamed from: getCapitalization-IUNYP9k  reason: not valid java name */
    public final int m893getCapitalizationIUNYP9k() {
    ...
    public final int m895getKeyboardTypePjHm6EE() {
        return this.keyboardType;
    }

    /* renamed from: getImeAction-eUduSuo  reason: not valid java name */
    public final int m894getImeActioneUduSuo() {
    ...
    public static /* synthetic */ KeyboardOptions m891copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m892copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw  reason: not valid java name */
    public final KeyboardOptions m892copy3m2b7yw(int i, boolean z, int i2, int i3) {
    ...
    public boolean equals(Object obj) {
        ...
        return KeyboardCapitalization.m4393equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m4404equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m4371equalsimpl0(this.imeAction, keyboardOptions.imeAction);
    }

    public int hashCode() {
        return (((((KeyboardCapitalization.m4394hashCodeimpl(this.capitalization) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4405hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4372hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + KeyboardCapitalization.m4395toStringimpl(this.capitalization) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + KeyboardType.m4406toStringimpl(this.keyboardType) + ", imeAction=" + ImeAction.m4373toStringimpl(this.imeAction) + ')';
    }
}
