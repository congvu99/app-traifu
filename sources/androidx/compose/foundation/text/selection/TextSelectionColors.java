...
public final class TextSelectionColors {
    ...
    public final long m1109getHandleColor0d7_KjU() {
        return this.handleColor;
    }

    /* renamed from: getBackgroundColor-0d7_KjU  reason: not valid java name */
    public final long m1108getBackgroundColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m1933equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m1933equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m1939hashCodeimpl(this.handleColor) * 31) + Color.m1939hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + Color.m1940toStringimpl(this.handleColor) + ", selectionBackgroundColor=" + Color.m1940toStringimpl(this.backgroundColor) + ')';
    }
}
