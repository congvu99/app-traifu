...
public interface Selectable {
    ...
    long m995getHandlePositiondBAh8RU(Selection selection, boolean z);

    LayoutCoordinates getLayoutCoordinates();

    /* renamed from: getRangeOfLineContaining--jx7JFs  reason: not valid java name */
    long m996getRangeOfLineContainingjx7JFs(int i);
    ...
    Pair<Selection, Boolean> m997updateSelectionqCDeeow(long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ Pair m998updateSelectionqCDeeow$default(Selectable selectable, long j, long j2, Offset offset, boolean z, LayoutCoordinates layoutCoordinates, SelectionAdjustment selectionAdjustment, Selection selection, int i, Object obj) {
            if (obj == null) {
                return selectable.m997updateSelectionqCDeeow(j, j2, offset, (i & 8) != 0 ? true : z, layoutCoordinates, selectionAdjustment, (i & 64) != 0 ? null : selection);
            }
