...
final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Function0 r1 = new Function0<Offset>() {
            public /* bridge */ /* synthetic */ Object invoke() {
                return Offset.m1672boximpl(m1105invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0  reason: not valid java name */
            public final long m1105invokeF1C5BW0() {
                return TextFieldSelectionManagerKt.m1100calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.m1103invoke$lambda1(mutableState));
            }
        };
    ...
    public static final long m1103invoke$lambda1(MutableState<IntSize> mutableState) {
        return ((IntSize) mutableState.getValue()).m4868unboximpl();
    }

    /* access modifiers changed from: private */
    /* renamed from: invoke$lambda-2  reason: not valid java name */
    public static final void m1104invoke$lambda2(MutableState<IntSize> mutableState, long j) {
