...
public final class SelectionHandlesKt {
    ...
    public static final long m1017getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m1683getXimpl(j), Offset.m1684getYimpl(j) - 1.0f);
    }

    static {
        float f = (float) 25;
        HandleWidth = Dp.m4704constructorimpl(f);
        HandleHeight = Dp.m4704constructorimpl(f);
    }
}
