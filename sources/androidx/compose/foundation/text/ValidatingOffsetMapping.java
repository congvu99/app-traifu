...
final class ValidatingOffsetMapping implements OffsetMapping {
    ...
    public int originalToTransformed(int i) {
        ...
        throw new IllegalStateException(("OffsetMapping.originalToTransformed returned invalid mapping: " + i + " -> " + originalToTransformed + " is not in range of transformed text [0, " + this.transformedLength + JsonLexerKt.END_LIST).toString());
    }
    ...
    public int transformedToOriginal(int i) {
        ...
        throw new IllegalStateException(("OffsetMapping.transformedToOriginal returned invalid mapping: " + i + " -> " + transformedToOriginal + " is not in range of original text [0, " + this.originalLength + JsonLexerKt.END_LIST).toString());
    }
}
