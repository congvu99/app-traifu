...
final class ClickableKt$genericClickableWithoutGesture$detectPressAndClickFromKey$1 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m210invokeZmokQxo(((KeyEvent) obj).m3271unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m210invokeZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "keyEvent");
        boolean z = true;
        if (!this.$enabled || !Clickable_androidKt.m213isPressZmokQxo(keyEvent)) {
            if (this.$enabled && Clickable_androidKt.m211isClickZmokQxo(keyEvent)) {
                PressInteraction.Press remove = this.$currentKeyPressInteractions.remove(Key.m2684boximpl(KeyEvent_androidKt.m3282getKeyZmokQxo(keyEvent)));
                if (remove != null) {
        ...
        } else if (!this.$currentKeyPressInteractions.containsKey(Key.m2684boximpl(KeyEvent_androidKt.m3282getKeyZmokQxo(keyEvent)))) {
            final PressInteraction.Press press = new PressInteraction.Press(this.$keyClickOffset.getValue().m1693unboximpl(), (DefaultConstructorMarker) null);
            this.$currentKeyPressInteractions.put(Key.m2684boximpl(KeyEvent_androidKt.m3282getKeyZmokQxo(keyEvent)), press);
