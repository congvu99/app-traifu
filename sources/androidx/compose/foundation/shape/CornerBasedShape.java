...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline m837createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection);
    ...
    public final Outline m838createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, ViewProps.LAYOUT_DIRECTION);
        Intrinsics.checkNotNullParameter(density, "density");
        float r3 = this.topStart.m839toPxTmRCtEA(j, density);
        float r4 = this.topEnd.m839toPxTmRCtEA(j, density);
        float r5 = this.bottomEnd.m839toPxTmRCtEA(j, density);
        float r0 = this.bottomStart.m839toPxTmRCtEA(j, density);
        float r6 = Size.m1751getMinDimensionimpl(j);
        float f = r3 + r0;
        if (f > r6) {
            float f2 = r6 / f;
            r3 *= f2;
        ...
        if (r3 >= 0.0f && r4 >= 0.0f && r5 >= 0.0f && f3 >= 0.0f) {
            return m837createOutlineLjSzlW0(j, r3, r4, r5, f3, layoutDirection);
        }
