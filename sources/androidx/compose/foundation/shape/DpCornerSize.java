...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m846component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m847copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m848copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m848copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m4709equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }

    public /* synthetic */ Sequence<ValueElement> getInspectableElements() {
    ...
    public int hashCode() {
        return Dp.m4710hashCodeimpl(this.size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m4702boximpl(m849getValueOverrideD9Ej5fM());
    }

    /* renamed from: toPx-TmRCtEA  reason: not valid java name */
    public float m850toPxTmRCtEA(long j, Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m4649toPx0680j_4(this.size);
    }
    ...
    public float m849getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
