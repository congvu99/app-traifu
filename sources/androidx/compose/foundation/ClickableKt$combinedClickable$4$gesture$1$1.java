...
final class ClickableKt$combinedClickable$4$gesture$1$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass3 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
            return m208invoked4ec7I((PressGestureScope) obj, ((Offset) obj2).m1693unboximpl(), (Continuation) obj3);
        }

        /* renamed from: invoke-d-4ec7I  reason: not valid java name */
        public final Object m208invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (z) {
                    this.label = 1;
                    if (ClickableKt.m203handlePressInteractionEPk0efs(pressGestureScope, j, mutableInteractionSource, mutableState2, state3, this) == coroutine_suspended) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            long r4 = IntSizeKt.m4870getCenterozmzZPI(pointerInputScope.m3452getSizeYbymL2g());
            mutableState.setValue(Offset.m1672boximpl(OffsetKt.Offset((float) IntOffset.m4822getXimpl(r4), (float) IntOffset.m4823getYimpl(r4))));
            if (!this.$hasDoubleClick || !this.$enabled) {
                ...
                function1 = new Function1<Offset, Unit>() {
                    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                        m206invokek4lQ0M(((Offset) obj).m1693unboximpl());
                        return Unit.INSTANCE;
                    }
            ...
            if (!this.$hasLongClick || !this.$enabled) {
                ...
                function12 = new Function1<Offset, Unit>() {
                    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                        m207invokek4lQ0M(((Offset) obj).m1693unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                    public final void m207invokek4lQ0M(long j) {
            ...
            if (TapGestureDetectorKt.detectTapGestures(pointerInputScope, function13, function12, new AnonymousClass3((Continuation<? super AnonymousClass3>) null), new Function1<Offset, Unit>() {
                public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                    m209invokek4lQ0M(((Offset) obj).m1693unboximpl());
                    return Unit.INSTANCE;
                }
