...
public final class ScrollableStateKt {
    ...
    public static final ScrollableState rememberScrollableState(Function1<? super Float, Float> function1, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(rememberScrollableState)116@5549L40,117@5601L61:ScrollableState.kt#8bwon0");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-180460798, i, -1, "androidx.compose.foundation.gestures.rememberScrollableState (ScrollableState.kt:115)");
        }
