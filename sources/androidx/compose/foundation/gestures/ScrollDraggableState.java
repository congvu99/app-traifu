...
final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float f) {
        ...
        value.m358dispatchScroll3eAAhYA(this.latestScrollScope, value.m368toOffsettuRUvjQ(f), NestedScrollSource.Companion.m3327getDragWNlRxjI());
    }
    ...
    public Object drag(MutatePriority mutatePriority, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object scroll = this.scrollLogic.getValue().getScrollableState().scroll(mutatePriority, new ScrollDraggableState$drag$2(this, function2, (Continuation<? super ScrollDraggableState$drag$2>) null), continuation);
