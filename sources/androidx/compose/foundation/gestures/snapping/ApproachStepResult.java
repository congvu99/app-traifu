...
final class ApproachStepResult {
    ...
    public static /* synthetic */ ApproachStepResult copy$default(ApproachStepResult approachStepResult, float f, AnimationState<Float, AnimationVector1D> animationState, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final ApproachStepResult copy(float f, AnimationState<Float, AnimationVector1D> animationState) {
