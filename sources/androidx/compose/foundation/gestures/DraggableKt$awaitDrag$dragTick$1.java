...
final class DraggableKt$awaitDrag$dragTick$1 extends Lambda implements Function1<PointerInputChange, Unit> {
    ...
    DraggableKt$awaitDrag$dragTick$1(VelocityTracker velocityTracker, SendChannel<? super DragEvent> sendChannel, boolean z) {
        super(1);
    ...
    public final void invoke(PointerInputChange pointerInputChange) {
        ...
        if (this.$reverseDirection) {
            positionChange = Offset.m1690timestuRUvjQ(positionChange, -1.0f);
        }
        sendChannel.m6954trySendJP2dKIU(new DragEvent.DragDelta(positionChange, (DefaultConstructorMarker) null));
    }
}
