...
public final class LazyItemScopeImpl$fillParentMaxSize$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    final /* synthetic */ float $fraction$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyItemScopeImpl$fillParentMaxSize$$inlined$debugInspectorInfo$1(float f) {
        super(1);
