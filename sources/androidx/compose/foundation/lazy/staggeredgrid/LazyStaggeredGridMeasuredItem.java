...
final class LazyStaggeredGridMeasuredItem {
    ...
    private LazyStaggeredGridMeasuredItem(int i, Object obj, List<? extends Placeable> list, boolean z, long j, int i2) {
        ...
        this.sizeWithSpacings = intValue + this.spacing;
        List<Placeable> list2 = this.placeables;
        if (list2.isEmpty()) {
            comparable = null;
        } else {
            Placeable placeable2 = list2.get(0);
            comparable = Integer.valueOf(this.isVertical ? placeable2.getWidth() : placeable2.getHeight());
            int lastIndex = CollectionsKt.getLastIndex(list2);
            int i5 = 1;
            if (1 <= lastIndex) {
                while (true) {
                    Placeable placeable3 = list2.get(i5);
                    Comparable valueOf = Integer.valueOf(this.isVertical ? placeable3.getWidth() : placeable3.getHeight());
        ...
        this.crossAxisSize = ((Number) comparable).intValue();
    }
    ...
    public final long m813getContentOffsetnOccac() {
    ...
    public final LazyStaggeredGridPositionedItem position(int i, int i2, int i3) {
        ...
        return new LazyStaggeredGridPositionedItem(j, this.index, i, this.key, IntSizeKt.IntSize(this.sizeWithSpacings, this.crossAxisSize), this.placeables, this.contentOffset, this.isVertical, (DefaultConstructorMarker) null);
    }
}
