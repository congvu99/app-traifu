...
public final class LazyMeasuredItemProvider {
    ...
    private LazyMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope, MeasuredItemFactory measuredItemFactory2) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m4624getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.m4623getMaxHeightimpl(j) : Integer.MAX_VALUE, 5, (Object) null);
    }

    /* renamed from: getChildConstraints-msEJaDk  reason: not valid java name */
    public final long m675getChildConstraintsmsEJaDk() {
        return this.childConstraints;
    }

    /* renamed from: getAndMeasure-ZjPyQlc  reason: not valid java name */
    public final LazyMeasuredItem m674getAndMeasureZjPyQlc(int i) {
        return this.measuredItemFactory.m676createItemHK0c1C0(i, this.itemProvider.getKey(i), this.measureScope.m764measure0kLqBqw(i, this.childConstraints));
    }
