...
public final class LazyGridMeasureResult implements LazyGridLayoutInfo, MeasureResult {
    ...
    public LazyGridMeasureResult(LazyMeasuredLine lazyMeasuredLine, int i, boolean z, float f, MeasureResult measureResult, List<? extends LazyGridItemInfo> list, int i2, int i3, int i4, boolean z2, Orientation orientation2, int i5) {
    ...
    public long m726getViewportSizeYbymL2g() {
