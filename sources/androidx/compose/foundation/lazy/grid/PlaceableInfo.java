...
final class PlaceableInfo {
    ...
    private PlaceableInfo(long j, int i) {
        this.mainAxisSize = i;
        this.animatedOffset = new Animatable(IntOffset.m4813boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), (Object) null, 4, (DefaultConstructorMarker) null);
        this.targetOffset = j;
    ...
    public final long m761getTargetOffsetnOccac() {
        return this.targetOffset;
    }

    /* renamed from: setTargetOffset--gyyYBs  reason: not valid java name */
    public final void m762setTargetOffsetgyyYBs(long j) {
        this.targetOffset = j;
    }
