...
final class LazyGridItemProviderImpl implements LazyGridItemProvider, LazyLayoutItemProvider {
    ...
    public LazyGridItemProviderImpl(IntervalList<LazyGridIntervalContent> intervalList, boolean z, IntRange intRange) {
        ...
        this.$$delegate_0 = LazyLayoutItemProviderKt.LazyLayoutItemProvider(intervalList, intRange, ComposableSingletons$LazyGridItemProviderKt.INSTANCE.m680getLambda1$foundation_release());
    }
    ...
    public long m718getSpan_orMbw(LazyGridItemSpanScope lazyGridItemSpanScope, int i) {
        ...
        return interval.getValue().getSpan().invoke(lazyGridItemSpanScope, Integer.valueOf(i - interval.getStartIndex())).m689unboximpl();
    }
}
