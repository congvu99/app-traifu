...
public final class LazyMeasuredLine {
    ...
    public /* synthetic */ LazyMeasuredLine(int i, LazyMeasuredItem[] lazyMeasuredItemArr, List list, boolean z, int i2, LayoutDirection layoutDirection2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, lazyMeasuredItemArr, list, z, i2, layoutDirection2, i3, i4);
    }

    private LazyMeasuredLine(int i, LazyMeasuredItem[] lazyMeasuredItemArr, List<GridItemSpan> list, boolean z, int i2, LayoutDirection layoutDirection2, int i3, int i4) {
        this.index = i;
    ...
    public final int m743getIndexhA7yfN8() {
        return this.index;
    }
    ...
    public final List<LazyGridPositionedItem> position(int i, int i2, int i3) {
        ...
        Collection arrayList = new ArrayList(lazyMeasuredItemArr.length);
        ...
        while (i4 < length) {
            ...
            int i8 = i5 + 1;
            int r5 = GridItemSpan.m686getCurrentLineSpanimpl(this.spans.get(i5).m689unboximpl());
            int i9 = this.layoutDirection == LayoutDirection.Rtl ? (this.slotsPerLine - i6) - r5 : i6;
            int i10 = this.isVertical ? this.index : i9;
            if (!this.isVertical) {
                i9 = this.index;
            }
