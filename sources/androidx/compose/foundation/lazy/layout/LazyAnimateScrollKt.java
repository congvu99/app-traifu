...
public final class LazyAnimateScrollKt {
    ...
    public static final float BoundDistance = Dp.m4704constructorimpl((float) 1500);
    private static final boolean DEBUG = false;
    /* access modifiers changed from: private */
    public static final float TargetDistance = Dp.m4704constructorimpl((float) 2500);
    ...
    public static final Object animateScrollToItem(LazyAnimateScrollScope lazyAnimateScrollScope, int i, int i2, Continuation<? super Unit> continuation) {
        Object scroll = lazyAnimateScrollScope.scroll(new LazyAnimateScrollKt$animateScrollToItem$2(i, lazyAnimateScrollScope, i2, (Continuation<? super LazyAnimateScrollKt$animateScrollToItem$2>) null), continuation);
