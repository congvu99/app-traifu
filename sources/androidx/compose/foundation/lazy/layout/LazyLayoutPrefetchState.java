...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle m795schedulePrefetch0kLqBqw(int i, long j);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0006, code lost:
        r2 = r0.m795schedulePrefetch0kLqBqw(r2, r3);
     */
    /* renamed from: schedulePrefetch-0kLqBqw  reason: not valid java name */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState.PrefetchHandle m794schedulePrefetch0kLqBqw(int r2, long r3) {
        /*
            r1 = this;
            androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState$Prefetcher r0 = r1.getPrefetcher$foundation_release()
            if (r0 == 0) goto L_0x000c
            androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState$PrefetchHandle r2 = r0.m795schedulePrefetch0kLqBqw(r2, r3)
            if (r2 != 0) goto L_0x0010
        L_0x000c:
            androidx.compose.foundation.lazy.layout.DummyHandle r2 = androidx.compose.foundation.lazy.layout.DummyHandle.INSTANCE
            androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState$PrefetchHandle r2 = (androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState.PrefetchHandle) r2
        L_0x0010:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState.m794schedulePrefetch0kLqBqw(int, long):androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState$PrefetchHandle");
    }
}
