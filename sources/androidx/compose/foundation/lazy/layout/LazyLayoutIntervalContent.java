...
public interface LazyLayoutIntervalContent {
    ...
    public final /* synthetic */ class CC {
        public static Function1 $default$getKey(LazyLayoutIntervalContent lazyLayoutIntervalContent) {
            return null;
        }

        public static Function1 $default$getType(LazyLayoutIntervalContent _this) {
