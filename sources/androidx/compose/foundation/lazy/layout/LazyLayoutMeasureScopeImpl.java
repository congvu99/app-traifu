...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int m782roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.m4642roundToPxR2X_6o(j);
    }

    /* renamed from: roundToPx-0680j_4  reason: not valid java name */
    public int m783roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.m4643roundToPx0680j_4(f);
    }

    /* renamed from: toPx--R2X_6o  reason: not valid java name */
    public float m788toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.m4648toPxR2X_6o(j);
    }

    /* renamed from: toPx-0680j_4  reason: not valid java name */
    public float m789toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.m4649toPx0680j_4(f);
    }
    ...
    public List<Placeable> m781measure0kLqBqw(int i, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(subcompose.get(i2).m3649measureBRTryo0(j));
        }
    ...
    public float m784toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.m4644toDpGaN1DYA(j);
    }

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    public float m786toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.m4646toDpu2uoSUM(i);
    }

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    public float m785toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.m4645toDpu2uoSUM(f);
    }

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long m792toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.m4652toSpkPz2Gy4(f);
    }

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long m793toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.m4653toSpkPz2Gy4(i);
    }

    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    public long m791toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.m4651toSp0xMU5do(f);
    }

    /* renamed from: toSize-XkaWNTQ  reason: not valid java name */
    public long m790toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.m4650toSizeXkaWNTQ(j);
    }

    /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
    public long m787toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.m4647toDpSizekrfVVM(j);
    }
}
