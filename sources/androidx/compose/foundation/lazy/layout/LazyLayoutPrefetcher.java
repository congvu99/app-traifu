...
public final class LazyLayoutPrefetcher implements RememberObserver, LazyLayoutPrefetchState.Prefetcher, Runnable, Choreographer.FrameCallback {
                        ...
                        try {
                            ...
                            if (enoughTimeLeft(nanoTime2, nanos, this.averagePremeasureTimeNs)) {
                                ...
                                for (int i = 0; i < placeablesCount; i++) {
                                    precomposeHandle.m3726premeasure0kLqBqw(i, prefetchRequest.m797getConstraintsmsEJaDk());
                                }
    ...
    public LazyLayoutPrefetchState.PrefetchHandle m796schedulePrefetch0kLqBqw(int i, long j) {
    ...
    private static final class PrefetchRequest implements LazyLayoutPrefetchState.PrefetchHandle {
        ...
        public final long m797getConstraintsmsEJaDk() {
    ...
    public static final class Companion {
        ...
        public final void calculateFrameIntervalIfNeeded(View view) {
            if (LazyLayoutPrefetcher.frameIntervalNs == 0) {
                ...
                LazyLayoutPrefetcher.frameIntervalNs = (long) (((float) Http2Connection.DEGRADED_PONG_TIMEOUT_NS) / f);
            }
        }
    }
}
