...
public interface LazyLayoutMeasureScope extends MeasureScope {
    ...
    List<Placeable> m764measure0kLqBqw(int i, long j);

    /* renamed from: toDp-GaN1DYA  reason: not valid java name */
    float m765toDpGaN1DYA(long j);

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    float m766toDpu2uoSUM(float f);

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    float m767toDpu2uoSUM(int i);

    /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
    long m768toDpSizekrfVVM(long j);

    /* renamed from: toSize-XkaWNTQ  reason: not valid java name */
    long m769toSizeXkaWNTQ(long j);

    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    long m770toSp0xMU5do(float f);

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    long m771toSpkPz2Gy4(float f);

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    long m772toSpkPz2Gy4(int i);
    ...
    public final /* synthetic */ class CC {
        ...
        public static float m773$default$toDpGaN1DYA(LazyLayoutMeasureScope _this, long j) {
        ...
        public static float m775$default$toDpu2uoSUM(LazyLayoutMeasureScope _this, int i) {
            return Dp.m4704constructorimpl(((float) i) / _this.getDensity());
        }

        /* renamed from: $default$toDp-u2uoSUM  reason: not valid java name */
        public static float m774$default$toDpu2uoSUM(LazyLayoutMeasureScope _this, float f) {
            return Dp.m4704constructorimpl(f / _this.getDensity());
        }

        /* renamed from: $default$toSp-kPz2Gy4  reason: not valid java name */
        public static long m779$default$toSpkPz2Gy4(LazyLayoutMeasureScope _this, float f) {
            return TextUnitKt.getSp(f / (_this.getFontScale() * _this.getDensity()));
        }

        /* renamed from: $default$toSp-kPz2Gy4  reason: not valid java name */
        public static long m780$default$toSpkPz2Gy4(LazyLayoutMeasureScope _this, int i) {
        ...
        public static long m778$default$toSp0xMU5do(LazyLayoutMeasureScope _this, float f) {
            return TextUnitKt.getSp(f / _this.getFontScale());
        }

        /* renamed from: $default$toSize-XkaWNTQ  reason: not valid java name */
        public static long m777$default$toSizeXkaWNTQ(LazyLayoutMeasureScope _this, long j) {
        ...
        public static long m776$default$toDpSizekrfVVM(LazyLayoutMeasureScope _this, long j) {
            if (j != Size.Companion.m1760getUnspecifiedNHjbRc()) {
                return DpKt.m4726DpSizeYgX7TsA(_this.m766toDpu2uoSUM(Size.m1752getWidthimpl(j)), _this.m766toDpu2uoSUM(Size.m1749getHeightimpl(j)));
            }
