...
public final class MagnifierKt {
    ...
    public static final Modifier magnifier(Modifier modifier, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, float f, MagnifierStyle magnifierStyle, Function1<? super DpSize, Unit> function13, PlatformMagnifierFactory platformMagnifierFactory) {
    ...
    public static final Modifier magnifier(Modifier modifier, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, float f, MagnifierStyle magnifierStyle, Function1<? super DpSize, Unit> function13) {
        Modifier modifier2;
        Intrinsics.checkNotNullParameter(modifier, "<this>");
        Intrinsics.checkNotNullParameter(function1, "sourceCenter");
        Intrinsics.checkNotNullParameter(function12, "magnifierCenter");
        ...
        if (isPlatformMagnifierSupported$default(0, 1, (Object) null)) {
            modifier2 = magnifier(modifier3, function1, function12, f, magnifierStyle, function13, PlatformMagnifierFactory.Companion.getForCurrentPlatform());
        } else {
