...
final class ImageKt$Image$2 implements MeasurePolicy {
    ...
    public final MeasureResult m227measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        return MeasureScope.CC.layout$default(measureScope, Constraints.m4626getMinWidthimpl(j), Constraints.m4625getMinHeightimpl(j), (Map) null, ImageKt$Image$2$measure$1.INSTANCE, 4, (Object) null);
    }
}
