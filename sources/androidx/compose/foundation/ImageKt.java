...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap imageBitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        m226Image5hnEew(imageBitmap, str, modifier2, center, fit, f2, colorFilter2, FilterQuality.Companion.m2018getLowfv9h1I(), composer, (i3 & 112) | 8 | (i3 & 896) | (i3 & 7168) | (57344 & i3) | (458752 & i3) | (i3 & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m226Image5hnEew(ImageBitmap imageBitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, int i2, int i3) {
        ImageBitmap imageBitmap2 = imageBitmap;
        Composer composer2 = composer;
        int i4 = i2;
        int i5 = i3;
        ...
        int r5 = (i5 & 128) != 0 ? DrawScope.Companion.m2518getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BitmapPainterKt.m2607BitmapPainterQZhYCtY$default(imageBitmap, 0, 0, r5, 6, (Object) null);
            composer2.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        Image((Painter) (BitmapPainter) rememberedValue, str, modifier2, center, fit, f2, colorFilter2, composer, (i4 & 112) | 8 | (i4 & 896) | (i4 & 7168) | (57344 & i4) | (458752 & i4) | (3670016 & i4), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final void Image(Painter painter, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        MeasurePolicy measurePolicy = ImageKt$Image$2.INSTANCE;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new ImageKt$Image$3(painter, str, modifier3, center, fit, f2, colorFilter2, i, i2));
        }
    }
}
