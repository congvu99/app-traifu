...
public final class Arrangement {
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m425getSpacingD9Ej5fM(Horizontal horizontal) {
                return CC.m423$default$getSpacingD9Ej5fM(horizontal);
            }
        }
        ...
        public final /* synthetic */ class CC {
            ...
            public static float m423$default$getSpacingD9Ej5fM(Horizontal _this) {
                return Dp.m4704constructorimpl((float) 0);
            }
        }
    }
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m443getSpacingD9Ej5fM(Vertical vertical) {
                return CC.m441$default$getSpacingD9Ej5fM(vertical);
            }
        }
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m441$default$getSpacingD9Ej5fM(Vertical _this) {
                return Dp.m4704constructorimpl((float) 0);
            }
        }
    }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m429getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
                return CC.m427$default$getSpacingD9Ej5fM(horizontalOrVertical);
            }
        }
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m427$default$getSpacingD9Ej5fM(HorizontalOrVertical _this) {
                return Dp.m4704constructorimpl((float) 0);
            }
        }
    }
    ...
    public final HorizontalOrVertical m407spacedBy0680j_4(float f) {
    ...
    public final Horizontal m408spacedByD5KLDUw(float f, Alignment.Horizontal horizontal) {
    ...
    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Vertical m409spacedByD5KLDUw(float f, Alignment.Vertical vertical) {
    ...
    public final Horizontal aligned(Alignment.Horizontal horizontal) {
        Intrinsics.checkNotNullParameter(horizontal, "alignment");
        return new SpacedAligned(Dp.m4704constructorimpl((float) 0), true, new Arrangement$aligned$1(horizontal), (DefaultConstructorMarker) null);
    }

    public final Vertical aligned(Alignment.Vertical vertical) {
        Intrinsics.checkNotNullParameter(vertical, "alignment");
        return new SpacedAligned(Dp.m4704constructorimpl((float) 0), false, new Arrangement$aligned$2(vertical), (DefaultConstructorMarker) null);
    }
    ...
    public static final class Absolute {
        ...
        public final Horizontal aligned(Alignment.Horizontal horizontal) {
            Intrinsics.checkNotNullParameter(horizontal, "alignment");
            return new SpacedAligned(Dp.m4704constructorimpl((float) 0), false, new Arrangement$Absolute$aligned$1(horizontal), (DefaultConstructorMarker) null);
        }
    }
    ...
    public static final class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m433copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2<Integer, LayoutDirection, Integer> function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m435copy8Feqmps(f, z, function2);
        }

        /* renamed from: component1-D9Ej5fM  reason: not valid java name */
        public final float m434component1D9Ej5fM() {
            return this.space;
        }
        ...
        public final SpacedAligned m435copy8Feqmps(float f, boolean z, Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
        ...
        public boolean equals(Object obj) {
            ...
            return Dp.m4709equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual((Object) this.alignment, (Object) spacedAligned.alignment);
        }

        public int hashCode() {
            int r0 = Dp.m4710hashCodeimpl(this.space) * 31;
        ...
        public final float m436getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density density, int i, int[] iArr, LayoutDirection layoutDirection, int[] iArr2) {
            ...
            if (!(iArr.length == 0)) {
                int r10 = density.m4643roundToPx0680j_4(this.space);
                ...
                if (!z) {
                    ...
                    while (i4 < length) {
                        ...
                        int min = Math.min(r10, (i - iArr2[i5]) - i6);
                        int i7 = iArr2[i5] + i6 + min;
                        i4++;
                        i5++;
                        int i8 = i7;
                        i2 = min;
                    ...
                    for (int length2 = iArr.length - 1; -1 < length2; length2--) {
                        ...
                        iArr2[length2] = Math.min(i3, i - i11);
                        i10 = Math.min(r10, (i - iArr2[length2]) - i11);
        ...
        public String toString() {
            ...
            sb.append(Dp.m4715toStringimpl(this.space));
            sb.append(", ");
