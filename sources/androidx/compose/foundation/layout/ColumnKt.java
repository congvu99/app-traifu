...
public final class ColumnKt {
    ...
    public static final void Column(Modifier modifier, Arrangement.Vertical vertical, Alignment.Horizontal horizontal, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, int i, int i2) {
        ...
        Updater.m1550setimpl(r1, columnMeasurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
    ...
    static {
        ...
        float r1 = Arrangement.INSTANCE.getTop().m440getSpacingD9Ej5fM();
        ...
        DefaultColumnMeasurePolicy = RowColumnImplKt.m553rowColumnMeasurePolicyTDGSqEk(layoutOrientation, ColumnKt$DefaultColumnMeasurePolicy$1.INSTANCE, r1, SizeMode.Wrap, horizontal$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy columnMeasurePolicy(Arrangement.Vertical vertical, Alignment.Horizontal horizontal, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(columnMeasurePolicy)P(1)101@4710L664:Column.kt#2w3rfo");
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            if (!Intrinsics.areEqual((Object) vertical, (Object) Arrangement.INSTANCE.getTop()) || !Intrinsics.areEqual((Object) horizontal, (Object) Alignment.Companion.getStart())) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Vertical;
                float r0 = vertical.m440getSpacingD9Ej5fM();
                ...
                measurePolicy = RowColumnImplKt.m553rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new ColumnKt$columnMeasurePolicy$1$1(vertical), r0, SizeMode.Wrap, horizontal$foundation_layout_release);
            } else {
