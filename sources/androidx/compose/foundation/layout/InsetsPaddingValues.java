...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float m479calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, ViewProps.LAYOUT_DIRECTION);
        Density density2 = this.density;
        return density2.m4646toDpu2uoSUM(this.insets.getLeft(density2, layoutDirection));
    }

    /* renamed from: calculateTopPadding-D9Ej5fM  reason: not valid java name */
    public float m481calculateTopPaddingD9Ej5fM() {
        Density density2 = this.density;
        return density2.m4646toDpu2uoSUM(this.insets.getTop(density2));
    }

    /* renamed from: calculateRightPadding-u2uoSUM  reason: not valid java name */
    public float m480calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, ViewProps.LAYOUT_DIRECTION);
        Density density2 = this.density;
        return density2.m4646toDpu2uoSUM(this.insets.getRight(density2, layoutDirection));
    }

    /* renamed from: calculateBottomPadding-D9Ej5fM  reason: not valid java name */
    public float m478calculateBottomPaddingD9Ej5fM() {
        Density density2 = this.density;
        return density2.m4646toDpu2uoSUM(this.insets.getBottom(density2));
    }
