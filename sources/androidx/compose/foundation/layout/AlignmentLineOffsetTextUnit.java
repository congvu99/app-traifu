...
final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    public final long m395getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m394getAfterXSAIIZE() {
        return this.after;
    }
    ...
    public MeasureResult m396measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return AlignmentLineKt.m382alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m4903isUnspecifiedR2X_6o(this.before) ? measureScope.m4644toDpGaN1DYA(this.before) : Dp.Companion.m4724getUnspecifiedD9Ej5fM(), !TextUnitKt.m4903isUnspecifiedR2X_6o(this.after) ? measureScope.m4644toDpGaN1DYA(this.after) : Dp.Companion.m4724getUnspecifiedD9Ej5fM(), measurable, j);
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m4886hashCodeimpl(this.before)) * 31) + TextUnit.m4886hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (alignmentLineOffsetTextUnit != null && Intrinsics.areEqual((Object) this.alignmentLine, (Object) alignmentLineOffsetTextUnit.alignmentLine) && TextUnit.m4882equalsimpl0(this.before, alignmentLineOffsetTextUnit.before) && TextUnit.m4882equalsimpl0(this.after, alignmentLineOffsetTextUnit.after)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + TextUnit.m4892toStringimpl(this.before) + ", after=" + TextUnit.m4892toStringimpl(this.after) + ')';
    }
}
