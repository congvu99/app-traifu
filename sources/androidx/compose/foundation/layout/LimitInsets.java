...
final class LimitInsets implements WindowInsets {
    ...
    public final int m485getSidesJoeWqyM() {
        return this.sides;
    }
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            i = WindowInsetsSides.Companion.m621getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            i = WindowInsetsSides.Companion.m622getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m614hasAnybkgdKaI$foundation_layout_release(this.sides, i)) {
    ...
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m614hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m631getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        ...
        Intrinsics.checkNotNullParameter(layoutDirection, ViewProps.LAYOUT_DIRECTION);
        if (layoutDirection == LayoutDirection.Ltr) {
            i = WindowInsetsSides.Companion.m623getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            i = WindowInsetsSides.Companion.m624getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m614hasAnybkgdKaI$foundation_layout_release(this.sides, i)) {
    ...
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m614hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m625getBottomJoeWqyM())) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.insets, (Object) limitInsets.insets) || !WindowInsetsSides.m613equalsimpl0(this.sides, limitInsets.sides)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (this.insets.hashCode() * 31) + WindowInsetsSides.m615hashCodeimpl(this.sides);
    }

    public String toString() {
        return '(' + this.insets + " only " + WindowInsetsSides.m617toStringimpl(this.sides) + ')';
    }
}
