...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.m4643roundToPx0680j_4(this.leftDp);
    }

    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m4643roundToPx0680j_4(this.topDp);
    }

    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, ViewProps.LAYOUT_DIRECTION);
        return density.m4643roundToPx0680j_4(this.rightDp);
    }

    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m4643roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + Dp.m4715toStringimpl(this.leftDp) + ", top=" + Dp.m4715toStringimpl(this.topDp) + ", right=" + Dp.m4715toStringimpl(this.rightDp) + ", bottom=" + Dp.m4715toStringimpl(this.bottomDp) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Dp.m4709equalsimpl0(this.leftDp, fixedDpInsets.leftDp) || !Dp.m4709equalsimpl0(this.topDp, fixedDpInsets.topDp) || !Dp.m4709equalsimpl0(this.rightDp, fixedDpInsets.rightDp) || !Dp.m4709equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((Dp.m4710hashCodeimpl(this.leftDp) * 31) + Dp.m4710hashCodeimpl(this.topDp)) * 31) + Dp.m4710hashCodeimpl(this.rightDp)) * 31) + Dp.m4710hashCodeimpl(this.bottomDp);
    }
}
