...
public final class SizeKt$requiredSizeInqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(ViewProps.MIN_WIDTH, Dp.m4702boximpl(this.$minWidth$inlined));
        inspectorInfo.getProperties().set(ViewProps.MIN_HEIGHT, Dp.m4702boximpl(this.$minHeight$inlined));
        inspectorInfo.getProperties().set(ViewProps.MAX_WIDTH, Dp.m4702boximpl(this.$maxWidth$inlined));
        inspectorInfo.getProperties().set(ViewProps.MAX_HEIGHT, Dp.m4702boximpl(this.$maxHeight$inlined));
    }
}
