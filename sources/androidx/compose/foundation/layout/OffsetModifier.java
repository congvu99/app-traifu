...
final class OffsetModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult m500measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable r9 = measurable.m3649measureBRTryo0(j);
        return MeasureScope.CC.layout$default(measureScope, r9.getWidth(), r9.getHeight(), (Map) null, new OffsetModifier$measure$1(this, r9, measureScope), 4, (Object) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (offsetModifier != null && Dp.m4709equalsimpl0(this.x, offsetModifier.x) && Dp.m4709equalsimpl0(this.y, offsetModifier.y) && this.rtlAware == offsetModifier.rtlAware) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Dp.m4710hashCodeimpl(this.x) * 31) + Dp.m4710hashCodeimpl(this.y)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifier(x=" + Dp.m4715toStringimpl(this.x) + ", y=" + Dp.m4715toStringimpl(this.y) + ", rtlAware=" + this.rtlAware + ')';
    }
}
