...
public final class RowKt {
    ...
    static {
        ...
        float r1 = Arrangement.INSTANCE.getStart().m422getSpacingD9Ej5fM();
        ...
        DefaultRowMeasurePolicy = RowColumnImplKt.m553rowColumnMeasurePolicyTDGSqEk(layoutOrientation, RowKt$DefaultRowMeasurePolicy$1.INSTANCE, r1, SizeMode.Wrap, vertical$foundation_layout_release);
    }
    ...
    public static final MeasurePolicy rowMeasurePolicy(Arrangement.Horizontal horizontal, Alignment.Vertical vertical, Composer composer, int i) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            if (!Intrinsics.areEqual((Object) horizontal, (Object) Arrangement.INSTANCE.getStart()) || !Intrinsics.areEqual((Object) vertical, (Object) Alignment.Companion.getTop())) {
                LayoutOrientation layoutOrientation = LayoutOrientation.Horizontal;
                float r0 = horizontal.m422getSpacingD9Ej5fM();
                ...
                measurePolicy = RowColumnImplKt.m553rowColumnMeasurePolicyTDGSqEk(layoutOrientation, new RowKt$rowMeasurePolicy$1$1(horizontal), r0, SizeMode.Wrap, vertical$foundation_layout_release);
            } else {
