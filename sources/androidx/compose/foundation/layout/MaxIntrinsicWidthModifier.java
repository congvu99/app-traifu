...
final class MaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public /* synthetic */ MeasureResult m489measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
    ...
    public long m488calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m4634fixedWidthOenEA2s(measurable.maxIntrinsicWidth(Constraints.m4623getMaxHeightimpl(j)));
    }
