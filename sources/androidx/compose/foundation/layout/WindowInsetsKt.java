...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m602onlybOOhFvg(WindowInsets windowInsets, int i) {
    ...
    public static final PaddingValues asPaddingValues(WindowInsets windowInsets, Composer composer, int i) {
        Intrinsics.checkNotNullParameter(windowInsets, "<this>");
        ComposerKt.sourceInformationMarkerStart(composer, -1485016250, "C(asPaddingValues)242@9135L7:WindowInsets.kt#2w3rfo");
    ...
    public static final WindowInsets m600WindowInsetsa9UjIt4(float f, float f2, float f3, float f4) {
    ...
    public static /* synthetic */ WindowInsets m601WindowInsetsa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m600WindowInsetsa9UjIt4(f, f2, f3, f4);
    }
}
