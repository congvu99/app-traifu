...
public final class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long j, LayoutOrientation layoutOrientation) {
        this(layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4626getMinWidthimpl(j) : Constraints.m4625getMinHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4624getMaxWidthimpl(j) : Constraints.m4623getMaxHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4625getMinHeightimpl(j) : Constraints.m4626getMinWidthimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4623getMaxHeightimpl(j) : Constraints.m4624getMaxWidthimpl(j));
    }
    ...
    public final OrientationIndependentConstraints stretchCrossAxis() {
        ...
        if (i3 == Integer.MAX_VALUE) {
            i3 = this.crossAxisMin;
        }
        return new OrientationIndependentConstraints(i, i2, i3, this.crossAxisMax);
    }

    /* renamed from: toBoxConstraints-OenEA2s  reason: not valid java name */
    public final long m502toBoxConstraintsOenEA2s(LayoutOrientation layoutOrientation) {
