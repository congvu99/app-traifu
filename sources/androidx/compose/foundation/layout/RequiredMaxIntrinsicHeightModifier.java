...
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public /* synthetic */ MeasureResult m546measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
    ...
    public long m545calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m4633fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m4624getMaxWidthimpl(j)));
    }
