...
public final class SideCalculator$Companion$LeftSideCalculator$1 implements SideCalculator {
    ...
    public long m560consumedOffsetsMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1683getXimpl(j), 0.0f);
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m561consumedVelocityQWom1Mo(long j, float f) {
        return VelocityKt.Velocity(Velocity.m4929getXimpl(j) - f, 0.0f);
    }
}
