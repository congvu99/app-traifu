...
public final class RowColumnImplKt {
    ...
    public static final MeasurePolicy m553rowColumnMeasurePolicyTDGSqEk(LayoutOrientation layoutOrientation, Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, float f, SizeMode sizeMode, CrossAxisAlignment crossAxisAlignment) {
