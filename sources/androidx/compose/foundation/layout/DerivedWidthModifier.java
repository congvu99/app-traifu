...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult m471measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (intValue == 0) {
            return MeasureScope.CC.layout$default(measureScope, 0, 0, (Map) null, DerivedWidthModifier$measure$1.INSTANCE, 4, (Object) null);
        }
        Placeable r11 = measurable.m3649measureBRTryo0(Constraints.m4615copyZbe2FdA$default(j, intValue, intValue, 0, 0, 12, (Object) null));
        return MeasureScope.CC.layout$default(measureScope, intValue, r11.getHeight(), (Map) null, new DerivedWidthModifier$measure$2(r11), 4, (Object) null);
    }
