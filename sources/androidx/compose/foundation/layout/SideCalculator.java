...
interface SideCalculator {
    ...
    long m555consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long m556consumedVelocityQWom1Mo(long j, float f);
    ...
    public final /* synthetic */ class CC {
        public static float $default$showMotion(SideCalculator _this, float f, float f2) {
            return RangesKt.coerceAtLeast(_this.motionOf(f, f2), 0.0f);
        }

        public static float $default$hideMotion(SideCalculator _this, float f, float f2) {
    ...
    public static final class Companion {
        ...
        public final SideCalculator m557chooseCalculatorni1skBw(int i, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, ViewProps.LAYOUT_DIRECTION);
            if (WindowInsetsSides.m613equalsimpl0(i, WindowInsetsSides.Companion.m628getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m613equalsimpl0(i, WindowInsetsSides.Companion.m631getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m613equalsimpl0(i, WindowInsetsSides.Companion.m629getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m613equalsimpl0(i, WindowInsetsSides.Companion.m625getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m613equalsimpl0(i, WindowInsetsSides.Companion.m630getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (!WindowInsetsSides.m613equalsimpl0(i, WindowInsetsSides.Companion.m626getEndJoeWqyM())) {
