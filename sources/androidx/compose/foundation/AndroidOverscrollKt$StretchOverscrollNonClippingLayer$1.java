...
final class AndroidOverscrollKt$StretchOverscrollNonClippingLayer$1 extends Lambda implements Function3<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
        return m174invoke3p2s80s((MeasureScope) obj, (Measurable) obj2, ((Constraints) obj3).m4630unboximpl());
    }

    /* renamed from: invoke-3p2s80s  reason: not valid java name */
    public final MeasureResult m174invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$layout");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable r9 = measurable.m3649measureBRTryo0(j);
        final int r10 = measureScope.m4643roundToPx0680j_4(Dp.m4704constructorimpl(ClipScrollableContainerKt.getMaxSupportedElevation() * ((float) 2)));
        return MeasureScope.CC.layout$default(measureScope, r9.getMeasuredWidth() - r10, r9.getMeasuredHeight() - r10, (Map) null, new Function1<Placeable.PlacementScope, Unit>() {
