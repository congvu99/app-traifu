...
final class GlowEdgeEffectCompat extends EdgeEffect {
    ...
    public GlowEdgeEffectCompat(Context context) {
        ...
        this.oppositeReleaseDeltaThreshold = AndroidDensity_androidKt.Density(context).m4649toPx0680j_4(Dp.m4704constructorimpl((float) 1));
    }
