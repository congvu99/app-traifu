...
public class Debug {
    ...
    public static void printStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            printStream.println(str + str2 + (".(" + stackTrace[i2].getFileName() + CertificateUtil.DELIMITER + stackTrace[i2].getLineNumber() + ") ") + str2);
        }
    }
        ...
        for (Field field : fields) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint")) {
                    if (!(obj2 instanceof Integer) || !obj2.toString().equals(CreateTicketViewModelKt.EmailId)) {
            ...
            for (Field field : fields) {
                try {
                    ...
                    if (field.getName().contains("To")) {
                        if (!obj.toString().equals(CreateTicketViewModelKt.EmailId)) {
