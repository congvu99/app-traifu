...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        ...
        sb.append(str + " ===== " + this.mType + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
        sb.append(str);
        ...
        String str2 = sb.toString() + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        if (this.mNumberOfStages > 1) {
            str2 = str2 + str + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (this.mNumberOfStages > 2) {
            str2 = str2 + str + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
