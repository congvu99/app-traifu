...
public final class ForegroundInfo {
    ...
    public String toString() {
        return "ForegroundInfo{" + "mNotificationId=" + this.mNotificationId + ", mForegroundServiceType=" + this.mForegroundServiceType + ", mNotification=" + this.mNotification + JsonLexerKt.END_OBJ;
    }
}
