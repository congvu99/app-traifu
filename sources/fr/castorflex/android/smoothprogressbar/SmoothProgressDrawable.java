...
public class SmoothProgressDrawable extends Drawable implements Animatable {
        ...
        this.mUpdater = new Runnable() {
            public void run() {
                if (SmoothProgressDrawable.this.isFinishing()) {
                    ...
                    float unused = smoothProgressDrawable.mFinishingOffset = smoothProgressDrawable.mFinishingOffset + (SmoothProgressDrawable.this.mProgressiveStopSpeed * 0.01f);
                    SmoothProgressDrawable smoothProgressDrawable2 = SmoothProgressDrawable.this;
                    float unused2 = smoothProgressDrawable2.mCurrentOffset = smoothProgressDrawable2.mCurrentOffset + (SmoothProgressDrawable.this.mProgressiveStopSpeed * 0.01f);
                    ...
                    float unused3 = smoothProgressDrawable3.mCurrentOffset = smoothProgressDrawable3.mCurrentOffset + (SmoothProgressDrawable.this.mProgressiveStartSpeed * 0.01f);
                } else {
                    SmoothProgressDrawable smoothProgressDrawable4 = SmoothProgressDrawable.this;
                    float unused4 = smoothProgressDrawable4.mCurrentOffset = smoothProgressDrawable4.mCurrentOffset + (SmoothProgressDrawable.this.mSpeed * 0.01f);
                }
                if (SmoothProgressDrawable.this.mCurrentOffset >= SmoothProgressDrawable.this.mMaxOffset) {
                    boolean unused5 = SmoothProgressDrawable.this.mNewTurn = true;
                    SmoothProgressDrawable smoothProgressDrawable5 = SmoothProgressDrawable.this;
                    float unused6 = smoothProgressDrawable5.mCurrentOffset = smoothProgressDrawable5.mCurrentOffset - SmoothProgressDrawable.this.mMaxOffset;
                }
    ...
    private void drawGradient(Canvas canvas) {
        ...
        this.mPaint.setShader(new LinearGradient((float) ((!this.mReversed || !this.mMirrorMode) ? this.mBounds.left : Math.abs(this.mBounds.left - this.mBounds.right) / 2), ((float) this.mBounds.centerY()) - (this.mStrokeWidth / 2.0f), (float) (this.mMirrorMode ? this.mReversed ? this.mBounds.left : Math.abs(this.mBounds.left - this.mBounds.right) / 2 : this.mBounds.right), (this.mStrokeWidth / 2.0f) + ((float) this.mBounds.centerY()), this.mLinearGradientColors, this.mLinearGradientPositions, this.mMirrorMode ? Shader.TileMode.MIRROR : Shader.TileMode.CLAMP));
    }
    ...
    private void drawStrokes(android.graphics.Canvas r24) {
        ...
        L_0x0110:
            r10 = r4
            r13 = r7
            r8.drawBackgroundIfNeeded(r9, r13, r10)
            return
        */
    ...
    public static class Builder {
        ...
        private void initValues(Context context, boolean z) {
            ...
            if (!z) {
                ...
                this.mStrokeWidth = (float) resources.getDimensionPixelOffset(R.dimen.spb_default_stroke_width);
            } else {
