...
public class PinchGestureHandler extends GestureHandler<PinchGestureHandler> {
    private ScaleGestureDetector.OnScaleGestureListener mGestureListener = new ScaleGestureDetector.OnScaleGestureListener() {
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            double unused = pinchGestureHandler.mLastScaleFactor = pinchGestureHandler.mLastScaleFactor * ((double) scaleGestureDetector.getScaleFactor());
            long timeDelta = scaleGestureDetector.getTimeDelta();
            if (timeDelta > 0) {
                PinchGestureHandler pinchGestureHandler2 = PinchGestureHandler.this;
                double unused2 = pinchGestureHandler2.mLastVelocity = (pinchGestureHandler2.mLastScaleFactor - access$000) / ((double) timeDelta);
            }
