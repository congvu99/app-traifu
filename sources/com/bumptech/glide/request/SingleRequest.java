...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r10, R r11, com.bumptech.glide.load.DataSource r12, boolean r13) {
        ...
        L_0x006b:
            ...
            r6 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00bd }
            if (r0 == 0) goto L_0x0093
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00bd }
            java.util.Iterator r7 = r0.iterator()     // Catch:{ all -> 0x00bd }
            r8 = 0
        L_0x007a:
            boolean r0 = r7.hasNext()     // Catch:{ all -> 0x00bd }
            if (r0 == 0) goto L_0x0094
            java.lang.Object r0 = r7.next()     // Catch:{ all -> 0x00bd }
            com.bumptech.glide.request.RequestListener r0 = (com.bumptech.glide.request.RequestListener) r0     // Catch:{ all -> 0x00bd }
            java.lang.Object r2 = r9.model     // Catch:{ all -> 0x00bd }
            com.bumptech.glide.request.target.Target<R> r3 = r9.target     // Catch:{ all -> 0x00bd }
            r1 = r11
            r4 = r12
            r5 = r13
            boolean r0 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch:{ all -> 0x00bd }
            r8 = r8 | r0
            goto L_0x007a
        L_0x0093:
            r8 = 0
        L_0x0094:
            com.bumptech.glide.request.RequestListener<R> r0 = r9.targetListener     // Catch:{ all -> 0x00bd }
        ...
        L_0x00a9:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r10 = r9.animationFactory     // Catch:{ all -> 0x00bd }
            com.bumptech.glide.request.transition.Transition r10 = r10.build(r12, r13)     // Catch:{ all -> 0x00bd }
            com.bumptech.glide.request.target.Target<R> r12 = r9.target     // Catch:{ all -> 0x00bd }
            r12.onResourceReady(r11, r10)     // Catch:{ all -> 0x00bd }
        L_0x00b7:
