...
public class RNCWebViewManager extends SimpleViewManager<WebView> {
        ...
        if (readableMap != null) {
            if (readableMap.hasKey("html")) {
                ...
                if (readableMap.hasKey(SDKConstants.PARAM_A2U_BODY)) {
                    String string2 = readableMap.getString(SDKConstants.PARAM_A2U_BODY);
                    try {
    ...
    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void receiveCommand(android.webkit.WebView r5, java.lang.String r6, com.facebook.react.bridge.ReadableArray r7) {
        /*
            r4 = this;
            int r0 = r6.hashCode()
            r1 = 1
            r2 = 0
            switch(r0) {
                case -1241591313: goto L_0x0073;
                case -948122918: goto L_0x0069;
                case -934641255: goto L_0x005f;
                case -759238347: goto L_0x0054;
                case -318289731: goto L_0x004a;
                case -265032709: goto L_0x003f;
                case 336631465: goto L_0x0035;
                case 903120263: goto L_0x002a;
                case 1280029577: goto L_0x0020;
                case 1490029383: goto L_0x0016;
                case 2104576510: goto L_0x000b;
        ...
        L_0x0035:
            ...
            goto L_0x007e
        L_0x003f:
            java.lang.String r0 = "clearFormData"
            boolean r0 = r6.equals(r0)
            if (r0 == 0) goto L_0x007d
            r0 = 8
            goto L_0x007e
        ...
        L_0x00a0:
            ...
            com.reactnativecommunity.webview.RNCWebViewManager$RNCWebView$ProgressChangedFilter r0 = r0.progressChangedFilter
        ...
        L_0x00b2:
            ...
            java.lang.String r6 = "Arguments for loading an url are null!"
            r5.<init>(r6)
            throw r5
        L_0x00ba:
            r0 = r5
            ...
            r0.evaluateJavascriptWithFallback(r1)
            goto L_0x010a
        L_0x00c5:
            r0 = r5
            com.reactnativecommunity.webview.RNCWebViewManager$RNCWebView r0 = (com.reactnativecommunity.webview.RNCWebViewManager.RNCWebView) r0     // Catch:{ JSONException -> 0x00f4 }
            org.json.JSONObject r1 = new org.json.JSONObject     // Catch:{ JSONException -> 0x00f4 }
            r1.<init>()     // Catch:{ JSONException -> 0x00f4 }
            java.lang.String r3 = "data"
            java.lang.String r2 = r7.getString(r2)     // Catch:{ JSONException -> 0x00f4 }
            r1.put(r3, r2)     // Catch:{ JSONException -> 0x00f4 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x00f4 }
            r2.<init>()     // Catch:{ JSONException -> 0x00f4 }
            java.lang.String r3 = "(function () {var event;var data = "
            r2.append(r3)     // Catch:{ JSONException -> 0x00f4 }
            java.lang.String r1 = r1.toString()     // Catch:{ JSONException -> 0x00f4 }
            r2.append(r1)     // Catch:{ JSONException -> 0x00f4 }
            java.lang.String r1 = ";try {event = new MessageEvent('message', data);} catch (e) {event = document.createEvent('MessageEvent');event.initMessageEvent('message', true, true, data.data, data.origin, data.lastEventId, data.source);}document.dispatchEvent(event);})();"
            r2.append(r1)     // Catch:{ JSONException -> 0x00f4 }
            java.lang.String r1 = r2.toString()     // Catch:{ JSONException -> 0x00f4 }
            r0.evaluateJavascriptWithFallback(r1)     // Catch:{ JSONException -> 0x00f4 }
            goto L_0x010a
        L_0x00f4:
            r5 = move-exception
        ...
        L_0x0107:
            r5.goBack()
        L_0x010a:
            super.receiveCommand(r5, (java.lang.String) r6, (com.facebook.react.bridge.ReadableArray) r7)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.reactnativecommunity.webview.RNCWebViewManager.receiveCommand(android.webkit.WebView, java.lang.String, com.facebook.react.bridge.ReadableArray):void");
    }
    ...
    protected static class RNCWebViewClient extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int i, String str, String str2) {
            ...
            if (str3 == null || !str2.equals(str3) || i != -1 || !str.equals("net::ERR_FAILED")) {
                ...
                createWebViewEvent.putDouble(OAuthConstants.CODE, (double) i);
