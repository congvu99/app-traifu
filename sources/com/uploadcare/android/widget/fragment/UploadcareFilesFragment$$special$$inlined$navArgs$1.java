...
public final class UploadcareFilesFragment$$special$$inlined$navArgs$1 extends Lambda implements Function0<Bundle> {
    final /* synthetic */ Fragment $this_navArgs;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public UploadcareFilesFragment$$special$$inlined$navArgs$1(Fragment fragment) {
        super(0);
