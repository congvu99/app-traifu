...
public final class SocialNetworksAdapter$$special$$inlined$sortBy$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(((SocialSource) t).getName(), ((SocialSource) t2).getName());
    }
}
