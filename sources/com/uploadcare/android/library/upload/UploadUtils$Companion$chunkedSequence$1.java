...
final class UploadUtils$Companion$chunkedSequence$1 extends Lambda implements Function0<byte[]> {
    final /* synthetic */ byte[] $buffer;
    final /* synthetic */ BufferedInputStream $input;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    UploadUtils$Companion$chunkedSequence$1(BufferedInputStream bufferedInputStream, byte[] bArr) {
        super(0);
