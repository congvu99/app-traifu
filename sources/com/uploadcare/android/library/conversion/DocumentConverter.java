...
public final class DocumentConverter extends Converter {
    ...
    public URI getConversionUri() {
        return Urls.Companion.apiConvertDocument();
    }

    /* access modifiers changed from: protected */
    public URI getConversionStatusUri(int i) {
        return Urls.Companion.apiConvertDocumentStatus(i);
    }
}
