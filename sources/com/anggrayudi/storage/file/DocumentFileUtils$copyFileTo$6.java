...
final class DocumentFileUtils$copyFileTo$6 extends Lambda implements Function2<InputStream, OutputStream, Unit> {
    ...
    DocumentFileUtils$copyFileTo$6(DocumentFile documentFile, DocumentFile documentFile2, boolean z, long j, FileCallback fileCallback) {
        super(2);
    ...
    public final void invoke(InputStream inputStream, OutputStream outputStream) {
        ...
        DocumentFileUtils.copyFileStream(this.$this_copyFileTo, inputStream, outputStream, this.$targetFile, this.$watchProgress, this.$reportInterval, false, this.$callback);
    }
}
