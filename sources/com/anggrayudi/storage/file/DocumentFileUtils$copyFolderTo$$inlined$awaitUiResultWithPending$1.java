...
@DebugMetadata(c = "com.anggrayudi.storage.file.DocumentFileUtils$copyFolderTo$$inlined$awaitUiResultWithPending$1", f = "DocumentFileExt.kt", i = {}, l = {58}, m = "invokeSuspend", n = {}, s = {})
...
public final class DocumentFileUtils$copyFolderTo$$inlined$awaitUiResultWithPending$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends FolderCallback.FileConflict>>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(cancellableContinuation, continuation, folderCallback, documentFile, arrayList);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                folderCallback.onContentConflict(documentFile, arrayList, new FolderCallback.FolderContentConflictAction(cancellableContinuation));
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final ArrayList arrayList = this.$conflictedFiles$inlined;
