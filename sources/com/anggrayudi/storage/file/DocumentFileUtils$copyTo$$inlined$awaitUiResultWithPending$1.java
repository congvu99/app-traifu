...
@DebugMetadata(c = "com.anggrayudi.storage.file.DocumentFileUtils$copyTo$$inlined$awaitUiResultWithPending$1", f = "DocumentFileExt.kt", i = {}, l = {58}, m = "invokeSuspend", n = {}, s = {})
...
public final class DocumentFileUtils$copyTo$$inlined$awaitUiResultWithPending$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends FolderCallback.FileConflict>>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(cancellableContinuation, continuation, multipleFileCallback, documentFile, list);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                multipleFileCallback.onContentConflict(documentFile, list, new FolderCallback.FolderContentConflictAction(cancellableContinuation));
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final DocumentFile documentFile = this.$writableTargetParentFolder$inlined;
            final List list = this.$conflictedFiles$inlined;
