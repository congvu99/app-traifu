...
@DebugMetadata(c = "com.anggrayudi.storage.file.DocumentFileUtils$copyFolderTo$$inlined$awaitUiResult$1", f = "DocumentFileExt.kt", i = {}, l = {58}, m = "invokeSuspend", n = {}, s = {})
...
public final class DocumentFileUtils$copyFolderTo$$inlined$awaitUiResult$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Long>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(cancellableContinuation, continuation, folderCallback, documentFile, intRef, thread);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                FolderCallback folderCallback = folderCallback;
                DocumentFile documentFile = documentFile;
                int i = intRef.element;
                Intrinsics.checkNotNullExpressionValue(thread, "thread");
                cancellableContinuation.resumeWith(Result.m5428constructorimpl(Boxing.boxLong(folderCallback.onStart(documentFile, i, thread))));
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final DocumentFile documentFile = this.$this_copyFolderTo$inlined;
            final Ref.IntRef intRef = this.$totalFilesToCopy$inlined;
