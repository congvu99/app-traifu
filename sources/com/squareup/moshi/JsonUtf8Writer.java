...
final class JsonUtf8Writer extends JsonWriter {
    ...
    public JsonWriter beginArray() throws IOException {
        if (!this.promoteValueToName) {
            writeDeferredName();
            return open(1, 2, JsonLexerKt.BEGIN_LIST);
        }
        throw new IllegalStateException("Array cannot be used as a map key in JSON at path " + getPath());
    }

    public JsonWriter endArray() throws IOException {
        return close(1, 2, JsonLexerKt.END_LIST);
    }

    public JsonWriter beginObject() throws IOException {
        if (!this.promoteValueToName) {
            writeDeferredName();
            return open(3, 5, JsonLexerKt.BEGIN_OBJ);
        }
    ...
    public JsonWriter endObject() throws IOException {
        ...
        return close(3, 5, JsonLexerKt.END_OBJ);
    }
    ...
    public JsonWriter nullValue() throws IOException {
        if (!this.promoteValueToName) {
            ...
            beforeValue();
            this.sink.writeUtf8(JsonLexerKt.NULL);
            int[] iArr = this.pathIndices;
            int i = this.stackSize - 1;
            iArr[i] = iArr[i] + 1;
            return this;
    ...
    public JsonWriter value(boolean z) throws IOException {
        if (!this.promoteValueToName) {
            writeDeferredName();
            beforeValue();
            this.sink.writeUtf8(z ? ServerProtocol.DIALOG_RETURN_SCOPES_TRUE : "false");
            int[] iArr = this.pathIndices;
            int i = this.stackSize - 1;
            iArr[i] = iArr[i] + 1;
            return this;
