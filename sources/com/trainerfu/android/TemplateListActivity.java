...
public class TemplateListActivity extends BaseActivity implements TemplateListFragment.EventListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        supportActionBar.setTitle((CharSequence) "Workout Templates");
        ...
        if (bundle == null) {
            ...
            getFragmentManager().beginTransaction().add(16908290, templateListFragment, "tlf").commit();
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final TemplateListFragment templateListFragment = (TemplateListFragment) getFragmentManager().findFragmentByTag("tlf");
        this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String str) {
                templateListFragment.searchPlanList(str);
                return false;
            }
        });
    ...
    private void styleSearchView(SearchView searchView2) {
        try {
            ...
            spannableStringBuilder.append(getString(R.string.searchWorkoutTemplates));
