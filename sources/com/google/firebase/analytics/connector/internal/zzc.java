...
public final class zzc {
    ...
    private static final List<String> zzc = Arrays.asList(new String[]{"auto", App.TYPE, "am"});
    ...
    public static AnalyticsConnector.ConditionalUserProperty zzh(Bundle bundle) {
        ...
        conditionalUserProperty.active = ((Boolean) zzgq.zzb(bundle, "active", Boolean.class, false)).booleanValue();
