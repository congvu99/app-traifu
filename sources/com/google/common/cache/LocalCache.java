...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        public V compute(K r17, int r18, java.util.function.BiFunction<? super K, ? super V, ? extends V> r19) {
            /*
                r16 = this;
                r7 = r16
                r0 = r17
                r8 = r18
                r16.lock()
                com.google.common.cache.LocalCache<K, V> r1 = r7.map     // Catch:{ all -> 0x00b7 }
                com.google.common.base.Ticker r1 = r1.ticker     // Catch:{ all -> 0x00b7 }
                long r1 = r1.read()     // Catch:{ all -> 0x00b7 }
                r7.preWriteCleanup(r1)     // Catch:{ all -> 0x00b7 }
                java.util.concurrent.atomic.AtomicReferenceArray<com.google.common.cache.ReferenceEntry<K, V>> r9 = r7.table     // Catch:{ all -> 0x00b7 }
                int r3 = r9.length()     // Catch:{ all -> 0x00b7 }
                r10 = 1
                int r3 = r3 - r10
                r11 = r8 & r3
                java.lang.Object r3 = r9.get(r11)     // Catch:{ all -> 0x00b7 }
                r12 = r3
                com.google.common.cache.ReferenceEntry r12 = (com.google.common.cache.ReferenceEntry) r12     // Catch:{ all -> 0x00b7 }
                r13 = r12
            L_0x0026:
                r14 = 0
                if (r13 == 0) goto L_0x006e
                java.lang.Object r3 = r13.getKey()     // Catch:{ all -> 0x00b7 }
                int r4 = r13.getHash()     // Catch:{ all -> 0x00b7 }
                if (r4 != r8) goto L_0x0069
                if (r3 == 0) goto L_0x0069
                com.google.common.cache.LocalCache<K, V> r4 = r7.map     // Catch:{ all -> 0x00b7 }
                com.google.common.base.Equivalence<java.lang.Object> r4 = r4.keyEquivalence     // Catch:{ all -> 0x00b7 }
                boolean r4 = r4.equivalent(r0, r3)     // Catch:{ all -> 0x00b7 }
                if (r4 == 0) goto L_0x0069
                com.google.common.cache.LocalCache$ValueReference r15 = r13.getValueReference()     // Catch:{ all -> 0x00b7 }
                com.google.common.cache.LocalCache<K, V> r4 = r7.map     // Catch:{ all -> 0x00b7 }
                boolean r1 = r4.isExpired(r13, r1)     // Catch:{ all -> 0x00b7 }
                if (r1 == 0) goto L_0x005d
                java.lang.Object r4 = r15.get()     // Catch:{ all -> 0x00b7 }
                int r5 = r15.getWeight()     // Catch:{ all -> 0x00b7 }
                com.google.common.cache.RemovalCause r6 = com.google.common.cache.RemovalCause.EXPIRED     // Catch:{ all -> 0x00b7 }
                r1 = r16
                r2 = r3
                r3 = r18
                r1.enqueueNotification(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x00b7 }
            L_0x005d:
                java.util.Queue<com.google.common.cache.ReferenceEntry<K, V>> r1 = r7.writeQueue     // Catch:{ all -> 0x00b7 }
                r1.remove(r13)     // Catch:{ all -> 0x00b7 }
                java.util.Queue<com.google.common.cache.ReferenceEntry<K, V>> r1 = r7.accessQueue     // Catch:{ all -> 0x00b7 }
                r1.remove(r13)     // Catch:{ all -> 0x00b7 }
                r1 = 0
                goto L_0x0070
            L_0x0069:
            ...
            L_0x006e:
                ...
                r1 = 1
            L_0x0070:
                com.google.common.cache.LocalCache$LoadingValueReference r2 = new com.google.common.cache.LocalCache$LoadingValueReference     // Catch:{ all -> 0x00b7 }
                r2.<init>(r15)     // Catch:{ all -> 0x00b7 }
                if (r13 != 0) goto L_0x0082
                com.google.common.cache.ReferenceEntry r13 = r7.newEntry(r0, r8, r12)     // Catch:{ all -> 0x00b7 }
                r13.setValueReference(r2)     // Catch:{ all -> 0x00b7 }
                r9.set(r11, r13)     // Catch:{ all -> 0x00b7 }
                goto L_0x0086
            L_0x0082:
                r13.setValueReference(r2)     // Catch:{ all -> 0x00b7 }
                r10 = r1
            L_0x0086:
                r1 = r19
                java.lang.Object r1 = r2.compute(r0, r1)     // Catch:{ all -> 0x00b7 }
                if (r1 == 0) goto L_0x00a5
                com.google.common.util.concurrent.ListenableFuture r1 = com.google.common.util.concurrent.Futures.immediateFuture(r1)     // Catch:{ ExecutionException -> 0x009d }
                java.lang.Object r0 = r7.getAndRecordStats(r0, r8, r2, r1)     // Catch:{ ExecutionException -> 0x009d }
                r16.unlock()
                r16.postWriteCleanup()
                return r0
            L_0x009d:
                java.lang.AssertionError r0 = new java.lang.AssertionError     // Catch:{ all -> 0x00b7 }
            ...
            L_0x00a5:
                ...
                r7.removeLoadingValue(r0, r8, r2)     // Catch:{ all -> 0x00b7 }
            L_0x00aa:
                r16.unlock()
                r16.postWriteCleanup()
                return r14
            L_0x00b1:
                com.google.common.cache.RemovalCause r0 = com.google.common.cache.RemovalCause.EXPLICIT     // Catch:{ all -> 0x00b7 }
                r7.removeEntry(r13, r8, r0)     // Catch:{ all -> 0x00b7 }
                goto L_0x00aa
            L_0x00b7:
                r0 = move-exception
                r16.unlock()
    ...
    public V computeIfAbsent(K k, java.util.function.Function<? super K, ? extends V> function) {
        ...
        return compute(k, new BiFunction(function, k) {
            public final /* synthetic */ java.util.function.Function f$0;
