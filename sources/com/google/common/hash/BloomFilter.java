...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public static <T> Collector<T, ?, BloomFilter<T>> toBloomFilter(Funnel<? super T> funnel2, long j, double d) {
        ...
        Preconditions.checkArgument(d > Utils.DOUBLE_EPSILON, "False positive probability (%s) must be > 0.0", (Object) Double.valueOf(d));
        ...
        }, $$Lambda$P_MmmwgZ0XwLgyONpS1egK2lhh4.INSTANCE, $$Lambda$BloomFilter$j8mscn2wdfq_052DogsIYVyRf94.INSTANCE, new Collector.Characteristics[]{Collector.Characteristics.UNORDERED, Collector.Characteristics.CONCURRENT});
    }
