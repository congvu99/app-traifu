...
public final class Maps {
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(java.util.function.Function<? super T, ? extends K> function, java.util.function.Function<? super T, ? extends V> function2) {
        ...
        return Collector.of($$Lambda$Maps$sa2evLlNzG4l0daqnB_BZ6Hpk.INSTANCE, new BiConsumer(function, function2) {
            ...
            public final /* synthetic */ java.util.function.Function f$1;
        ...
        }, $$Lambda$gr3P2nGL7W8VpcERw4klfzrPGXE.INSTANCE, $$Lambda$2o4X03rSa_8uE4aeQ0hIjzviXc.INSTANCE, new Collector.Characteristics[]{Collector.Characteristics.UNORDERED});
    }
    ...
    static String toStringImpl(Map<?, ?> map) {
        ...
        newStringBuilderForCollection.append(JsonLexerKt.BEGIN_OBJ);
        boolean z = true;
        for (Map.Entry next : map.entrySet()) {
            if (!z) {
        ...
        newStringBuilderForCollection.append(JsonLexerKt.END_OBJ);
