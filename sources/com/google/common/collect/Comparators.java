...
public final class Comparators {
    ...
    public static <T> Collector<T, ?, List<T>> least(int i, Comparator<? super T> comparator) {
        ...
        }, $$Lambda$gdvJ8zzvQatRh6knqtwfSxKqxQ.INSTANCE, $$Lambda$Iilf_x3Yim75FBgBCib4qGxg29c.INSTANCE, $$Lambda$VPCwCVNyDcTS8_paG2FrPedynw.INSTANCE, new Collector.Characteristics[]{Collector.Characteristics.UNORDERED});
    }
