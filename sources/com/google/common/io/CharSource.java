...
public abstract class CharSource {
    ...
    public void forEachLine(java.util.function.Consumer<? super java.lang.String> r3) throws java.io.IOException {
        /*
            r2 = this;
            java.util.stream.Stream r0 = r2.lines()     // Catch:{ UncheckedIOException -> 0x001b }
            r0.forEachOrdered(r3)     // Catch:{ all -> 0x000d }
            if (r0 == 0) goto L_0x000c
            r0.close()     // Catch:{ UncheckedIOException -> 0x001b }
        L_0x000c:
            return
        L_0x000d:
            r3 = move-exception
        ...
        L_0x0016:
            r0 = move-exception
            r3.addSuppressed(r0)     // Catch:{ UncheckedIOException -> 0x001b }
        L_0x001a:
            throw r1     // Catch:{ UncheckedIOException -> 0x001b }
        L_0x001b:
            r3 = move-exception
