...
public final class zzj {
    ...
    public static int zza(int i, int i2, @NullableDecl String str) {
        ...
        if (i < 0) {
            str2 = zzk.zza("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
        } else if (i2 < 0) {
            StringBuilder sb = new StringBuilder(26);
            sb.append("negative size: ");
            sb.append(i2);
            ...
            str2 = zzk.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
