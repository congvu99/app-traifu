...
public final class zznq implements zznp {
    ...
    static {
        ...
        zza = zzhr.zza("measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzl = zzhr.zza("measurement.alarm_manager.minimum_interval", 60000);
        zzm = zzhr.zza("measurement.upload.minimum_delay", 500);
        zzn = zzhr.zza("measurement.monitoring.sample_period_millis", 86400000);
        zzo = zzhr.zza("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
        zzp = zzhr.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000);
        zzq = zzhr.zza("measurement.config.cache_time.service", 3600000);
        ...
        zzu = zzhr.zza("measurement.sdk.attribution.cache.ttl", 604800000);
        zzv = zzhr.zza("measurement.upload.backoff_period", 43200000);
        zzw = zzhr.zza("measurement.upload.initial_upload_delay_time", 15000);
        zzx = zzhr.zza("measurement.upload.interval", 3600000);
        zzy = zzhr.zza("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzH = zzhr.zza("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzL = zzhr.zza("measurement.upload.window_interval", 3600000);
    }
