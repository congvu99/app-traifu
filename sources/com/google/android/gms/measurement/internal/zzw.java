...
abstract class zzw {
    ...
    static Boolean zzf(String str, zzex zzex, zzem zzem) {
        ...
        if (zzf2 || zzb2 == zzew.REGEXP || zzb2 == zzew.IN_LIST) {
            str2 = zzex.zzd();
        } else {
        ...
        return zzd(str, zzb2, zzf2, str3, list, zzb2 == zzew.REGEXP ? str3 : null, zzem);
    }

    static Boolean zzg(long j, zzeq zzeq) {
        try {
            return zzj(new BigDecimal(j), zzeq, Utils.DOUBLE_EPSILON);
    ...
    static Boolean zzi(String str, zzeq zzeq) {
        ...
        try {
            return zzj(new BigDecimal(str), zzeq, Utils.DOUBLE_EPSILON);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
