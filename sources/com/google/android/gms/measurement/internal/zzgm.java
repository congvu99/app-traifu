...
public final class zzgm extends zzec {
    ...
    public final byte[] zzj(zzas zzas, String str) {
        ...
        long nanoTime = this.zza.zzay().nanoTime() / AnimationKt.MillisToNanos;
        try {
            ...
            this.zza.zzau().zzj().zzd("Log and bundle processed. event, size, time_ms", this.zza.zzo().zzc(zzas.zza), Integer.valueOf(bArr.length), Long.valueOf((this.zza.zzay().nanoTime() / AnimationKt.MillisToNanos) - nanoTime));
            return bArr;
        } catch (InterruptedException | ExecutionException e) {
