...
public class FastParser<T extends FastJsonResponse> {
    private static final char[] zaqg = {JsonLexerKt.UNICODE_ESC, 'l', 'l'};
    private static final char[] zaqh = {'r', JsonLexerKt.UNICODE_ESC, 'e'};
    private static final char[] zaqi = {'r', JsonLexerKt.UNICODE_ESC, 'e', '\"'};
    ...
    public final long zae(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        if (zaa2 > 0) {
            ...
            while (i < zaa2) {
                ...
                if (digit2 < 0) {
                    throw new ParseException("Unexpected non-digit character");
                } else if (j2 >= _BufferKt.OVERFLOW_ZONE) {
                    long j3 = j2 * 10;
                    long j4 = (long) digit2;
                    if (j3 >= j + j4) {
                        j2 = j3 - j4;
