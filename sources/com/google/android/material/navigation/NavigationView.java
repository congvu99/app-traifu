    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (drawable == null && hasShapeAppearance(obtainTintedStyledAttributes)) {
            ...
            if (Build.VERSION.SDK_INT >= 21 && colorStateList4 != null) {
                this.presenter.setItemForeground(new RippleDrawable(RippleUtils.sanitizeRippleDrawableColor(colorStateList4), (Drawable) null, createDefaultItemDrawable(obtainTintedStyledAttributes, (ColorStateList) null)));
            }
        }
