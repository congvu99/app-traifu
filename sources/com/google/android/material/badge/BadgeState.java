...
public final class BadgeState {
    ...
    BadgeState(Context context, int i, int i2, int i3, State state) {
        ...
        int unused2 = this.currentState.alpha = state.alpha == -2 ? 255 : state.alpha;
        ...
        int unused4 = state3.contentDescriptionQuantityStrings = i4;
        ...
        int unused5 = state4.contentDescriptionExceedsMaxBadgeNumberRes = i5;
        int i13 = 0;
        Boolean unused6 = this.currentState.isVisible = Boolean.valueOf(state.isVisible == null || state.isVisible.booleanValue());
        ...
        int unused7 = state5.maxCharacterCount = i6;
        if (state.number != -2) {
            int unused8 = this.currentState.number = state.number;
        } else if (generateTypedArray.hasValue(R.styleable.Badge_number)) {
            int unused9 = this.currentState.number = generateTypedArray.getInt(R.styleable.Badge_number, 0);
        } else {
            int unused10 = this.currentState.number = -1;
        }
        ...
        Integer unused11 = state6.backgroundColor = Integer.valueOf(i7);
        if (state.badgeTextColor != null) {
            Integer unused12 = this.currentState.badgeTextColor = state.badgeTextColor;
        } else if (generateTypedArray.hasValue(R.styleable.Badge_badgeTextColor)) {
            Integer unused13 = this.currentState.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, generateTypedArray, R.styleable.Badge_badgeTextColor));
        } else {
            Integer unused14 = this.currentState.badgeTextColor = Integer.valueOf(new TextAppearance(context, R.style.TextAppearance_MaterialComponents_Badge).getTextColor().getDefaultColor());
        }
        ...
        Integer unused15 = state7.badgeGravity = Integer.valueOf(i8);
        ...
        Integer unused16 = state8.horizontalOffsetWithoutText = Integer.valueOf(i9);
        ...
        Integer unused17 = state9.verticalOffsetWithoutText = Integer.valueOf(i10);
        State state10 = this.currentState;
        if (state.horizontalOffsetWithText == null) {
            i11 = generateTypedArray.getDimensionPixelOffset(R.styleable.Badge_horizontalOffsetWithText, this.currentState.horizontalOffsetWithoutText.intValue());
        } else {
            i11 = state.horizontalOffsetWithText.intValue();
        }
        Integer unused18 = state10.horizontalOffsetWithText = Integer.valueOf(i11);
        State state11 = this.currentState;
        if (state.verticalOffsetWithText == null) {
            i12 = generateTypedArray.getDimensionPixelOffset(R.styleable.Badge_verticalOffsetWithText, this.currentState.verticalOffsetWithoutText.intValue());
        } else {
            i12 = state.verticalOffsetWithText.intValue();
        }
        Integer unused19 = state11.verticalOffsetWithText = Integer.valueOf(i12);
        Integer unused20 = this.currentState.additionalHorizontalOffset = Integer.valueOf(state.additionalHorizontalOffset == null ? 0 : state.additionalHorizontalOffset.intValue());
        Integer unused21 = this.currentState.additionalVerticalOffset = Integer.valueOf(state.additionalVerticalOffset != null ? state.additionalVerticalOffset.intValue() : i13);
        ...
        if (state.numberLocale == null) {
            ...
            Locale unused22 = state12.numberLocale = locale;
        } else {
            Locale unused23 = this.currentState.numberLocale = state.numberLocale;
        }
