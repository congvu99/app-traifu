...
final class ColorResourcesTableCreator {
    ...
    private static class StringPoolChunk {
        ...
        StringPoolChunk(boolean z, String... strArr) {
            ...
            int i4 = i2 % 4;
            this.stringsPaddingSize = i4 == 0 ? 0 : 4 - i4;
            ...
            int size = (this.stringCount * 4) + 28 + (this.styledSpanIndex.size() * 4);
            this.stringsStart = size;
            int i5 = i2 + this.stringsPaddingSize;
            this.styledSpansStart = z2 ? size + i5 : 0;
            int i6 = this.stringsStart + i5 + (z2 ? i3 : i);
            this.chunkSize = i6;
            this.header = new ResChunkHeader(1, 28, i6);
        }
