        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if ("matrix".equals(nextKey)) {
                ...
                if (equals) {
                    ...
                    MatrixMathHelper.applyTranslate2D(dArr2, map.getDouble(nextKey), Utils.DOUBLE_EPSILON);
                } else if (ViewProps.TRANSLATE_Y.equals(nextKey)) {
                    MatrixMathHelper.applyTranslate2D(dArr2, Utils.DOUBLE_EPSILON, map.getDouble(nextKey));
