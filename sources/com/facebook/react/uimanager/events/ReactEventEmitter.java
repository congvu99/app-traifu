...
public class ReactEventEmitter implements RCTModernEventEmitter {
    ...
    public void receiveTouches(String str, WritableArray writableArray, WritableArray writableArray2) {
        ...
        if (uIManagerType == 2 && (rCTModernEventEmitter = this.mFabricEventEmitter) != null) {
            ...
            ReactSoftExceptionLogger.logSoftException(TAG, new ReactNoCrashSoftException("Cannot find EventEmitter for receivedTouches: ReactTag[" + i + "] UIManagerType[" + uIManagerType + "] EventName[" + str + "]"));
        } else {
