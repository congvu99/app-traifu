...
public class FabricUIManager implements UIManager, LifecycleEventListener {
    ...
    private int mCurrentSynchronousCommitNumber = AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT;
    /* access modifiers changed from: private */
    ...
    public FabricUIManager(ReactApplicationContext reactApplicationContext, ViewManagerRegistry viewManagerRegistry, EventBeatManager eventBeatManager) {
        ...
        this.mMountingManager = mountingManager;
        this.mMountItemDispatcher = new MountItemDispatcher(mountingManager, new MountItemDispatchListener());
        this.mEventDispatcher = ReactFeatureFlags.enableLockFreeEventDispatcher ? new LockFreeEventDispatcherImpl(reactApplicationContext) : new EventDispatcherImpl(reactApplicationContext);
    ...
    public <T extends View> int addRootView(T t, WritableMap writableMap, String str) {
        ...
        this.mMountingManager.startSurface(nextRootViewTag, t, new ThemedReactContext(this.mReactApplicationContext, t.getContext(), reactRoot.getSurfaceID(), nextRootViewTag));
    ...
    public <T extends View> int startSurface(T t, String str, WritableMap writableMap, int i, int i2) {
        ...
        this.mMountingManager.startSurface(nextRootViewTag, t, themedReactContext);
    ...
    public void startSurface(SurfaceHandler surfaceHandler, View view) {
        ...
        if (view == null) {
            ...
            this.mMountingManager.startSurface(nextRootViewTag, view, new ThemedReactContext(this.mReactApplicationContext, view.getContext(), surfaceHandler.getModuleName(), nextRootViewTag));
        }
    ...
    public int getColor(int i, ReadableMap readableMap) {
        Integer color = ColorPropConverter.getColor(readableMap, this.mMountingManager.getSurfaceManagerEnforced(i, "getColor").getContext());
        if (color != null) {
    ...
    private long measureMapBuffer(int i, String str, ReadableMapBuffer readableMapBuffer, ReadableMapBuffer readableMapBuffer2, float f, float f2, float f3, float f4, float[] fArr) {
        ReactContext reactContext;
        if (i > 0) {
            SurfaceMountingManager surfaceManagerEnforced = this.mMountingManager.getSurfaceManagerEnforced(i, "measure");
            if (surfaceManagerEnforced.isStopped()) {
        ...
        return this.mMountingManager.measureTextMapBuffer(reactContext, str, readableMapBuffer, readableMapBuffer2, LayoutMetricsConversions.getYogaSize(f, f2), LayoutMetricsConversions.getYogaMeasureMode(f, f2), LayoutMetricsConversions.getYogaSize(f3, f4), LayoutMetricsConversions.getYogaMeasureMode(f3, f4), fArr);
    }

    public boolean getThemeData(int i, float[] fArr) {
        float[] defaultTextInputPadding = UIManagerHelper.getDefaultTextInputPadding(this.mMountingManager.getSurfaceManagerEnforced(i, "getThemeData").getContext());
    ...
    private void preallocateView(int i, int i2, String str, ReadableMap readableMap, Object obj, Object obj2, boolean z) {
        this.mMountItemDispatcher.addPreAllocateMountItem(new PreAllocateViewMountItem(i, i2, FabricComponents.getFabricComponentName(str), readableMap, (StateWrapper) obj, (EventEmitterWrapper) obj2, z));
    }
