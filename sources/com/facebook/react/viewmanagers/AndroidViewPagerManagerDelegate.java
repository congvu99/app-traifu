...
public class AndroidViewPagerManagerDelegate<T extends View, U extends BaseViewManagerInterface<T> & AndroidViewPagerManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void receiveCommand(T r5, java.lang.String r6, com.facebook.react.bridge.ReadableArray r7) {
        /*
            r4 = this;
            int r0 = r6.hashCode()
        ...
        L_0x002b:
            ...
            int r7 = r7.getInt(r3)
            r6.setPageWithoutAnimation(r5, r7)
            goto L_0x0042
        L_0x0037:
            com.facebook.react.uimanager.BaseViewManagerInterface r6 = r4.mViewManager
            com.facebook.react.viewmanagers.AndroidViewPagerManagerInterface r6 = (com.facebook.react.viewmanagers.AndroidViewPagerManagerInterface) r6
        ...
        L_0x0042:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.viewmanagers.AndroidViewPagerManagerDelegate.receiveCommand(android.view.View, java.lang.String, com.facebook.react.bridge.ReadableArray):void");
    }
}
