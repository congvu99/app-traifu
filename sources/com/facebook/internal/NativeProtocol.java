...
public final class NativeProtocol {
    ...
    public static final List<Intent> createProxyAuthIntents(Context context, String str, Collection<String> collection, String str2, boolean z, boolean z2, DefaultAudience defaultAudience, String str3, String str4, boolean z3) {
        ...
        try {
            ...
            for (NativeAppInfo createNativeAppIntent : facebookAppInfoList) {
                ...
                Intent createNativeAppIntent2 = INSTANCE.createNativeAppIntent(createNativeAppIntent, str, collection, str2, z2, defaultAudience, str3, str4, z3);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:26:0x007c A[Catch:{ RuntimeException -> 0x0055, all -> 0x0098 }, LOOP:0: B:26:0x007c->B:28:0x0082, LOOP_START] */
    ...
    private final java.util.TreeSet<java.lang.Integer> fetchAllAvailableProtocolVersionsForAppInfo(com.facebook.internal.NativeProtocol.NativeAppInfo r13) {
        /*
            ...
            return r3
        L_0x000d:
            java.util.TreeSet r2 = new java.util.TreeSet     // Catch:{ all -> 0x009f }
            r2.<init>()     // Catch:{ all -> 0x009f }
            android.content.Context r4 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x009f }
            java.lang.String r5 = "appContext"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r4, r5)     // Catch:{ all -> 0x009f }
            android.content.ContentResolver r6 = r4.getContentResolver()     // Catch:{ all -> 0x009f }
            java.lang.String[] r8 = new java.lang.String[]{r0}     // Catch:{ all -> 0x009f }
            android.net.Uri r7 = r12.buildPlatformProviderVersionURI(r13)     // Catch:{ all -> 0x009f }
            r4 = r3
            android.database.Cursor r4 = (android.database.Cursor) r4     // Catch:{ all -> 0x009f }
            android.content.Context r5 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x0098 }
            java.lang.String r9 = "FacebookSdk.getApplicationContext()"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r5, r9)     // Catch:{ all -> 0x0098 }
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch:{ all -> 0x0098 }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x0098 }
            r9.<init>()     // Catch:{ all -> 0x0098 }
            java.lang.String r13 = r13.getPackage()     // Catch:{ all -> 0x0098 }
            r9.append(r13)     // Catch:{ all -> 0x0098 }
            java.lang.String r13 = ".provider.PlatformProvider"
            r9.append(r13)     // Catch:{ all -> 0x0098 }
            java.lang.String r13 = r9.toString()     // Catch:{ all -> 0x0098 }
            r9 = r3
            android.content.pm.ProviderInfo r9 = (android.content.pm.ProviderInfo) r9     // Catch:{ all -> 0x0098 }
            r10 = 0
            android.content.pm.ProviderInfo r9 = r5.resolveContentProvider(r13, r10)     // Catch:{ RuntimeException -> 0x0055 }
            goto L_0x005d
        L_0x0055:
            r13 = move-exception
            java.lang.String r5 = TAG     // Catch:{ all -> 0x0098 }
            java.lang.Throwable r13 = (java.lang.Throwable) r13     // Catch:{ all -> 0x0098 }
            android.util.Log.e(r5, r1, r13)     // Catch:{ all -> 0x0098 }
        L_0x005d:
            if (r9 == 0) goto L_0x0092
            r9 = 0
            r10 = 0
            r11 = 0
            android.database.Cursor r13 = r6.query(r7, r8, r9, r10, r11)     // Catch:{ NullPointerException -> 0x0074, SecurityException -> 0x006e, IllegalArgumentException -> 0x0068 }
            r4 = r13
            goto L_0x007a
        L_0x0068:
            java.lang.String r13 = TAG     // Catch:{ all -> 0x0098 }
            android.util.Log.e(r13, r1)     // Catch:{ all -> 0x0098 }
            goto L_0x0079
        L_0x006e:
            java.lang.String r13 = TAG     // Catch:{ all -> 0x0098 }
            android.util.Log.e(r13, r1)     // Catch:{ all -> 0x0098 }
        ...
        L_0x007c:
            boolean r13 = r4.moveToNext()     // Catch:{ all -> 0x0098 }
            if (r13 == 0) goto L_0x0092
            int r13 = r4.getColumnIndex(r0)     // Catch:{ all -> 0x0098 }
            int r13 = r4.getInt(r13)     // Catch:{ all -> 0x0098 }
            java.lang.Integer r13 = java.lang.Integer.valueOf(r13)     // Catch:{ all -> 0x0098 }
            r2.add(r13)     // Catch:{ all -> 0x0098 }
            goto L_0x007c
        L_0x0092:
