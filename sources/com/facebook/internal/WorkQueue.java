...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m5045assert(boolean z) {
            if (!z) {
    ...
    private final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode workNode, boolean z) {
            boolean z2 = true;
            WorkQueue.Companion.m5045assert(this.next == null);
            Companion companion = WorkQueue.Companion;
            if (this.prev != null) {
                z2 = false;
            }
            companion.m5045assert(z2);
            if (workNode == null) {
                workNode = this;
                this.prev = workNode;
                this.next = workNode;
