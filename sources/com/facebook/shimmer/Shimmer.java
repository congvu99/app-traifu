...
public class Shimmer {
    ...
    public static abstract class Builder<T extends Builder<T>> {
        ...
        public T setBaseAlpha(float f) {
            ...
            shimmer.baseColor = (((int) (clamp(0.0f, 1.0f, f) * 255.0f)) << 24) | (shimmer.baseColor & 16777215);
            return getThis();
        }

        public T setHighlightAlpha(float f) {
            Shimmer shimmer = this.mShimmer;
            shimmer.highlightColor = (((int) (clamp(0.0f, 1.0f, f) * 255.0f)) << 24) | (shimmer.highlightColor & 16777215);
            return getThis();
        }
    ...
    public static class ColorHighlightBuilder extends Builder<ColorHighlightBuilder> {
        ...
        public ColorHighlightBuilder setBaseColor(int i) {
            this.mShimmer.baseColor = (i & 16777215) | (this.mShimmer.baseColor & ViewCompat.MEASURED_STATE_MASK);
            return getThis();
        }
