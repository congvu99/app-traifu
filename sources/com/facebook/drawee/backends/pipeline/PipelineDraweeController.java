...
public class PipelineDraweeController extends AbstractDraweeController<CloseableReference<CloseableImage>, ImageInfo> {
    ...
    public synchronized void removeImageOriginListener(com.facebook.drawee.backends.pipeline.info.ImageOriginListener r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            com.facebook.drawee.backends.pipeline.info.ImageOriginListener r0 = r1.mImageOriginListener     // Catch:{ all -> 0x0019 }
            boolean r0 = r0 instanceof com.facebook.drawee.backends.pipeline.info.ForwardingImageOriginListener     // Catch:{ all -> 0x0019 }
            if (r0 == 0) goto L_0x0010
            com.facebook.drawee.backends.pipeline.info.ImageOriginListener r0 = r1.mImageOriginListener     // Catch:{ all -> 0x0019 }
            com.facebook.drawee.backends.pipeline.info.ForwardingImageOriginListener r0 = (com.facebook.drawee.backends.pipeline.info.ForwardingImageOriginListener) r0     // Catch:{ all -> 0x0019 }
            r0.removeImageOriginListener(r2)     // Catch:{ all -> 0x0019 }
            monitor-exit(r1)
            return
        L_0x0010:
            com.facebook.drawee.backends.pipeline.info.ImageOriginListener r0 = r1.mImageOriginListener     // Catch:{ all -> 0x0019 }
            ...
            r2 = 0
            r1.mImageOriginListener = r2     // Catch:{ all -> 0x0019 }
        L_0x0017:
            monitor-exit(r1)
            return
        L_0x0019:
