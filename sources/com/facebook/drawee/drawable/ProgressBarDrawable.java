...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mIsVertical) {
            drawVerticalBar(canvas, AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT, this.mBackgroundColor);
            drawVerticalBar(canvas, this.mLevel, this.mColor);
            return;
        }
        drawHorizontalBar(canvas, AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT, this.mBackgroundColor);
    ...
    private void drawHorizontalBar(Canvas canvas, int i, int i2) {
        ...
        int width = ((bounds.width() - (this.mPadding * 2)) * i) / AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT;
    ...
    private void drawVerticalBar(Canvas canvas, int i, int i2) {
        Rect bounds = getBounds();
        int height = ((bounds.height() - (this.mPadding * 2)) * i) / AsyncHttpClient.DEFAULT_SOCKET_TIMEOUT;
        int i3 = bounds.left + this.mPadding;
