...
public abstract class UnpackingSoSource extends DirectorySoSource {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:12:0x0043 A[Catch:{ all -> 0x00ac, all -> 0x00b3, all -> 0x0036, all -> 0x00dc }] */
    /* JADX WARNING: Removed duplicated region for block: B:16:0x005a A[Catch:{ all -> 0x00ac, all -> 0x00b3, all -> 0x0036, all -> 0x00dc }] */
    ...
    private void regenerate(byte r10, com.facebook.soloader.UnpackingSoSource.DsoManifest r11, com.facebook.soloader.UnpackingSoSource.InputDsoIterator r12) throws java.io.IOException {
        ...
        L_0x0060:
            ...
            com.facebook.soloader.UnpackingSoSource$Dso[] r7 = r10.dsos     // Catch:{ all -> 0x00ac }
            int r7 = r7.length     // Catch:{ all -> 0x00ac }
            if (r6 >= r7) goto L_0x008f
            com.facebook.soloader.UnpackingSoSource$Dso r7 = r4.getDso()     // Catch:{ all -> 0x00ac }
            java.lang.String r7 = r7.name     // Catch:{ all -> 0x00ac }
            com.facebook.soloader.UnpackingSoSource$Dso[] r8 = r10.dsos     // Catch:{ all -> 0x00ac }
            r8 = r8[r6]     // Catch:{ all -> 0x00ac }
            java.lang.String r8 = r8.name     // Catch:{ all -> 0x00ac }
            boolean r7 = r8.equals(r7)     // Catch:{ all -> 0x00ac }
            if (r7 == 0) goto L_0x008c
            com.facebook.soloader.UnpackingSoSource$Dso[] r7 = r10.dsos     // Catch:{ all -> 0x00ac }
            r7 = r7[r6]     // Catch:{ all -> 0x00ac }
            java.lang.String r7 = r7.hash     // Catch:{ all -> 0x00ac }
            com.facebook.soloader.UnpackingSoSource$Dso r8 = r4.getDso()     // Catch:{ all -> 0x00ac }
            java.lang.String r8 = r8.hash     // Catch:{ all -> 0x00ac }
            boolean r7 = r7.equals(r8)     // Catch:{ all -> 0x00ac }
            if (r7 == 0) goto L_0x008c
            r5 = 0
        L_0x008c:
            int r6 = r6 + 1
            goto L_0x0060
        L_0x008f:
            java.io.File r6 = new java.io.File     // Catch:{ all -> 0x00ac }
            java.io.File r7 = r9.soDirectory     // Catch:{ all -> 0x00ac }
            java.lang.String r8 = r4.getFileName()     // Catch:{ all -> 0x00ac }
            r6.<init>(r7, r8)     // Catch:{ all -> 0x00ac }
            boolean r6 = r6.exists()     // Catch:{ all -> 0x00ac }
            if (r6 != 0) goto L_0x00a1
            r5 = 1
        L_0x00a1:
            if (r5 == 0) goto L_0x00a6
            r9.extractDso(r4, r11)     // Catch:{ all -> 0x00ac }
        L_0x00a6:
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Removed duplicated region for block: B:39:0x00a2 A[RETURN] */
    ...
    public boolean refreshLocked(com.facebook.soloader.FileLocker r12, int r13, byte[] r14) throws java.io.IOException {
        /*
            ...
            r8 = 1
            r3 = 0
            byte r5 = r1.readByte()     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            if (r5 == r8) goto L_0x0041
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            r5.<init>()     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            java.lang.String r6 = "dso store "
            r5.append(r6)     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            java.io.File r6 = r11.soDirectory     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            r5.append(r6)     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            java.lang.String r6 = " regeneration interrupted: wiping clean"
            r5.append(r6)     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            java.lang.String r5 = r5.toString()     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            android.util.Log.v(r0, r5)     // Catch:{ EOFException -> 0x0040, all -> 0x0036 }
            goto L_0x0040
        L_0x0036:
            r12 = move-exception
        ...
        L_0x0041:
            ...
            r7.<init>(r6, r2)
            long r9 = r7.length()     // Catch:{ all -> 0x00ef }
            int r2 = (int) r9     // Catch:{ all -> 0x00ef }
            byte[] r9 = new byte[r2]     // Catch:{ all -> 0x00ef }
            int r10 = r7.read(r9)     // Catch:{ all -> 0x00ef }
            if (r10 == r2) goto L_0x0066
            java.lang.String r2 = "short read of so store deps file: marking unclean"
            android.util.Log.v(r0, r2)     // Catch:{ all -> 0x00ef }
            r5 = 0
        L_0x0066:
            boolean r2 = r11.depsChanged(r9, r14)     // Catch:{ all -> 0x00ef }
        ...
        L_0x007b:
            ...
            android.util.Log.v(r0, r1)     // Catch:{ all -> 0x00ef }
            writeState(r4, r3)     // Catch:{ all -> 0x00ef }
            com.facebook.soloader.UnpackingSoSource$Unpacker r0 = r11.makeUnpacker(r5)     // Catch:{ all -> 0x00ef }
            com.facebook.soloader.UnpackingSoSource$DsoManifest r1 = r0.getDsoManifest()     // Catch:{ all -> 0x00e3 }
            com.facebook.soloader.UnpackingSoSource$InputDsoIterator r2 = r0.openDsoIterator()     // Catch:{ all -> 0x00e3 }
            r11.regenerate(r5, r1, r2)     // Catch:{ all -> 0x00d7 }
        ...
        L_0x00de:
            r13 = move-exception
            r12.addSuppressed(r13)     // Catch:{ all -> 0x00e3 }
        L_0x00e2:
            throw r12     // Catch:{ all -> 0x00e3 }
        L_0x00e3:
            r12 = move-exception
        ...
        L_0x00ea:
            r13 = move-exception
            r12.addSuppressed(r13)     // Catch:{ all -> 0x00ef }
        L_0x00ee:
            throw r12     // Catch:{ all -> 0x00ef }
        L_0x00ef:
            r12 = move-exception
