        ...
        this.writeThread.execute(new Runnable() {
            ...
            public void run() {
                /*
                    ...
                    com.loopj.android.image.WebImageCache r4 = com.loopj.android.image.WebImageCache.this     // Catch:{ FileNotFoundException -> 0x003f, all -> 0x003a }
                    java.lang.String r4 = r4.diskCachePath     // Catch:{ FileNotFoundException -> 0x003f, all -> 0x003a }
                    com.loopj.android.image.WebImageCache r5 = com.loopj.android.image.WebImageCache.this     // Catch:{ FileNotFoundException -> 0x003f, all -> 0x003a }
