...
public final class EngineInterceptor implements Interceptor {
    ...
    public final MemoryCacheService memoryCacheService = new MemoryCacheService(this.imageLoader, this.requestService, this.logger);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:46:0x015c A[Catch:{ all -> 0x021d }] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:69:0x01fb A[RETURN] */
    ...
    public final java.lang.Object execute(coil.request.ImageRequest r36, java.lang.Object r37, coil.request.Options r38, coil.EventListener r39, kotlin.coroutines.Continuation<? super coil.intercept.EngineInterceptor.ExecuteResult> r40) {
        ...
        L_0x0088:
            ...
            r15.<init>()
            coil.request.RequestService r1 = r8.requestService     // Catch:{ all -> 0x021d }
            T r2 = r13.element     // Catch:{ all -> 0x021d }
            coil.request.Options r2 = (coil.request.Options) r2     // Catch:{ all -> 0x021d }
            boolean r1 = r1.allowHardwareWorkerThread(r2)     // Catch:{ all -> 0x021d }
            if (r1 != 0) goto L_0x00e0
            T r1 = r13.element     // Catch:{ all -> 0x021d }
            r16 = r1
            coil.request.Options r16 = (coil.request.Options) r16     // Catch:{ all -> 0x021d }
            r17 = 0
            android.graphics.Bitmap$Config r18 = android.graphics.Bitmap.Config.ARGB_8888     // Catch:{ all -> 0x021d }
            r19 = 0
            r20 = 0
            r21 = 0
            r22 = 0
            ...
            r33 = 0
            coil.request.Options r1 = coil.request.Options.copy$default(r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33)     // Catch:{ all -> 0x021d }
            r13.element = r1     // Catch:{ all -> 0x021d }
        L_0x00e0:
            kotlin.Pair r1 = r36.getFetcherFactory()     // Catch:{ all -> 0x021d }
            if (r1 != 0) goto L_0x00ec
            coil.decode.Decoder$Factory r1 = r36.getDecoderFactory()     // Catch:{ all -> 0x021d }
            if (r1 == 0) goto L_0x0115
        L_0x00ec:
            T r1 = r14.element     // Catch:{ all -> 0x021d }
            coil.ComponentRegistry r1 = (coil.ComponentRegistry) r1     // Catch:{ all -> 0x021d }
            coil.ComponentRegistry$Builder r1 = r1.newBuilder()     // Catch:{ all -> 0x021d }
            kotlin.Pair r2 = r36.getFetcherFactory()     // Catch:{ all -> 0x021d }
            r4 = 0
            if (r2 == 0) goto L_0x0102
            java.util.List r5 = r1.getFetcherFactories$coil_base_release()     // Catch:{ all -> 0x021d }
            r5.add(r4, r2)     // Catch:{ all -> 0x021d }
        L_0x0102:
            coil.decode.Decoder$Factory r2 = r36.getDecoderFactory()     // Catch:{ all -> 0x021d }
            if (r2 == 0) goto L_0x010f
            java.util.List r5 = r1.getDecoderFactories$coil_base_release()     // Catch:{ all -> 0x021d }
            r5.add(r4, r2)     // Catch:{ all -> 0x021d }
        L_0x010f:
            coil.ComponentRegistry r1 = r1.build()     // Catch:{ all -> 0x021d }
            r14.element = r1     // Catch:{ all -> 0x021d }
        L_0x0115:
            T r1 = r14.element     // Catch:{ all -> 0x021d }
            r2 = r1
            coil.ComponentRegistry r2 = (coil.ComponentRegistry) r2     // Catch:{ all -> 0x021d }
            T r1 = r13.element     // Catch:{ all -> 0x021d }
            r5 = r1
            coil.request.Options r5 = (coil.request.Options) r5     // Catch:{ all -> 0x021d }
            r0.L$0 = r8     // Catch:{ all -> 0x021d }
            r7 = r36
            r0.L$1 = r7     // Catch:{ all -> 0x021d }
            r6 = r37
            r0.L$2 = r6     // Catch:{ all -> 0x021d }
            r4 = r39
            r0.L$3 = r4     // Catch:{ all -> 0x021d }
            r0.L$4 = r13     // Catch:{ all -> 0x021d }
            r0.L$5 = r14     // Catch:{ all -> 0x021d }
            r0.L$6 = r15     // Catch:{ all -> 0x021d }
            r0.L$7 = r15     // Catch:{ all -> 0x021d }
            r0.label = r3     // Catch:{ all -> 0x021d }
            r1 = r35
            r3 = r36
            r4 = r37
            r6 = r39
            r7 = r0
            java.lang.Object r1 = r1.fetch(r2, r3, r4, r5, r6, r7)     // Catch:{ all -> 0x021d }
        ...
        L_0x0147:
            ...
            r14 = r8
        L_0x0152:
            r2.element = r1     // Catch:{ all -> 0x021d }
            T r1 = r15.element     // Catch:{ all -> 0x021d }
            coil.fetch.FetchResult r1 = (coil.fetch.FetchResult) r1     // Catch:{ all -> 0x021d }
            boolean r2 = r1 instanceof coil.fetch.SourceResult     // Catch:{ all -> 0x021d }
            if (r2 == 0) goto L_0x01a0
            kotlinx.coroutines.CoroutineDispatcher r1 = r13.getDecoderDispatcher()     // Catch:{ all -> 0x021d }
            kotlin.coroutines.CoroutineContext r1 = (kotlin.coroutines.CoroutineContext) r1     // Catch:{ all -> 0x021d }
            coil.intercept.EngineInterceptor$execute$executeResult$1 r2 = new coil.intercept.EngineInterceptor$execute$executeResult$1     // Catch:{ all -> 0x021d }
            r24 = 0
            r16 = r2
            r17 = r14
            r18 = r15
            ...
            r22 = r3
            r23 = r6
            r16.<init>(r17, r18, r19, r20, r21, r22, r23, r24)     // Catch:{ all -> 0x021d }
            kotlin.jvm.functions.Function2 r2 = (kotlin.jvm.functions.Function2) r2     // Catch:{ all -> 0x021d }
            r0.L$0 = r14     // Catch:{ all -> 0x021d }
            r0.L$1 = r13     // Catch:{ all -> 0x021d }
            r0.L$2 = r6     // Catch:{ all -> 0x021d }
            r0.L$3 = r3     // Catch:{ all -> 0x021d }
            r0.L$4 = r15     // Catch:{ all -> 0x021d }
            r0.L$5 = r12     // Catch:{ all -> 0x021d }
            r0.L$6 = r12     // Catch:{ all -> 0x021d }
            r0.L$7 = r12     // Catch:{ all -> 0x021d }
            r0.label = r11     // Catch:{ all -> 0x021d }
            java.lang.Object r1 = kotlinx.coroutines.BuildersKt.withContext(r1, r2, r0)     // Catch:{ all -> 0x021d }
        ...
        L_0x019a:
            ...
            goto L_0x01c4
        L_0x01a0:
            boolean r1 = r1 instanceof coil.fetch.DrawableResult     // Catch:{ all -> 0x021d }
            if (r1 == 0) goto L_0x0217
            coil.intercept.EngineInterceptor$ExecuteResult r1 = new coil.intercept.EngineInterceptor$ExecuteResult     // Catch:{ all -> 0x021d }
            T r2 = r15.element     // Catch:{ all -> 0x021d }
            coil.fetch.DrawableResult r2 = (coil.fetch.DrawableResult) r2     // Catch:{ all -> 0x021d }
            android.graphics.drawable.Drawable r2 = r2.getDrawable()     // Catch:{ all -> 0x021d }
            T r4 = r15.element     // Catch:{ all -> 0x021d }
            coil.fetch.DrawableResult r4 = (coil.fetch.DrawableResult) r4     // Catch:{ all -> 0x021d }
            boolean r4 = r4.isSampled()     // Catch:{ all -> 0x021d }
            T r5 = r15.element     // Catch:{ all -> 0x021d }
            coil.fetch.DrawableResult r5 = (coil.fetch.DrawableResult) r5     // Catch:{ all -> 0x021d }
            coil.decode.DataSource r5 = r5.getDataSource()     // Catch:{ all -> 0x021d }
            r1.<init>(r2, r4, r5, r12)     // Catch:{ all -> 0x021d }
            r4 = r13
            r2 = r14
            goto L_0x019a
        L_0x01c4:
        ...
        L_0x0216:
            return r1
        L_0x0217:
            kotlin.NoWhenBranchMatchedException r0 = new kotlin.NoWhenBranchMatchedException     // Catch:{ all -> 0x021d }
    ...
    public final Object transform$coil_base_release(ExecuteResult executeResult, ImageRequest imageRequest, Options options, EventListener eventListener, Continuation<? super ExecuteResult> continuation) {
        ...
        if (logger2 != null && logger2.getLevel() <= 4) {
            ...
            logger2.log(TAG, 4, "allowConversionToBitmap=false, skipping transformations for type " + canonicalName + '.', (Throwable) null);
        }
        return executeResult;
    }
