...
public final class CrossfadeDrawable extends Drawable implements Drawable.Callback, Animatable2Compat {
    ...
    public CrossfadeDrawable(Drawable drawable, Drawable drawable2, Scale scale2, int i, boolean z, boolean z2) {
        ...
        this.end = drawable2 != null ? drawable2.mutate() : drawable4;
    ...
    public void draw(Canvas canvas) {
        ...
        if (i == 0) {
            ...
            double coerceIn = RangesKt.coerceIn(uptimeMillis, (double) Utils.DOUBLE_EPSILON, 1.0d);
    ...
    public boolean onStateChange(int[] iArr) {
        Drawable drawable = this.start;
        boolean state2 = drawable == null ? false : drawable.setState(iArr);
        Drawable drawable2 = this.end;
        boolean state3 = drawable2 == null ? false : drawable2.setState(iArr);
        if (state2 || state3) {
            return true;
        }
        return false;
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Lcoil/drawable/CrossfadeDrawable$Companion;", "", "()V", "DEFAULT_DURATION", "", "STATE_DONE", "STATE_RUNNING", "STATE_START", "coil-base_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* compiled from: CrossfadeDrawable.kt */
