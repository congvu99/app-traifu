...
public final class ScaleDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public void draw(Canvas canvas) {
        ...
        try {
            ...
            canvas.scale(this.childScale, this.childScale);
