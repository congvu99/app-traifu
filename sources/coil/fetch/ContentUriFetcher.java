...
public final class ContentUriFetcher implements Fetcher {
    ...
    public Object fetch(Continuation<? super FetchResult> continuation) {
        ...
        if (isContactPhotoUri$coil_base_release(this.data)) {
            ...
            AssetFileDescriptor openTypedAssetFile = contentResolver.openTypedAssetFile(this.data, MimeType.IMAGE, newMusicThumbnailSizeOptions(), (CancellationSignal) null);
    ...
    private final Bundle newMusicThumbnailSizeOptions() {
        ...
        Integer valueOf = pixels == null ? null : Integer.valueOf(pixels.px);
        if (valueOf == null) {
            return null;
        }
        ...
        Integer valueOf2 = pixels2 == null ? null : Integer.valueOf(pixels2.px);
        if (valueOf2 == null) {
            return null;
        }
