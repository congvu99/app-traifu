...
public final class ImageRequest {
    ...
    public int hashCode() {
        ...
        int hashCode6 = (((hashCode5 + (colorSpace2 == null ? 0 : colorSpace2.hashCode())) * 31) + this.precision.hashCode()) * 31;
        Pair<Fetcher.Factory<?>, Class<?>> pair = this.fetcherFactory;
        int hashCode7 = (hashCode6 + (pair == null ? 0 : pair.hashCode())) * 31;
        Decoder.Factory factory = this.decoderFactory;
        int hashCode8 = (((((((((((((((((((((((((((((((((((((((hashCode7 + (factory == null ? 0 : factory.hashCode())) * 31) + this.transformations.hashCode()) * 31) + this.transitionFactory.hashCode()) * 31) + this.headers.hashCode()) * 31) + this.tags.hashCode()) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.allowConversionToBitmap)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.allowHardware)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.allowRgb565)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.premultipliedAlpha)) * 31) + this.memoryCachePolicy.hashCode()) * 31) + this.diskCachePolicy.hashCode()) * 31) + this.networkCachePolicy.hashCode()) * 31) + this.interceptorDispatcher.hashCode()) * 31) + this.fetcherDispatcher.hashCode()) * 31) + this.decoderDispatcher.hashCode()) * 31) + this.transformationDispatcher.hashCode()) * 31) + this.lifecycle.hashCode()) * 31) + this.sizeResolver.hashCode()) * 31) + this.scale.hashCode()) * 31) + this.parameters.hashCode()) * 31;
    ...
    public static final class Builder {
        ...
        public final Builder interceptorDispatcher(CoroutineDispatcher coroutineDispatcher) {
            Builder builder = this;
            builder.interceptorDispatcher = coroutineDispatcher;
            return builder;
        }
        ...
        public final Builder transformations(List<? extends Transformation> list) {
            Builder builder = this;
            builder.transformations = Collections.toImmutableList(list);
            return builder;
        }
        ...
        public final <T> Builder fetcherFactory(Fetcher.Factory<T> factory, Class<T> cls) {
            Builder builder = this;
            builder.fetcherFactory = TuplesKt.to(factory, cls);
            return builder;
        }
        ...
        public final Builder allowConversionToBitmap(boolean z) {
            Builder builder = this;
            builder.allowConversionToBitmap = z;
            return builder;
        }
        ...
        public final <T> Builder tag(Class<? super T> cls, T t) {
            ...
            if (t == null) {
                ...
                Map<Class<?>, Object> map2 = builder.tags;
                if (map2 == null) {
        ...
        public final Builder tags(Tags tags2) {
            Builder builder = this;
            builder.tags = MapsKt.toMutableMap(tags2.asMap());
            return builder;
        }
        ...
        public final ImageRequest build() {
            ...
            Tags orEmpty2 = Utils.orEmpty(map == null ? null : Tags.Companion.from(map));
            boolean z = this.allowConversionToBitmap;
            Boolean bool = this.allowHardware;
            boolean allowHardware2 = bool == null ? this.defaults.getAllowHardware() : bool.booleanValue();
            Boolean bool2 = this.allowRgb565;
            boolean allowRgb5652 = bool2 == null ? this.defaults.getAllowRgb565() : bool2.booleanValue();
            ...
            Parameters orEmpty3 = Utils.orEmpty(builder2 == null ? null : builder2.build());
            MemoryCache.Key key2 = this.placeholderMemoryCacheKey;
            Integer num = this.placeholderResId;
            Drawable drawable = this.placeholderDrawable;
            Integer num2 = this.errorResId;
