...
public final class Options {
    ...
    public static /* synthetic */ Options copy$default(Options options, Context context2, Bitmap.Config config2, ColorSpace colorSpace2, Size size2, Scale scale2, boolean z, boolean z2, boolean z3, String str, Headers headers2, Tags tags2, Parameters parameters2, CachePolicy cachePolicy, CachePolicy cachePolicy2, CachePolicy cachePolicy3, int i, Object obj) {
        ...
        int i2 = i;
        return options.copy((i2 & 1) != 0 ? options2.context : context2, (i2 & 2) != 0 ? options2.config : config2, (i2 & 4) != 0 ? options2.colorSpace : colorSpace2, (i2 & 8) != 0 ? options2.size : size2, (i2 & 16) != 0 ? options2.scale : scale2, (i2 & 32) != 0 ? options2.allowInexactSize : z, (i2 & 64) != 0 ? options2.allowRgb565 : z2, (i2 & 128) != 0 ? options2.premultipliedAlpha : z3, (i2 & 256) != 0 ? options2.diskCacheKey : str, (i2 & 512) != 0 ? options2.headers : headers2, (i2 & 1024) != 0 ? options2.tags : tags2, (i2 & 2048) != 0 ? options2.parameters : parameters2, (i2 & 4096) != 0 ? options2.memoryCachePolicy : cachePolicy, (i2 & 8192) != 0 ? options2.diskCachePolicy : cachePolicy2, (i2 & 16384) != 0 ? options2.networkCachePolicy : cachePolicy3);
    }
    ...
    public int hashCode() {
        ...
        int i = 0;
        int hashCode2 = (((((((((((hashCode + (colorSpace2 == null ? 0 : colorSpace2.hashCode())) * 31) + this.size.hashCode()) * 31) + this.scale.hashCode()) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.allowInexactSize)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.allowRgb565)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.premultipliedAlpha)) * 31;
