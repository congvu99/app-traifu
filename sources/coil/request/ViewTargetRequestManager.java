...
public final class ViewTargetRequestManager implements View.OnAttachStateChangeListener {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v2, resolved type: coil.request.ImageResult} */
    ...
    public final synchronized coil.request.ImageResult getResult() {
        /*
            r2 = this;
            monitor-enter(r2)
            coil.request.ViewTargetDisposable r0 = r2.currentDisposable     // Catch:{ all -> 0x0017 }
            r1 = 0
            if (r0 != 0) goto L_0x0007
            goto L_0x0015
        L_0x0007:
            kotlinx.coroutines.Deferred r0 = r0.getJob()     // Catch:{ all -> 0x0017 }
            if (r0 != 0) goto L_0x000e
            goto L_0x0015
        L_0x000e:
            java.lang.Object r0 = coil.util.Utils.getCompletedOrNull(r0)     // Catch:{ all -> 0x0017 }
            r1 = r0
            coil.request.ImageResult r1 = (coil.request.ImageResult) r1     // Catch:{ all -> 0x0017 }
        L_0x0015:
            monitor-exit(r2)
            return r1
        L_0x0017:
