...
public final class DefaultRequestOptions {
    ...
    public static /* synthetic */ DefaultRequestOptions copy$default(DefaultRequestOptions defaultRequestOptions, CoroutineDispatcher coroutineDispatcher, CoroutineDispatcher coroutineDispatcher2, CoroutineDispatcher coroutineDispatcher3, CoroutineDispatcher coroutineDispatcher4, Transition.Factory factory, Precision precision2, Bitmap.Config config, boolean z, boolean z2, Drawable drawable, Drawable drawable2, Drawable drawable3, CachePolicy cachePolicy, CachePolicy cachePolicy2, CachePolicy cachePolicy3, int i, Object obj) {
        ...
        int i2 = i;
        return defaultRequestOptions.copy((i2 & 1) != 0 ? defaultRequestOptions2.interceptorDispatcher : coroutineDispatcher, (i2 & 2) != 0 ? defaultRequestOptions2.fetcherDispatcher : coroutineDispatcher2, (i2 & 4) != 0 ? defaultRequestOptions2.decoderDispatcher : coroutineDispatcher3, (i2 & 8) != 0 ? defaultRequestOptions2.transformationDispatcher : coroutineDispatcher4, (i2 & 16) != 0 ? defaultRequestOptions2.transitionFactory : factory, (i2 & 32) != 0 ? defaultRequestOptions2.precision : precision2, (i2 & 64) != 0 ? defaultRequestOptions2.bitmapConfig : config, (i2 & 128) != 0 ? defaultRequestOptions2.allowHardware : z, (i2 & 256) != 0 ? defaultRequestOptions2.allowRgb565 : z2, (i2 & 512) != 0 ? defaultRequestOptions2.placeholder : drawable, (i2 & 1024) != 0 ? defaultRequestOptions2.error : drawable2, (i2 & 2048) != 0 ? defaultRequestOptions2.fallback : drawable3, (i2 & 4096) != 0 ? defaultRequestOptions2.memoryCachePolicy : cachePolicy, (i2 & 8192) != 0 ? defaultRequestOptions2.diskCachePolicy : cachePolicy2, (i2 & 16384) != 0 ? defaultRequestOptions2.networkCachePolicy : cachePolicy3);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((((this.interceptorDispatcher.hashCode() * 31) + this.fetcherDispatcher.hashCode()) * 31) + this.decoderDispatcher.hashCode()) * 31) + this.transformationDispatcher.hashCode()) * 31) + this.transitionFactory.hashCode()) * 31) + this.precision.hashCode()) * 31) + this.bitmapConfig.hashCode()) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.allowHardware)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.allowRgb565)) * 31;
