...
final class SubcomposeAsyncImageKt$SubcomposeAsyncImage$3 extends Lambda implements Function3<BoxWithConstraintsScope, Composer, Integer, Unit> {
    ...
    SubcomposeAsyncImageKt$SubcomposeAsyncImage$3(SizeResolver sizeResolver, Function3<? super SubcomposeAsyncImageScope, ? super Composer, ? super Integer, Unit> function3, AsyncImagePainter asyncImagePainter, String str, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i) {
        super(3);
    ...
    public final void invoke(BoxWithConstraintsScope boxWithConstraintsScope, Composer composer, int i) {
        ...
        if (((i & 91) ^ 18) != 0 || !composer.getSkipping()) {
            ((ConstraintsSizeResolver) this.$sizeResolver).m5002setConstraintsBRTryo0(boxWithConstraintsScope.m457getConstraintsmsEJaDk());
