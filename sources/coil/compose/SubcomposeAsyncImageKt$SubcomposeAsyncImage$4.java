...
final class SubcomposeAsyncImageKt$SubcomposeAsyncImage$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        SubcomposeAsyncImageKt.m5025SubcomposeAsyncImagesKDTAoQ(this.$model, this.$contentDescription, this.$imageLoader, this.$modifier, this.$transform, this.$onState, this.$alignment, this.$contentScale, this.$alpha, this.$colorFilter, this.$filterQuality, this.$content, composer, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
