...
public final class CacheStrategy {
    ...
    public static final class Factory {
        ...
        public Factory(Request request2, CacheResponse cacheResponse2) {
            ...
            if (cacheResponse2 != null) {
                ...
                Headers responseHeaders = this.cacheResponse.getResponseHeaders();
                int i = 0;
        ...
        public final CacheStrategy compute() {
            ...
            return new CacheStrategy(this.request.newBuilder().headers(newBuilder.build()).build(), this.cacheResponse, (DefaultConstructorMarker) null);
        }
    ...
    public static final class Companion {
        ...
        public final boolean isCacheable(Request request, Response response) {
            return !request.cacheControl().noStore() && !response.cacheControl().noStore() && !Intrinsics.areEqual((Object) response.headers().get("Vary"), (Object) ProxyConfig.MATCH_ALL_SCHEMES);
        }

        public final boolean isCacheable(Request request, CacheResponse cacheResponse) {
            return !request.cacheControl().noStore() && !cacheResponse.getCacheControl().noStore() && !Intrinsics.areEqual((Object) cacheResponse.getResponseHeaders().get("Vary"), (Object) ProxyConfig.MATCH_ALL_SCHEMES);
        }
        ...
        private final boolean isEndToEnd(String str) {
            if (StringsKt.equals("Connection", str, true) || StringsKt.equals(HTTP.CONN_KEEP_ALIVE, str, true) || StringsKt.equals("Proxy-Authenticate", str, true) || StringsKt.equals("Proxy-Authorization", str, true) || StringsKt.equals("TE", str, true) || StringsKt.equals("Trailers", str, true) || StringsKt.equals("Transfer-Encoding", str, true) || StringsKt.equals("Upgrade", str, true)) {
                return false;
            }
            return true;
        }
