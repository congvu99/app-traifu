...
public final class GifUtils {
    ...
    public static final PostProcessor asPostProcessor(AnimatedTransformation animatedTransformation) {
        return new PostProcessor() {
            public final int onPostProcess(Canvas canvas) {
                return GifUtils.m5030asPostProcessor$lambda0(AnimatedTransformation.this, canvas);
            }
        };
    }
    ...
    public static final int m5030asPostProcessor$lambda0(AnimatedTransformation animatedTransformation, Canvas canvas) {
