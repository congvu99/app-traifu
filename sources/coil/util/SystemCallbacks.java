...
public final class SystemCallbacks implements ComponentCallbacks2, NetworkObserver.Listener {
    ...
    public SystemCallbacks(RealImageLoader realImageLoader, Context context2, boolean z) {
        ...
        if (z) {
            networkObserver2 = NetworkObserverKt.NetworkObserver(this.context, this, realImageLoader.getLogger());
        } else {
    ...
    private final void withImageLoader(Function1<? super RealImageLoader, Unit> function1) {
        Unit unit;
        RealImageLoader realImageLoader = (RealImageLoader) getImageLoader$coil_base_release().get();
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Lcoil/util/SystemCallbacks$Companion;", "", "()V", "OFFLINE", "", "ONLINE", "TAG", "coil-base_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* compiled from: SystemCallbacks.kt */
    ...
    public void onTrimMemory(int i) {
        ...
        if (realImageLoader != null) {
            ...
            if (logger != null && logger.getLevel() <= 2) {
                logger.log(TAG, 2, Intrinsics.stringPlus("trimMemory, level=", Integer.valueOf(i)), (Throwable) null);
            }
