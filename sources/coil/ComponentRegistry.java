...
public final class ComponentRegistry {
    ...
    public final Object map(Object obj, Options options) {
        ...
        while (i < size) {
            ...
            if (((Class) pair.component2()).isAssignableFrom(obj.getClass()) && (map = mapper.map(obj, options)) != null) {
                obj = map;
            }
            i = i2;
        }
    ...
    public final String key(Object obj, Options options) {
        ...
        while (i < size) {
            ...
            if (((Class) pair.component2()).isAssignableFrom(obj.getClass()) && (key = keyer.key(obj, options)) != null) {
                return key;
            }
            i = i2;
        }
    ...
    public final Pair<Fetcher, Integer> newFetcher(Object obj, Options options, ImageLoader imageLoader, int i) {
        ...
        while (i < size) {
            ...
            if (((Class) pair.component2()).isAssignableFrom(obj.getClass()) && (create = factory.create(obj, options, imageLoader)) != null) {
    ...
    public static final class Builder {
        ...
        public final Builder add(Interceptor interceptor) {
            ...
            builder.getInterceptors$coil_base_release().add(interceptor);
            return builder;
        }
        ...
        public final <T> Builder add(Mapper<T, ?> mapper, Class<T> cls) {
            Builder builder = this;
            builder.getMappers$coil_base_release().add(TuplesKt.to(mapper, cls));
            return builder;
        }
        ...
        public final <T> Builder add(Keyer<T> keyer, Class<T> cls) {
            Builder builder = this;
            builder.getKeyers$coil_base_release().add(TuplesKt.to(keyer, cls));
            return builder;
        }
        ...
        public final <T> Builder add(Fetcher.Factory<T> factory, Class<T> cls) {
            Builder builder = this;
            builder.getFetcherFactories$coil_base_release().add(TuplesKt.to(factory, cls));
            return builder;
        }

        public final Builder add(Decoder.Factory factory) {
            Builder builder = this;
            builder.getDecoderFactories$coil_base_release().add(factory);
            return builder;
        }
