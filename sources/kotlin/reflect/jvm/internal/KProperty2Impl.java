...
public class KProperty2Impl<D, E, V> extends KPropertyImpl<V> implements KProperty2<D, E, V> {
    ...
    private final Lazy<Field> delegateField = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new KProperty2Impl$delegateField$1(this));
    ...
    public Object getDelegate(D d, E e) {
        return getDelegate(this.delegateField.getValue(), d);
    }
