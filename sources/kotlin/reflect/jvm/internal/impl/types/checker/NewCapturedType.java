...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    public NewCapturedType refine(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return new NewCapturedType(captureStatus2, refine, unwrappedType != null ? kotlinTypeRefiner.refineType(unwrappedType).unwrap() : null, getAnnotations(), isMarkedNullable(), false, 32, (DefaultConstructorMarker) null);
    }
}
