...
public final class CapturedTypeApproximationKt {
    ...
    private static final TypeProjection toTypeProjection(TypeArgument typeArgument) {
        ...
        throw new AssertionError("Only consistent enhanced type projection can be converted to type projection, but " + JsonLexerKt.BEGIN_LIST + withOptions.render(typeArgument.getTypeParameter()) + ": <" + withOptions.renderType(typeArgument.getInProjection()) + ", " + withOptions.renderType(typeArgument.getOutProjection()) + ">]" + " was found");
    }
    ...
    private static final TypeProjection substituteCapturedTypesWithProjections(TypeProjection typeProjection) {
        ...
        Intrinsics.checkNotNullExpressionValue(create, "TypeSubstitutor.create(o…ojection\n        }\n    })");
    ...
    public static final kotlin.reflect.jvm.internal.impl.types.typesApproximation.ApproximationBounds<kotlin.reflect.jvm.internal.impl.types.KotlinType> approximateCapturedTypes(kotlin.reflect.jvm.internal.impl.types.KotlinType r8) {
        ...
        L_0x005d:
            ...
            kotlin.reflect.jvm.internal.impl.types.KotlinType r4 = r1.invoke((kotlin.reflect.jvm.internal.impl.types.KotlinType) r4)
            ...
            kotlin.reflect.jvm.internal.impl.types.KotlinType r8 = r1.invoke((kotlin.reflect.jvm.internal.impl.types.KotlinType) r8)
            r0.<init>(r8, r4)
            goto L_0x00d7
        L_0x00ac:
