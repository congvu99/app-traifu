...
public class Flags {
    ...
    static {
        ...
        MEMBER_KIND = after4;
        BooleanFlagField booleanAfter6 = FlagField.booleanAfter(after4);
        IS_OPERATOR = booleanAfter6;
        BooleanFlagField booleanAfter7 = FlagField.booleanAfter(booleanAfter6);
        IS_INFIX = booleanAfter7;
        BooleanFlagField booleanAfter8 = FlagField.booleanAfter(booleanAfter7);
        IS_INLINE = booleanAfter8;
        BooleanFlagField booleanAfter9 = FlagField.booleanAfter(booleanAfter8);
        IS_TAILREC = booleanAfter9;
        BooleanFlagField booleanAfter10 = FlagField.booleanAfter(booleanAfter9);
        IS_EXTERNAL_FUNCTION = booleanAfter10;
        BooleanFlagField booleanAfter11 = FlagField.booleanAfter(booleanAfter10);
        IS_SUSPEND = booleanAfter11;
        IS_EXPECT_FUNCTION = FlagField.booleanAfter(booleanAfter11);
        BooleanFlagField booleanAfter12 = FlagField.booleanAfter(MEMBER_KIND);
        IS_VAR = booleanAfter12;
        BooleanFlagField booleanAfter13 = FlagField.booleanAfter(booleanAfter12);
        HAS_GETTER = booleanAfter13;
        BooleanFlagField booleanAfter14 = FlagField.booleanAfter(booleanAfter13);
        HAS_SETTER = booleanAfter14;
        BooleanFlagField booleanAfter15 = FlagField.booleanAfter(booleanAfter14);
        IS_CONST = booleanAfter15;
        BooleanFlagField booleanAfter16 = FlagField.booleanAfter(booleanAfter15);
        IS_LATEINIT = booleanAfter16;
        BooleanFlagField booleanAfter17 = FlagField.booleanAfter(booleanAfter16);
        HAS_CONSTANT = booleanAfter17;
        BooleanFlagField booleanAfter18 = FlagField.booleanAfter(booleanAfter17);
        IS_EXTERNAL_PROPERTY = booleanAfter18;
        BooleanFlagField booleanAfter19 = FlagField.booleanAfter(booleanAfter18);
        IS_DELEGATED = booleanAfter19;
        IS_EXPECT_PROPERTY = FlagField.booleanAfter(booleanAfter19);
        BooleanFlagField booleanAfter20 = FlagField.booleanAfter(HAS_ANNOTATIONS);
        DECLARES_DEFAULT_VALUE = booleanAfter20;
        BooleanFlagField booleanAfter21 = FlagField.booleanAfter(booleanAfter20);
        IS_CROSSINLINE = booleanAfter21;
        IS_NOINLINE = FlagField.booleanAfter(booleanAfter21);
        BooleanFlagField booleanAfter22 = FlagField.booleanAfter(MODALITY);
        IS_NOT_DEFAULT = booleanAfter22;
        BooleanFlagField booleanAfter23 = FlagField.booleanAfter(booleanAfter22);
        IS_EXTERNAL_ACCESSOR = booleanAfter23;
        IS_INLINE_ACCESSOR = FlagField.booleanAfter(booleanAfter23);
