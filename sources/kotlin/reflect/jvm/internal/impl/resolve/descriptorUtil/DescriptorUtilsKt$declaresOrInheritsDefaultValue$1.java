...
final class DescriptorUtilsKt$declaresOrInheritsDefaultValue$1<N> implements DFS.Neighbors<ValueParameterDescriptor> {
    ...
    public final Iterable<ValueParameterDescriptor> getNeighbors(ValueParameterDescriptor valueParameterDescriptor) {
        Intrinsics.checkNotNullExpressionValue(valueParameterDescriptor, "current");
