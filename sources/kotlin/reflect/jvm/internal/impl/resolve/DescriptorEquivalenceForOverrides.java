...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areCallableDescriptorsEquivalent(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (!DescriptorUtils.isLocal(declarationDescriptor)) {
            ...
            OverridingUtil.OverrideCompatibilityInfo isOverridableBy = create.isOverridableBy(callableDescriptor, callableDescriptor2, (ClassDescriptor) null, !z3);
            ...
            if (isOverridableBy.getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE) {
                OverridingUtil.OverrideCompatibilityInfo isOverridableBy2 = create.isOverridableBy(callableDescriptor2, callableDescriptor, (ClassDescriptor) null, !z3);
