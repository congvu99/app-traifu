...
public final class CapturedType extends SimpleType implements SubtypingRepresentatives, CapturedTypeMarker {
    ...
    public MemberScope getMemberScope() {
        ...
        Intrinsics.checkNotNullExpressionValue(createErrorScope, "ErrorUtils.createErrorSc…solution\", true\n        )");
    ...
    private final KotlinType representative(Variance variance, KotlinType kotlinType) {
        ...
        Intrinsics.checkNotNullExpressionValue(kotlinType, "if (typeProjection.proje…jection.type else default");
        return kotlinType;
    }
