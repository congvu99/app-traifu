...
public final class KClassValue extends ConstantValue<Value> {
    ...
    public final KotlinType getArgumentType(ModuleDescriptor moduleDescriptor) {
        ...
        if (value instanceof Value.NormalClass) {
            ...
            Intrinsics.checkNotNullExpressionValue(createErrorType, "ErrorUtils.createErrorTy…sions=$arrayDimensions)\")");
    ...
    public static final class Companion {
        ...
        public final ConstantValue<?> create(KotlinType kotlinType) {
            ...
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                Intrinsics.checkNotNullExpressionValue(classId2, "ClassId.topLevel(KotlinB…ns.FQ_NAMES.any.toSafe())");
