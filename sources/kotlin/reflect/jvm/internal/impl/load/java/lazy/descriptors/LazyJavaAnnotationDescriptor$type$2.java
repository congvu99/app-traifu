...
final class LazyJavaAnnotationDescriptor$type$2 extends Lambda implements Function0<SimpleType> {
    ...
    public final SimpleType invoke() {
        ...
        if (fqName != null) {
            ...
            ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMap.mapJavaToKotlin$default(JavaToKotlinClassMap.INSTANCE, fqName, this.this$0.c.getModule().getBuiltIns(), (Integer) null, 4, (Object) null);
