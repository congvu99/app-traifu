...
public final class JavaAnnotationMapper {
    ...
    public final AnnotationDescriptor mapOrResolveJavaAnnotation(JavaAnnotation javaAnnotation, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        if (Intrinsics.areEqual((Object) classId, (Object) ClassId.topLevel(JAVA_TARGET_FQ_NAME))) {
            possiblyExternalAnnotationDescriptor = new JavaTargetAnnotationDescriptor(javaAnnotation, lazyJavaResolverContext);
        } else if (Intrinsics.areEqual((Object) classId, (Object) ClassId.topLevel(JAVA_RETENTION_FQ_NAME))) {
            possiblyExternalAnnotationDescriptor = new JavaRetentionAnnotationDescriptor(javaAnnotation, lazyJavaResolverContext);
            ...
            possiblyExternalAnnotationDescriptor = new JavaAnnotationDescriptor(lazyJavaResolverContext, javaAnnotation, fqName);
            ...
            possiblyExternalAnnotationDescriptor = new JavaAnnotationDescriptor(lazyJavaResolverContext, javaAnnotation, fqName2);
        } else if (Intrinsics.areEqual((Object) classId, (Object) ClassId.topLevel(JAVA_DEPRECATED_FQ_NAME))) {
            possiblyExternalAnnotationDescriptor = null;
        } else {
            possiblyExternalAnnotationDescriptor = new LazyJavaAnnotationDescriptor(lazyJavaResolverContext, javaAnnotation);
        }
    ...
    public final AnnotationDescriptor findMappedJavaAnnotation(FqName fqName, JavaAnnotationOwner javaAnnotationOwner, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        Intrinsics.checkNotNullParameter(lazyJavaResolverContext, "c");
        if (Intrinsics.areEqual((Object) fqName, (Object) KotlinBuiltIns.FQ_NAMES.deprecated) && ((findAnnotation2 = javaAnnotationOwner.findAnnotation(JAVA_DEPRECATED_FQ_NAME)) != null || javaAnnotationOwner.isDeprecatedInJavaDoc())) {
