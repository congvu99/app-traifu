...
public final class UtilKt {
    ...
    public static final LazyJavaStaticClassScope getParentJavaStaticClassScope(ClassDescriptor classDescriptor) {
        Intrinsics.checkNotNullParameter(classDescriptor, "$this$getParentJavaStaticClassScope");
    ...
    public static final AnnotationDefaultValue getDefaultValueFromAnnotation(ValueParameterDescriptor valueParameterDescriptor) {
        ...
        String str;
        Intrinsics.checkNotNullParameter(valueParameterDescriptor, "$this$getDefaultValueFromAnnotation");
        Annotations annotations = valueParameterDescriptor.getAnnotations();
        FqName fqName = JvmAnnotationNames.DEFAULT_VALUE_FQ_NAME;
        Intrinsics.checkNotNullExpressionValue(fqName, "JvmAnnotationNames.DEFAULT_VALUE_FQ_NAME");
        ...
        Intrinsics.checkNotNullExpressionValue(fqName2, "JvmAnnotationNames.DEFAULT_NULL_FQ_NAME");
