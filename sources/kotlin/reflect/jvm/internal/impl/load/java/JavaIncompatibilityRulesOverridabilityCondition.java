    ...
    public static final class Companion {
        ...
        public final boolean doesJavaOverrideHaveIncompatibleValueParameterKinds(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2) {
            ...
            if ((callableDescriptor2 instanceof JavaMethodDescriptor) && (callableDescriptor instanceof FunctionDescriptor)) {
                ...
                if (!_Assertions.ENABLED || z) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(original, "subDescriptor.original");
                    ...
                    Intrinsics.checkNotNullExpressionValue(original2, "superDescriptor.original");
                    ...
                    for (Pair pair : CollectionsKt.zip(valueParameters, valueParameters2)) {
                        ...
                        boolean z2 = companion.mapValueParameterType((FunctionDescriptor) callableDescriptor2, valueParameterDescriptor) instanceof JvmType.Primitive;
                        Intrinsics.checkNotNullExpressionValue(valueParameterDescriptor2, "superParameter");
                        if (z2 != (companion.mapValueParameterType(functionDescriptor, valueParameterDescriptor2) instanceof JvmType.Primitive)) {
                            return true;
                        }
                    }
                } else {
        ...
        private final boolean isPrimitiveCompareTo(FunctionDescriptor functionDescriptor) {
            ...
            if (classDescriptor2 != null) {
                ...
                Intrinsics.checkNotNullExpressionValue(single, "f.valueParameters.single()");
                ...
                if (classDescriptor3 == null || !KotlinBuiltIns.isPrimitiveClass(classDescriptor2) || !Intrinsics.areEqual((Object) DescriptorUtilsKt.getFqNameSafe(classDescriptor2), (Object) DescriptorUtilsKt.getFqNameSafe(classDescriptor3))) {
                    return false;
                }
                return true;
            }
