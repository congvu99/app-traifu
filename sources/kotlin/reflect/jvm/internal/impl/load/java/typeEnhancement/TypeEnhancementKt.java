...
public final class TypeEnhancementKt {
    ...
    public static final KotlinType enhance(KotlinType kotlinType, Function1<? super Integer, JavaTypeQualifiers> function1) {
        Intrinsics.checkNotNullParameter(kotlinType, "$this$enhance");
    ...
    public static final boolean hasEnhancedNullability(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "$this$hasEnhancedNullability");
    ...
    public static final boolean hasEnhancedNullability(TypeSystemCommonBackendContext typeSystemCommonBackendContext, KotlinTypeMarker kotlinTypeMarker) {
        Intrinsics.checkNotNullParameter(typeSystemCommonBackendContext, "$this$hasEnhancedNullability");
    ...
    private static final SimpleResult enhanceInflexible(SimpleType simpleType, Function1<? super Integer, JavaTypeQualifiers> function1, int i, TypeComponentPosition typeComponentPosition) {
        ...
        SimpleType simpleType$default = KotlinTypeFactory.simpleType$default(compositeAnnotationsOrSingle(CollectionsKt.listOfNotNull((T[]) new Annotations[]{simpleType.getAnnotations(), component2, component22})), typeConstructor, list, booleanValue, (KotlinTypeRefiner) null, 16, (Object) null);
        if (invoke.isNotNullTypeParameter()) {
            simpleType$default = new NotNullTypeParameter(simpleType$default);
        }
        UnwrappedType wrapEnhancement = component22 != null && invoke.isNullabilityQualifierForWarning() ? TypeWithEnhancementKt.wrapEnhancement(simpleType2, simpleType$default) : simpleType$default;
    ...
    public static final boolean shouldEnhance(TypeComponentPosition typeComponentPosition) {
        Intrinsics.checkNotNullParameter(typeComponentPosition, "$this$shouldEnhance");
