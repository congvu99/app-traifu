...
public final class MethodSignatureMappingKt {
    public static final String computeJvmDescriptor(FunctionDescriptor functionDescriptor, boolean z, boolean z2) {
        ...
        for (ValueParameterDescriptor next : functionDescriptor.getValueParameters()) {
            Intrinsics.checkNotNullExpressionValue(next, "parameter");
    ...
    public static final String getInternalName(ClassDescriptor classDescriptor) {
        ...
        if (mapKotlinToJava == null) {
            return TypeSignatureMappingKt.computeInternalName$default(classDescriptor, (TypeMappingConfiguration) null, 2, (Object) null);
        }
    ...
    public static final JvmType mapToJvmType(KotlinType kotlinType) {
        ...
        return (JvmType) TypeSignatureMappingKt.mapType$default(kotlinType, JvmTypeFactoryImpl.INSTANCE, TypeMappingMode.DEFAULT, TypeMappingConfigurationImpl.INSTANCE, (JvmDescriptorTypeWriter) null, (Function3) null, 32, (Object) null);
    }
