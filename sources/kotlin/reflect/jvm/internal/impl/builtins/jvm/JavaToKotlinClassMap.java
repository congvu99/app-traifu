...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        Intrinsics.checkNotNullExpressionValue(fqName, "FQ_NAMES.mutableIterable");
        ...
        Intrinsics.checkNotNullExpressionValue(fqName2, "FQ_NAMES.mutableIterator");
        ...
        Intrinsics.checkNotNullExpressionValue(classId7, "ClassId.topLevel(FQ_NAMES.collection)");
        FqName fqName3 = KotlinBuiltIns.FQ_NAMES.mutableCollection;
        Intrinsics.checkNotNullExpressionValue(fqName3, "FQ_NAMES.mutableCollection");
        ...
        Intrinsics.checkNotNullExpressionValue(classId9, "ClassId.topLevel(FQ_NAMES.list)");
        FqName fqName4 = KotlinBuiltIns.FQ_NAMES.mutableList;
        Intrinsics.checkNotNullExpressionValue(fqName4, "FQ_NAMES.mutableList");
        ...
        Intrinsics.checkNotNullExpressionValue(classId11, "ClassId.topLevel(FQ_NAMES.set)");
        FqName fqName5 = KotlinBuiltIns.FQ_NAMES.mutableSet;
        Intrinsics.checkNotNullExpressionValue(fqName5, "FQ_NAMES.mutableSet");
        ...
        Intrinsics.checkNotNullExpressionValue(classId13, "ClassId.topLevel(FQ_NAMES.listIterator)");
        FqName fqName6 = KotlinBuiltIns.FQ_NAMES.mutableListIterator;
        Intrinsics.checkNotNullExpressionValue(fqName6, "FQ_NAMES.mutableListIterator");
        ...
        Intrinsics.checkNotNullExpressionValue(classId15, "ClassId.topLevel(FQ_NAMES.map)");
        FqName fqName7 = KotlinBuiltIns.FQ_NAMES.mutableMap;
        Intrinsics.checkNotNullExpressionValue(fqName7, "FQ_NAMES.mutableMap");
        ...
        Intrinsics.checkNotNullExpressionValue(createNestedClassId, "ClassId.topLevel(FQ_NAME…MES.mapEntry.shortName())");
        FqName fqName8 = KotlinBuiltIns.FQ_NAMES.mutableMapEntry;
        Intrinsics.checkNotNullExpressionValue(fqName8, "FQ_NAMES.mutableMapEntry");
        ...
        Intrinsics.checkNotNullExpressionValue(fqName9, "FQ_NAMES.throwable");
        ...
        Intrinsics.checkNotNullExpressionValue(fqName10, "FQ_NAMES.comparable");
        ...
        Intrinsics.checkNotNullExpressionValue(fqName11, "FQ_NAMES.annotation");
        ...
        for (JvmPrimitiveType jvmPrimitiveType : JvmPrimitiveType.values()) {
            ...
            Intrinsics.checkNotNullExpressionValue(classId17, "ClassId.topLevel(jvmType.wrapperFqName)");
            ClassId classId18 = ClassId.topLevel(KotlinBuiltIns.getPrimitiveFqName(jvmPrimitiveType.getPrimitiveType()));
            Intrinsics.checkNotNullExpressionValue(classId18, "ClassId.topLevel(KotlinB…e(jvmType.primitiveType))");
        ...
        for (ClassId next : CompanionObjectMapping.INSTANCE.allClassesWithIntrinsicCompanions()) {
            ...
            Intrinsics.checkNotNullExpressionValue(classId19, "ClassId.topLevel(FqName(…g() + \"CompanionObject\"))");
        ...
        for (int i = 0; i < 23; i++) {
            ...
            Intrinsics.checkNotNullExpressionValue(classId20, "ClassId.topLevel(FqName(…m.functions.Function$i\"))");
            ClassId functionClassId = KotlinBuiltIns.getFunctionClassId(i);
            Intrinsics.checkNotNullExpressionValue(functionClassId, "KotlinBuiltIns.getFunctionClassId(i)");
        ...
        Intrinsics.checkNotNullExpressionValue(safe, "FQ_NAMES.nothing.toSafe()");
    ...
    public final Collection<ClassDescriptor> mapPlatformClass(FqName fqName, KotlinBuiltIns kotlinBuiltIns) {
        ...
        Intrinsics.checkNotNullExpressionValue(fqName2, "readOnlyToMutable[kotlin…eturn setOf(kotlinAnalog)");
    ...
    public final ClassId classId(Class<?> cls) {
        ...
        if (!_Assertions.ENABLED || z) {
            ...
            if (declaringClass == null) {
                ...
                Intrinsics.checkNotNullExpressionValue(classId, "ClassId.topLevel(FqName(clazz.canonicalName))");
                return classId;
            }
