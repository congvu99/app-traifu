...
public class JvmBuiltInsSettings implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    private final SimpleType getCloneableType() {
        return (SimpleType) StorageKt.getValue(this.cloneableType$delegate, (Object) this, (KProperty<?>) $$delegatedProperties[0]);
    }

    private final Annotations getNotConsideredDeprecation() {
        return (Annotations) StorageKt.getValue(this.notConsideredDeprecation$delegate, (Object) this, (KProperty<?>) $$delegatedProperties[1]);
    }
    ...
    public JvmBuiltInsSettings(ModuleDescriptor moduleDescriptor2, StorageManager storageManager, Function0<? extends ModuleDescriptor> function0, Function0<Boolean> function02) {
        ...
        Intrinsics.checkNotNullParameter(function0, "deferredOwnerModuleDescriptor");
        Intrinsics.checkNotNullParameter(function02, "isAdditionalBuiltInsFeatureSupported");
    ...
    public Collection<KotlinType> getSupertypes(ClassDescriptor classDescriptor) {
        ...
        if (Companion.isArrayOrPrimitiveArray(fqNameUnsafe)) {
            ...
            list = CollectionsKt.listOf(cloneableType, this.mockSerializableType);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:57:0x00c4 A[SYNTHETIC] */
    ...
    private final boolean isMutabilityViolation(SimpleFunctionDescriptor simpleFunctionDescriptor, boolean z) {
        ...
        if (containingDeclaration != null) {
            ...
            Intrinsics.checkNotNullExpressionValue(ifAny, "DFS.ifAny<CallableMember…lassDescriptor)\n        }");
    ...
    private final JDKMemberStatus getJdkMethodStatus(FunctionDescriptor functionDescriptor) {
        ...
        if (containingDeclaration != null) {
            String computeJvmDescriptor$default = MethodSignatureMappingKt.computeJvmDescriptor$default(functionDescriptor, false, false, 3, (Object) null);
            ...
            Intrinsics.checkNotNullExpressionValue(dfs, "DFS.dfs<ClassDescriptor,…CONSIDERED\n            })");
    ...
    public final LazyJavaClassDescriptor getJavaAnalogue(ClassDescriptor classDescriptor) {
        ...
        Intrinsics.checkNotNullExpressionValue(asSingleFqName, "j2kClassMap.mapKotlinToJ…leFqName() ?: return null");
    ...
    public Collection<ClassConstructorDescriptor> getConstructors(ClassDescriptor classDescriptor) {
        ...
        ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMap.mapJavaToKotlin$default(this.j2kClassMap, DescriptorUtilsKt.getFqNameSafe(javaAnalogue), FallbackBuiltIns.Companion.getInstance(), (Integer) null, 4, (Object) null);
        ...
        while (true) {
            ...
            if (classConstructorDescriptor.getVisibility().isPublicAPI()) {
                ...
                if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
                    ...
                    if (z && !isTrivialCopyConstructorFor(classConstructorDescriptor, classDescriptor2) && !KotlinBuiltIns.isDeprecated(classConstructorDescriptor) && !BLACK_LIST_CONSTRUCTOR_SIGNATURES.contains(SignatureBuildingComponents.INSTANCE.signature(classDescriptor3, MethodSignatureMappingKt.computeJvmDescriptor$default(classConstructorDescriptor, false, false, 3, (Object) null)))) {
                        z2 = true;
                    }
                }
                z = true;
        ...
        for (ClassConstructorDescriptor classConstructorDescriptor3 : iterable2) {
            ...
            if (!WHITE_LIST_CONSTRUCTOR_SIGNATURES.contains(SignatureBuildingComponents.INSTANCE.signature(classDescriptor3, MethodSignatureMappingKt.computeJvmDescriptor$default(classConstructorDescriptor3, false, false, 3, (Object) null)))) {
    ...
    static {
        ...
        Set plus = SetsKt.plus(access$buildPrimitiveStringConstructorsSet, signatureBuildingComponents4.inJavaLang("Float", (String[]) Arrays.copyOf(constructors, constructors.length)));
        ...
        BLACK_LIST_CONSTRUCTOR_SIGNATURES = SetsKt.plus(plus, signatureBuildingComponents4.inJavaLang("String", (String[]) Arrays.copyOf(constructors2, constructors2.length)));
