...
public final class CompanionObjectMapping {
    ...
    static {
        ...
        for (FqName fqName : CollectionsKt.plus(CollectionsKt.plus(CollectionsKt.plus((List) arrayList, KotlinBuiltIns.FQ_NAMES.string.toSafe()), KotlinBuiltIns.FQ_NAMES._boolean.toSafe()), KotlinBuiltIns.FQ_NAMES._enum.toSafe())) {
