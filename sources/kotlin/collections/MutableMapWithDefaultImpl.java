...
final class MutableMapWithDefaultImpl<K, V> implements MutableMapWithDefault<K, V> {
    ...
    private final Function1<K, V> f214default;
    private final Map<K, V> map;

    public MutableMapWithDefaultImpl(Map<K, V> map2, Function1<? super K, ? extends V> function1) {
        Intrinsics.checkNotNullParameter(map2, "map");
        Intrinsics.checkNotNullParameter(function1, Bus.DEFAULT_IDENTIFIER);
        this.map = map2;
        this.f214default = function1;
    }
    ...
    public V getOrImplicitDefault(K k) {
        Map map2 = getMap();
        V v = map2.get(k);
        return (v != null || map2.containsKey(k)) ? v : this.f214default.invoke(k);
    }
}
