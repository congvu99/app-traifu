...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark m6739minusLRDsOJo(long j) {
            return TimeMark.DefaultImpls.m6887minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m6738elapsedNowUwyO8pc() {
        ...
        public TimeMark m6740plusLRDsOJo(long j) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m6785plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }
    }

    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m6851getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
