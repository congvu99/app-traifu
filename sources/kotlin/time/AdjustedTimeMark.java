...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m6743minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m6887minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m6742getAdjustmentUwyO8pc() {
    ...
    public long m6741elapsedNowUwyO8pc() {
        return Duration.m6784minusLRDsOJo(this.mark.m6884elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m6744plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m6785plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
