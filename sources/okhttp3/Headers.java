...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m7046deprecated_size() {
        return size();
    }
    ...
    public static final class Builder {
        ...
        public final Builder addLenient$okhttp(String str) {
            ...
            int indexOf$default = StringsKt.indexOf$default((CharSequence) str, (char) JsonLexerKt.COLON, 1, false, 4, (Object) null);
        ...
        public final Builder add(String str) {
            Intrinsics.checkNotNullParameter(str, "line");
            Builder builder = this;
            int indexOf$default = StringsKt.indexOf$default((CharSequence) str, (char) JsonLexerKt.COLON, 0, false, 6, (Object) null);
            if (indexOf$default != -1) {
                String substring = str.substring(0, indexOf$default);
                Intrinsics.checkNotNullExpressionValue(substring, "(this as java.lang.Strin…ing(startIndex, endIndex)");
                if (substring != null) {
    ...
    public static final class Companion {
        ...
        public final Headers m7048deprecated_of(String... strArr) {
            Intrinsics.checkNotNullParameter(strArr, "namesAndValues");
        ...
        /* renamed from: -deprecated_of  reason: not valid java name */
        public final Headers m7047deprecated_of(Map<String, String> map) {
