...
public final class Request {
    ...
    public final HttpUrl m7114deprecated_url() {
        return this.url;
    }
    ...
    public final String m7113deprecated_method() {
        return this.method;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "headers", imports = {}))
    /* renamed from: -deprecated_headers  reason: not valid java name */
    public final Headers m7112deprecated_headers() {
        return this.headers;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "body", imports = {}))
    /* renamed from: -deprecated_body  reason: not valid java name */
    public final RequestBody m7110deprecated_body() {
        return this.body;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "cacheControl", imports = {}))
    /* renamed from: -deprecated_cacheControl  reason: not valid java name */
    public final CacheControl m7111deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public static class Builder {
        ...
        public Builder post(RequestBody requestBody) {
            ...
            return method(RequestHelper.REQUEST_POST, requestBody);
        }
        ...
        public Builder put(RequestBody requestBody) {
            Intrinsics.checkNotNullParameter(requestBody, SDKConstants.PARAM_A2U_BODY);
            return method(RequestHelper.REQUEST_PUT, requestBody);
        }
