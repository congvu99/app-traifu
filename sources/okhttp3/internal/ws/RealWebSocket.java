...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void connect(OkHttpClient okHttpClient) {
        ...
        Request build2 = this.originalRequest.newBuilder().header("Upgrade", "websocket").header("Connection", "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", BaseHttpClient.API_VERSION).header("Sec-WebSocket-Extensions", "permessage-deflate").build();
