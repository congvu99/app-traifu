...
abstract class CacheStrategy {
    ...
    private io.sentry.SentryEnvelope readEnvelope(java.io.File r5) {
        ...
        L_0x001c:
            ...
            r1.log((io.sentry.SentryLevel) r2, (java.lang.String) r3, (java.lang.Throwable) r5)
            return r0
        */
    ...
    private void saveNewEnvelope(io.sentry.SentryEnvelope r4, java.io.File r5, long r6) {
        /*
            ...
            r2.serialize((io.sentry.SentryEnvelope) r4, (java.io.OutputStream) r0)     // Catch:{ all -> 0x0012 }
