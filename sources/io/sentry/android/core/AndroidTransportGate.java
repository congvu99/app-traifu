    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                io.sentry.android.core.util.ConnectivityChecker$Status r1 = io.sentry.android.core.util.ConnectivityChecker.Status.CONNECTED     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$sentry$android$core$util$ConnectivityChecker$Status     // Catch:{ NoSuchFieldError -> 0x001d }
                io.sentry.android.core.util.ConnectivityChecker$Status r1 = io.sentry.android.core.util.ConnectivityChecker.Status.UNKNOWN     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$io$sentry$android$core$util$ConnectivityChecker$Status     // Catch:{ NoSuchFieldError -> 0x0028 }
                io.sentry.android.core.util.ConnectivityChecker$Status r1 = io.sentry.android.core.util.ConnectivityChecker.Status.NO_PERMISSION     // Catch:{ NoSuchFieldError -> 0x0028 }
