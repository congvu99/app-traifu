...
public final class SentryEnvelopeItem {
    ...
    public static SentryEnvelopeItem fromSession(ISerializer iSerializer, Session session) throws IOException {
        ...
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.Session, (Callable<Integer>) new Callable() {
            public final Object call() {
                return Integer.valueOf(SentryEnvelopeItem.CachedItem.this.getBytes().length);
            }
        }, RequestParams.APPLICATION_JSON, (String) null), (Callable<byte[]>) new Callable() {
            public final Object call() {
    ...
    static /* synthetic */ byte[] lambda$fromSession$0(io.sentry.ISerializer r4, io.sentry.Session r5) throws java.lang.Exception {
        /*
            ...
            r4.serialize(r5, (java.io.Writer) r1)     // Catch:{ all -> 0x0020 }
    ...
    public static SentryEnvelopeItem fromEvent(ISerializer iSerializer, SentryBaseEvent sentryBaseEvent) throws IOException {
        ...
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.resolve(sentryBaseEvent), (Callable<Integer>) new Callable() {
            public final Object call() {
                return Integer.valueOf(SentryEnvelopeItem.CachedItem.this.getBytes().length);
            }
        }, RequestParams.APPLICATION_JSON, (String) null), (Callable<byte[]>) new Callable() {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ byte[] lambda$fromEvent$3(io.sentry.ISerializer r4, io.sentry.SentryBaseEvent r5) throws java.lang.Exception {
        /*
            java.io.ByteArrayOutputStream r0 = new java.io.ByteArrayOutputStream
            r0.<init>()
            java.io.BufferedWriter r1 = new java.io.BufferedWriter     // Catch:{ all -> 0x0027 }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public io.sentry.ITransaction getTransaction(io.sentry.ISerializer r6) throws java.lang.Exception {
        /*
            r5 = this;
            io.sentry.SentryEnvelopeItemHeader r0 = r5.header
            r1 = 0
        ...
        L_0x000e:
            ...
            r2.<init>(r3, r4)
            r0.<init>(r2)
            java.lang.Class<io.sentry.SentryTransaction> r2 = io.sentry.SentryTransaction.class
            java.lang.Object r6 = r6.deserialize(r0, r2)     // Catch:{ all -> 0x002f }
            io.sentry.ITransaction r6 = (io.sentry.ITransaction) r6     // Catch:{ all -> 0x002f }
            $closeResource(r1, r0)
            return r6
        L_0x002f:
            r6 = move-exception
        ...
        L_0x0036:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.sentry.SentryEnvelopeItem.getTransaction(io.sentry.ISerializer):io.sentry.ITransaction");
    }
    ...
    public static SentryEnvelopeItem fromUserFeedback(ISerializer iSerializer, UserFeedback userFeedback) {
        ...
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.UserFeedback, (Callable<Integer>) new Callable() {
            public final Object call() {
                return Integer.valueOf(SentryEnvelopeItem.CachedItem.this.getBytes().length);
            }
        }, RequestParams.APPLICATION_JSON, (String) null), (Callable<byte[]>) new Callable() {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ byte[] lambda$fromUserFeedback$6(io.sentry.ISerializer r4, io.sentry.UserFeedback r5) throws java.lang.Exception {
        /*
            java.io.ByteArrayOutputStream r0 = new java.io.ByteArrayOutputStream
            r0.<init>()
            java.io.BufferedWriter r1 = new java.io.BufferedWriter     // Catch:{ all -> 0x0027 }
    ...
    public static SentryEnvelopeItem fromAttachment(Attachment attachment, long j) {
        ...
        return new SentryEnvelopeItem(new SentryEnvelopeItemHeader(SentryItemType.Attachment, (Callable<Integer>) new Callable() {
            public final Object call() {
                return Integer.valueOf(SentryEnvelopeItem.CachedItem.this.getBytes().length);
            }
        }, attachment.getContentType(), attachment.getFilename()), (Callable<byte[]>) new Callable() {
            public final Object call() {
                return SentryEnvelopeItem.CachedItem.this.getBytes();
            }
        });
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ byte[] lambda$fromAttachment$9(io.sentry.Attachment r9, long r10) throws java.lang.Exception {
        /*
            byte[] r0 = r9.getBytes()
            r1 = 2
            r2 = 3
