...
public final class AsyncHttpTransport implements ITransport {
    ...
    public AsyncHttpTransport(ExecutorService executorService, SentryOptions sentryOptions, RateLimiter rateLimiter2, ITransportGate iTransportGate, HttpConnection httpConnection) {
        this.executor = (ExecutorService) Objects.requireNonNull(executorService, "executor is required");
    ...
    private static QueuedThreadPoolExecutor initExecutor(int i, IEnvelopeCache iEnvelopeCache, ILogger iLogger) {
        return new QueuedThreadPoolExecutor(1, i, new AsyncConnectionThreadFactory(), new RejectedExecutionHandler(iLogger) {
