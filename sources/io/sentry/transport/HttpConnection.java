...
final class HttpConnection {
        ...
        if (proxy2 != null) {
            ...
            if (!(port == null || host == null)) {
                try {
                    ...
                    logger.log(sentryLevel, e, "Failed to parse Sentry Proxy port: " + proxy2.getPort() + ". Proxy is ignored", new Object[0]);
                }
            }
        }
        return null;
    ...
    private HttpURLConnection createConnection() throws IOException {
        ...
        open.setRequestMethod(RequestHelper.REQUEST_POST);
        open.setDoOutput(true);
        open.setRequestProperty("Content-Encoding", AsyncHttpClient.ENCODING_GZIP);
