...
class TwoParamChangeSubscriber<S, T1, T2> implements Store.Subscriber<S> {
    ...
    TwoParamChangeSubscriber(Store.Selector<S, T1> selector, Store.Selector<S, T2> selector3, Store.Subscriber2<T1, T2> subscriber2) {
        this(selector, selector3, subscriber2, new Handler(Looper.getMainLooper()));
    }

    TwoParamChangeSubscriber(Store.Selector<S, T1> selector, Store.Selector<S, T2> selector3, Store.Subscriber2<T1, T2> subscriber2, Handler handler) {
        this.last1 = null;
        this.last2 = null;
