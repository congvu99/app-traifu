...
final class HomeScreenKt$HomeScreen$2$2$2 extends Lambda implements Function3<AnimatedVisibilityScope, Composer, Integer, Unit> {
    final /* synthetic */ HomeViewState $homeState;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HomeScreenKt$HomeScreen$2$2$2(HomeViewState homeViewState) {
        super(3);
    ...
    public final void invoke(AnimatedVisibilityScope animatedVisibilityScope, Composer composer, int i) {
        ...
        if (homeViewState instanceof HomeViewState.Error) {
            ...
            HomeErrorContentKt.HomeErrorContent(((HomeViewState.Error) homeViewState).getErrorState(), (Modifier) null, composer, 0, 2);
