...
final class ComposableSingletons$HomeErrorContentKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            HomeErrorContentKt.HomeErrorContent(new ErrorState.WithoutCTA(0, 0, (Integer) null, 7, (DefaultConstructorMarker) null), (Modifier) null, composer, 0, 2);
        } else {
