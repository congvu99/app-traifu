...
final class ComposableSingletons$NewConversationCardKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            NewConversationCardKt.NewConversationCard(new HomeCards.HomeNewConversationData("Get in touch", HomeCardType.NEW_CONVERSATION, new Action("Ask a question", IconType.BOT, "Usual reply time is a few minutes"), false, CollectionsKt.emptyList()), AnonymousClass1.INSTANCE, composer, 56);
            return;
        }
