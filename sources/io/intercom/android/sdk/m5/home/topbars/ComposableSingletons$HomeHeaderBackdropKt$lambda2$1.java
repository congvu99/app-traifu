...
final class ComposableSingletons$HomeHeaderBackdropKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            HomeHeaderBackdropKt.m5232HomeHeaderBackdroporJrPs(r6, new HeaderState.HeaderBackdropStyle.Gradient((List) arrayList, false), AnonymousClass2.INSTANCE, composer, 454);
            return;
        }
