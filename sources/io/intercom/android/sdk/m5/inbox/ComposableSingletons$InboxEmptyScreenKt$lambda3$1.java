...
final class ComposableSingletons$InboxEmptyScreenKt$lambda3$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            InboxEmptyScreenKt.InboxEmptyScreen(new EmptyState("No messages", "Messages from the team, queries and support tickets will be visible here", new EmptyState.Action(ActionType.HELP, "Browse our help articles", (IconType) null, 4, (DefaultConstructorMarker) null)), true, AnonymousClass1.INSTANCE, (Modifier) null, composer, 432, 8);
        } else {
