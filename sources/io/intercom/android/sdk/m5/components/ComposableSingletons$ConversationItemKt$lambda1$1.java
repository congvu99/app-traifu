...
final class ComposableSingletons$ConversationItemKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Conversation withRead = ConversationItemKt.sampleConversation$default((Ticket) null, 1, (Object) null).withRead(true);
            Intrinsics.checkNotNullExpressionValue(withRead, "sampleConversation().withRead(true)");
            float f = (float) 16;
