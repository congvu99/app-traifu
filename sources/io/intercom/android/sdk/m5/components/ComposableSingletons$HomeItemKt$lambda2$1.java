...
final class ComposableSingletons$HomeItemKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            HomeItemKt.HomeItem((Modifier) null, Integer.valueOf(R.drawable.intercom_messages_icon), (Integer) null, "Messages", (String) null, 3, (Function0<Unit>) null, composer, 199680, 85);
        } else {
