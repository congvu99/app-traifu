...
final class ComposableSingletons$ConversationItemKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            Conversation withRead = ConversationItemKt.sampleConversation(new Ticket("Feature request", (String) null, (String) null, (String) null, new Ticket.Status("Submitted", MetricTracker.Action.SUBMITTED, (String) null, false, 0, 28, (DefaultConstructorMarker) null), (List) null, (List) null, 0, (Participant.Builder) null, 494, (DefaultConstructorMarker) null)).withRead(true);
