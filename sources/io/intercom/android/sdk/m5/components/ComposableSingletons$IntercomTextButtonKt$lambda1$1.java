...
final class ComposableSingletons$IntercomTextButtonKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ComposableSingletons$IntercomTextButtonKt$lambda1$1() {
        super(2);
    }
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            IntercomTextButtonKt.IntercomTextButton("Button", (Modifier) null, (Integer) null, AnonymousClass1.INSTANCE, composer, 3078, 6);
        } else {
