...
final class ComposableSingletons$DayDividerKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            DayDividerKt.DayDivider("23 August", (Modifier) null, composer, 6, 2);
        } else {
