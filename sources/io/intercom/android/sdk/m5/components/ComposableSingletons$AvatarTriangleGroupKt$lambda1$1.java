...
final class ComposableSingletons$AvatarTriangleGroupKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            AvatarTriangleGroupKt.m5127AvatarTriangleGroupjt2gSs(CollectionsKt.listOf(Avatar.create("", "SK")), (Modifier) null, (Shape) null, 0.0f, composer, 8, 14);
        } else {
