...
/* renamed from: io.intercom.android.sdk.m5.components.ComposableSingletons$NewConversationCardKt$lambda-1$1  reason: invalid class name */
...
final class ComposableSingletons$NewConversationCardKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            NewConversationCardKt.NewConversationCard((Modifier) null, (Function0<Unit>) null, composer, 0, 3);
        } else {
