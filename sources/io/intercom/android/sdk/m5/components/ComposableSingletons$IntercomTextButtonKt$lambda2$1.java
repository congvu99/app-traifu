...
final class ComposableSingletons$IntercomTextButtonKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            IntercomTextButtonKt.IntercomTextButton("Button", (Modifier) null, Integer.valueOf(R.drawable.intercom_send), AnonymousClass1.INSTANCE, composer, 3078, 2);
        } else {
