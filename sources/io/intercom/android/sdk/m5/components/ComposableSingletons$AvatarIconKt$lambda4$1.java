...
/* renamed from: io.intercom.android.sdk.m5.components.ComposableSingletons$AvatarIconKt$lambda-4$1  reason: invalid class name */
/* compiled from: AvatarIcon.kt */
final class ComposableSingletons$AvatarIconKt$lambda4$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            AvatarIconKt.m5124AvatarIconRd90Nhg(create, SizeKt.m582size3ABfNKs(Modifier.Companion, Dp.m4704constructorimpl(f)), (Shape) null, true, 0, (Color) null, composer2, 3128, 52);
            ...
            AvatarIconKt.m5124AvatarIconRd90Nhg(create2, SizeKt.m582size3ABfNKs(Modifier.Companion, Dp.m4704constructorimpl(f)), (Shape) null, true, 0, (Color) null, composer2, 3128, 52);
