...
final class ComposableSingletons$AvatarGroupKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            AvatarGroupKt.m5121AvatarGroupJ8mCjc(CollectionsKt.listOf(Avatar.create("", "SK"), Avatar.create("", "RS"), Avatar.create("", "VR")), (Modifier) null, 0.0f, 0, composer, 8, 14);
            return;
        }
