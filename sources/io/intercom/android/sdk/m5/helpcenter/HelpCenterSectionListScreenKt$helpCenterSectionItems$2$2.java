...
final class HelpCenterSectionListScreenKt$helpCenterSectionItems$2$2 extends Lambda implements Function3<LazyItemScope, Composer, Integer, Unit> {
    final /* synthetic */ ArticleSectionRow $item;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HelpCenterSectionListScreenKt$helpCenterSectionItems$2$2(ArticleSectionRow articleSectionRow) {
        super(3);
    ...
    public final void invoke(LazyItemScope lazyItemScope, Composer composer, int i) {
        ...
        if ((i & 81) != 16 || !composer.getSkipping()) {
            SectionTitleComponentKt.SectionTitleComponent((ArticleSectionRow.SectionRow) this.$item, (Modifier) null, composer, 0, 2);
        } else {
