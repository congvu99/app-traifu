...
final class ComposableSingletons$CollectionRowComponentKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            CollectionRowComponentKt.CollectionRowComponent(new CollectionListRow.CollectionRow("", "Lorem Ipsum Dolor Sit", 0, "Lorem Ipsum Dolor Sit Lorem Ipsum Dolor Sit Lorem Ipsum Dolor Sit Lorem Ipsum Dolor Sit", 3), AnonymousClass1.INSTANCE, (Modifier) null, composer, 48, 4);
            return;
        }
