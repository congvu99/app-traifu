...
final class ComposableSingletons$SectionTitleComponentKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            SurfaceKt.m1419SurfaceFjzlyU((Modifier) null, (Shape) null, 0, 0, (BorderStroke) null, 0.0f, ComposableSingletons$SectionTitleComponentKt.INSTANCE.m5207getLambda1$intercom_sdk_base_release(), composer, 1572864, 63);
        } else {
