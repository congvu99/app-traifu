...
final class BrowseAllHelpTopicsComponentKt$BrowseAllHelpTopicsComponent$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrowseAllHelpTopicsComponentKt$BrowseAllHelpTopicsComponent$1(Context context) {
        super(0);
