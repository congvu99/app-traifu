...
final class ComposableSingletons$HelpCenterErrorScreenKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            HelpCenterErrorScreenKt.HelpCenterErrorScreen(new ErrorState.WithCTA(0, 0, (Integer) null, 0, AnonymousClass1.INSTANCE, 15, (DefaultConstructorMarker) null), (Modifier) null, composer, 0, 2);
        } else {
