...
final class IntercomStickyBottomSheetKt$IntercomStickyBottomSheet$2$2$1 extends Lambda implements Function1<LayoutCoordinates, Unit> {
    final /* synthetic */ MutableState<Float> $sheetHeightAsState;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    IntercomStickyBottomSheetKt$IntercomStickyBottomSheet$2$2$1(MutableState<Float> mutableState) {
        super(1);
