...
final class ComposableSingletons$ChoicePillKt$lambda3$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ChoicePillKt.m5322ChoicePillUdaoDFU(true, (Function1<? super String, Unit>) null, "Option 1", 0, 0.0f, Color.Companion.m1959getBlue0d7_KjU(), (FontWeight) null, 0, composer, 196998, JfifUtil.MARKER_SOS);
        } else {
