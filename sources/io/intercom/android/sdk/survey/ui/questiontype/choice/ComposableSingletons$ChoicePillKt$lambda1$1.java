...
final class ComposableSingletons$ChoicePillKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ChoicePillKt.m5322ChoicePillUdaoDFU(false, (Function1<? super String, Unit>) null, "Option 1", 0, 0.0f, 0, (FontWeight) null, 0, composer, 390, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION);
        } else {
