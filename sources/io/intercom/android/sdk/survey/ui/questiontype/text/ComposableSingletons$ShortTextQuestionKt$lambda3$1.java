...
final class ComposableSingletons$ShortTextQuestionKt$lambda3$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            SurveyData.Step.Question.ShortTextQuestionModel shortTextQuestionModel = new SurveyData.Step.Question.ShortTextQuestionModel(uuid, listOf, true, "Placeholder text", validationType, Integer.valueOf(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION), false, (Integer) null, JfifUtil.MARKER_SOFn, (DefaultConstructorMarker) null);
