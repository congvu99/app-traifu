...
final class ComposableSingletons$TicketTimelineCardKt$lambda3$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 11) != 2 || !composer.getSkipping()) {
            TicketTimelineCardKt.TicketTimelineCard(TicketTimelineCardState.m5383copyBx497Mc$default(TicketTimelineCardKt.getSampleTicketTimelineCardState(), (List) null, (String) null, (String) null, TicketStatus.Resolved.m5382getColor0d7_KjU(), CollectionsKt.listOf(new TicketTimelineCardState.ProgressSection(true, new TicketTimelineCardState.ActualStringOrRes.ActualString("Submitted"), 1634889351, false), new TicketTimelineCardState.ProgressSection(true, new TicketTimelineCardState.ActualStringOrRes.ActualString("In progress"), 1644477950, false), new TicketTimelineCardState.ProgressSection(true, new TicketTimelineCardState.ActualStringOrRes.ActualString("Resolved"), Calendar.getInstance().getTimeInMillis(), true)), (Integer) null, 39, (Object) null), BackgroundKt.m177backgroundbw27NRU$default(Modifier.Companion, MaterialTheme.INSTANCE.getColors(composer2, 8).m1218getSurface0d7_KjU(), (Shape) null, 2, (Object) null), composer2, 8, 0);
            return;
        }
