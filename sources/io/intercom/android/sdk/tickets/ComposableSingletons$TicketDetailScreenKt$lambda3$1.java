...
final class ComposableSingletons$TicketDetailScreenKt$lambda3$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            TicketDetailScreenKt.TicketDetailScreen(TicketDetailScreenKt.getSampleTicketDetailState(), (Function0<Unit>) null, false, composer, 8, 6);
        } else {
