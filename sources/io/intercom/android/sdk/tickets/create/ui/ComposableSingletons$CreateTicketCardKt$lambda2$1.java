...
final class ComposableSingletons$CreateTicketCardKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            CreateTicketCardKt.CreateTicketCard(fillMaxWidth$default, new BlockRenderData(access$getSampleBlock$p, (Color) null, 0, 0, (FontWeight) null, (Color) null, 0, 0, (FontWeight) null, (Color) null, 0, 2046, (DefaultConstructorMarker) null), false, composer, 454, 0);
            return;
        }
