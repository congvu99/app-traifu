...
final class ComposableSingletons$TicketDetailScreenKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            TicketDetailScreenKt.TicketSubmissionCard((Modifier) null, composer, 0, 1);
        } else {
