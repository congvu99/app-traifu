...
public final class HelpCenterArticleSearchResponse$Highlight$$serializer implements GeneratedSerializer<HelpCenterArticleSearchResponse.Highlight> {
    ...
    public HelpCenterArticleSearchResponse.Highlight deserialize(Decoder decoder) {
        ...
        return new HelpCenterArticleSearchResponse.Highlight(i, str2, str, (SerializationConstructorMarker) null);
    }

    public void serialize(Encoder encoder, HelpCenterArticleSearchResponse.Highlight highlight) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(highlight, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        HelpCenterArticleSearchResponse.Highlight.write$Self(highlight, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
