...
public final class HelpCenterArticle$$serializer implements GeneratedSerializer<HelpCenterArticle> {
    ...
    public HelpCenterArticle deserialize(Decoder decoder) {
        ...
        return new HelpCenterArticle(i, str2, str, (SerializationConstructorMarker) null);
    }

    public void serialize(Encoder encoder, HelpCenterArticle helpCenterArticle) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(helpCenterArticle, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        HelpCenterArticle.write$Self(helpCenterArticle, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
