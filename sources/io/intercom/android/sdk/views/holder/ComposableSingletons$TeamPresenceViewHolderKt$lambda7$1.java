...
final class ComposableSingletons$TeamPresenceViewHolderKt$lambda7$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 11) != 2 || !composer.getSkipping()) {
            ...
            TeamPresenceViewHolderKt.TeamPresenceAvatars(TeamPresenceViewHolderKt.getAdminTeamPresence(create, "Anna", "Job Title", "London", "UK", "This is the teamates bio description that wraps onto two lines", (GroupParticipants) null, create2), composer, 8);
            return;
        }
