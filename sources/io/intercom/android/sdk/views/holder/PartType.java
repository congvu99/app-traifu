...
public @interface PartType {
    ...
    public static final int BIG_TICKET = 19;
    public static final int COMPOSER_SUGGESTIONS = 16;
    ...
    public static final int TEAM_PRESENCE = 20;
    public static final int TEMPORARY_EXPECTATIONS_MESSAGE = 17;
    public static final int TICKET_STATUS_MESSAGE_UPDATED = 18;
