...
public final class IntercomErrorInboxBinding implements ViewBinding {
    ...
    private IntercomErrorInboxBinding(IntercomErrorView intercomErrorView, Button button, TextView textView, TextView textView2, IntercomErrorView intercomErrorView2) {
    ...
    public static IntercomErrorInboxBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static IntercomErrorInboxBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
    ...
    public static IntercomErrorInboxBinding bind(View view) {
