...
public class BlockUtils {
    ...
    public static void setMarginBottom(View view, int i) {
        ((ViewGroup.MarginLayoutParams) view.getLayoutParams()).bottomMargin = ScreenUtils.dpToPx((float) i, view.getContext());
    }

    public static void setMarginLeft(View view, int i) {
        ((ViewGroup.MarginLayoutParams) view.getLayoutParams()).setMarginStart(ScreenUtils.dpToPx((float) i, view.getContext()));
    }
    ...
    private static void setLineSpacing(TextView textView, int i) {
        textView.setLineSpacing((float) ScreenUtils.dpToPx((float) i, textView.getContext()), 1.0f);
    }
