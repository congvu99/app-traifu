...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0058, code lost:
        if (r7 != kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()) goto L_0x0066;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0068, code lost:
        if ((r7 instanceof kotlinx.coroutines.channels.Closed) == false) goto L_0x006d;
     */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        /*
            ...
            r0.lock()
            int r1 = r8.size     // Catch:{ all -> 0x00ce }
            if (r1 != 0) goto L_0x0017
            kotlinx.coroutines.channels.Closed r9 = r8.getClosedForSend()     // Catch:{ all -> 0x00ce }
        ...
        L_0x0013:
            ...
            return r9
        L_0x0017:
            java.lang.Object[] r2 = r8.buffer     // Catch:{ all -> 0x00ce }
            int r3 = r8.head     // Catch:{ all -> 0x00ce }
            r2 = r2[r3]     // Catch:{ all -> 0x00ce }
            java.lang.Object[] r3 = r8.buffer     // Catch:{ all -> 0x00ce }
            int r4 = r8.head     // Catch:{ all -> 0x00ce }
            r5 = 0
            r3[r4] = r5     // Catch:{ all -> 0x00ce }
            int r3 = r1 + -1
            r8.size = r3     // Catch:{ all -> 0x00ce }
            kotlinx.coroutines.internal.Symbol r3 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00ce }
            int r4 = r8.capacity     // Catch:{ all -> 0x00ce }
            r6 = 1
            if (r1 != r4) goto L_0x0088
        L_0x002f:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r4 = r8.describeTryPoll()     // Catch:{ all -> 0x00ce }
            r7 = r4
            kotlinx.coroutines.internal.AtomicDesc r7 = (kotlinx.coroutines.internal.AtomicDesc) r7     // Catch:{ all -> 0x00ce }
            java.lang.Object r7 = r9.performAtomicTrySelect(r7)     // Catch:{ all -> 0x00ce }
            if (r7 != 0) goto L_0x004c
            java.lang.Object r5 = r4.getResult()     // Catch:{ all -> 0x00ce }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r5)     // Catch:{ all -> 0x00ce }
            r3 = r5
            kotlinx.coroutines.channels.Send r3 = (kotlinx.coroutines.channels.Send) r3     // Catch:{ all -> 0x00ce }
            java.lang.Object r3 = r3.getPollResult()     // Catch:{ all -> 0x00ce }
        L_0x004a:
            r4 = 1
            goto L_0x0089
        L_0x004c:
            kotlinx.coroutines.internal.Symbol r4 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00ce }
            if (r7 == r4) goto L_0x0088
            java.lang.Object r4 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00ce }
            if (r7 == r4) goto L_0x002f
            java.lang.Object r3 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00ce }
            if (r7 != r3) goto L_0x0066
            r8.size = r1     // Catch:{ all -> 0x00ce }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00ce }
            int r1 = r8.head     // Catch:{ all -> 0x00ce }
            r9[r1] = r2     // Catch:{ all -> 0x00ce }
            r0.unlock()
            return r7
        L_0x0066:
            boolean r3 = r7 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00ce }
            if (r3 == 0) goto L_0x006d
            r3 = r7
            r5 = r3
            goto L_0x004a
        L_0x006d:
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00ce }
            ...
            r1.append(r7)     // Catch:{ all -> 0x00ce }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x00ce }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x00ce }
            r9.<init>(r1)     // Catch:{ all -> 0x00ce }
            throw r9     // Catch:{ all -> 0x00ce }
        L_0x0088:
            r4 = 0
        L_0x0089:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00ce }
            if (r3 == r7) goto L_0x009f
            boolean r7 = r3 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00ce }
            if (r7 != 0) goto L_0x009f
            r8.size = r1     // Catch:{ all -> 0x00ce }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00ce }
            int r7 = r8.head     // Catch:{ all -> 0x00ce }
            int r7 = r7 + r1
            java.lang.Object[] r1 = r8.buffer     // Catch:{ all -> 0x00ce }
            int r1 = r1.length     // Catch:{ all -> 0x00ce }
            int r7 = r7 % r1
            r9[r7] = r3     // Catch:{ all -> 0x00ce }
            goto L_0x00b5
        L_0x009f:
            boolean r9 = r9.trySelect()     // Catch:{ all -> 0x00ce }
            ...
            return r9
        L_0x00b5:
            int r9 = r8.head     // Catch:{ all -> 0x00ce }
            int r9 = r9 + r6
            java.lang.Object[] r1 = r8.buffer     // Catch:{ all -> 0x00ce }
            int r1 = r1.length     // Catch:{ all -> 0x00ce }
            int r9 = r9 % r1
            r8.head = r9     // Catch:{ all -> 0x00ce }
