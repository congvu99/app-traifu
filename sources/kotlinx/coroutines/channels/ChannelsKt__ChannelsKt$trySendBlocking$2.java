    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m5428constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m5428constructorimpl(Unit.INSTANCE);
        if (Result.m5435isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m6947successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m6945closedJP2dKIU(Result.m5431exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m6932boximpl(obj3);
    }
}
