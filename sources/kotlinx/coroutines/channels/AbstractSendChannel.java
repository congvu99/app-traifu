...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object m6923trySendJP2dKIU(E e) {
        Object offerInternal = offerInternal(e);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m6947successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            return ChannelResult.Companion.m6945closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m6945closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            ...
            continuation.resumeWith(Result.m5428constructorimpl(ResultKt.createFailure(sendException)));
            return;
        }
        Throwable th = callUndeliveredElementCatchingException$default;
        ExceptionsKt.addSuppressed(th, sendException);
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m5428constructorimpl(ResultKt.createFailure(th)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m6970constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m6975plusFjFbRPM(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + '@' + DebugStringsKt.getHexAddress(this) + JsonLexerKt.BEGIN_OBJ + getQueueDebugStateString() + JsonLexerKt.END_OBJ + getBufferDebugString();
    }
    ...
    private static final class SendSelect<E, R> extends Send implements DisposableHandle {
        ...
        public String toString() {
            return "SendSelect@" + DebugStringsKt.getHexAddress(this) + '(' + getPollResult() + ")[" + this.channel + ", " + this.select + JsonLexerKt.END_LIST;
        }
    }
