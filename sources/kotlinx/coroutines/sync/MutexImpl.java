...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    private static final class LockedQueue extends LockFreeLinkedListHead {
        ...
        public String toString() {
            return "LockedQueue[" + this.owner + JsonLexerKt.END_LIST;
        }
    }
    ...
    public String toString() {
        while (true) {
            Object obj = this._state;
            if (obj instanceof Empty) {
                return "Mutex[" + ((Empty) obj).locked + JsonLexerKt.END_LIST;
            } else if (obj instanceof OpDescriptor) {
                ((OpDescriptor) obj).perform(this);
            } else if (obj instanceof LockedQueue) {
                return "Mutex[" + ((LockedQueue) obj).owner + JsonLexerKt.END_LIST;
            } else {
                throw new IllegalStateException(("Illegal state " + obj).toString());
            }
        }
