...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    public final String toDebugString() {
        return nameString$kotlinx_coroutines_core() + JsonLexerKt.BEGIN_OBJ + stateString(getState$kotlinx_coroutines_core()) + JsonLexerKt.END_OBJ;
    }
    ...
    private static final class Finishing implements Incomplete {
        ...
        public String toString() {
            return "Finishing[cancelling=" + isCancelling() + ", completing=" + isCompleting() + ", rootCause=" + getRootCause() + ", exceptions=" + getExceptionsHolder() + ", list=" + getList() + JsonLexerKt.END_LIST;
        }
    }
