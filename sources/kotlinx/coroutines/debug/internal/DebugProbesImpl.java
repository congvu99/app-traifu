...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m5428constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
                if (Result.m5434isFailureimpl(obj)) {
                    obj = null;
                }
            ...
            obj = Result.m5428constructorimpl(ResultKt.createFailure(th));
        }
    }
    ...
    public final void install() {
        ...
        L_0x0052:
            ...
            java.lang.Boolean r5 = java.lang.Boolean.valueOf(r5)     // Catch:{ all -> 0x006b }
    ...
    public final void uninstall() {
        ...
        L_0x001c:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0089 }
            boolean r4 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0089 }
            if (r4 == 0) goto L_0x007d
            int r4 = installations     // Catch:{ all -> 0x0089 }
            int r4 = r4 + -1
            installations = r4     // Catch:{ all -> 0x0089 }
            int r4 = installations     // Catch:{ all -> 0x0089 }
        ...
        L_0x0041:
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0089 }
            r4.stopWeakRefCleanerThread()     // Catch:{ all -> 0x0089 }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner<?>, java.lang.Boolean> r4 = capturedCoroutinesMap     // Catch:{ all -> 0x0089 }
            r4.clear()     // Catch:{ all -> 0x0089 }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlin.coroutines.jvm.internal.CoroutineStackFrame, kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl> r4 = callerInfoCache     // Catch:{ all -> 0x0089 }
            r4.clear()     // Catch:{ all -> 0x0089 }
            kotlinx.coroutines.debug.internal.AgentInstallationType r4 = kotlinx.coroutines.debug.internal.AgentInstallationType.INSTANCE     // Catch:{ all -> 0x0089 }
            boolean r4 = r4.isInstalledStatically$kotlinx_coroutines_core()     // Catch:{ all -> 0x0089 }
        ...
        L_0x0060:
            ...
            return
        L_0x0064:
            kotlin.jvm.functions.Function1<java.lang.Boolean, kotlin.Unit> r4 = dynamicAttach     // Catch:{ all -> 0x0089 }
            if (r4 == 0) goto L_0x006f
            java.lang.Boolean r5 = java.lang.Boolean.valueOf(r3)     // Catch:{ all -> 0x0089 }
            r4.invoke(r5)     // Catch:{ all -> 0x0089 }
        L_0x006f:
        ...
        L_0x007d:
            ...
            java.lang.IllegalStateException r5 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0089 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0089 }
            r5.<init>(r4)     // Catch:{ all -> 0x0089 }
    ...
    public final java.lang.String hierarchyToString(kotlinx.coroutines.Job r10) {
        ...
        L_0x001c:
            ...
            boolean r4 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x00cf }
    ...
    private final <R> java.util.List<R> dumpCoroutinesInfoImpl(kotlin.jvm.functions.Function2<? super kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner<?>, ? super kotlin.coroutines.CoroutineContext, ? extends R> r8) {
        ...
        L_0x001c:
            ...
            boolean r5 = r5.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0070 }
            if (r5 == 0) goto L_0x0064
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0070 }
            java.util.Set r5 = r5.getCapturedCoroutines()     // Catch:{ all -> 0x0070 }
            java.lang.Iterable r5 = (java.lang.Iterable) r5     // Catch:{ all -> 0x0070 }
            kotlin.sequences.Sequence r5 = kotlin.collections.CollectionsKt.asSequence(r5)     // Catch:{ all -> 0x0070 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$lambda-12$$inlined$sortedBy$1 r6 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$lambda-12$$inlined$sortedBy$1     // Catch:{ all -> 0x0070 }
            r6.<init>()     // Catch:{ all -> 0x0070 }
            java.util.Comparator r6 = (java.util.Comparator) r6     // Catch:{ all -> 0x0070 }
            kotlin.sequences.Sequence r5 = kotlin.sequences.SequencesKt.sortedWith(r5, r6)     // Catch:{ all -> 0x0070 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$1$3 r6 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$1$3     // Catch:{ all -> 0x0070 }
            r6.<init>(r8)     // Catch:{ all -> 0x0070 }
            kotlin.jvm.functions.Function1 r6 = (kotlin.jvm.functions.Function1) r6     // Catch:{ all -> 0x0070 }
            kotlin.sequences.Sequence r8 = kotlin.sequences.SequencesKt.mapNotNull(r5, r6)     // Catch:{ all -> 0x0070 }
            java.util.List r8 = kotlin.sequences.SequencesKt.toList(r8)     // Catch:{ all -> 0x0070 }
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo debugCoroutineInfo) {
        ...
        return JsonLexerKt.BEGIN_LIST + CollectionsKt.joinToString$default(arrayList, (CharSequence) null, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 63, (Object) null) + JsonLexerKt.END_LIST;
    }
    ...
    private final void dumpCoroutinesSynchronized(java.io.PrintStream r13) {
        ...
        L_0x001c:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0120 }
            boolean r4 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0120 }
            ...
            java.text.SimpleDateFormat r5 = dateFormat     // Catch:{ all -> 0x0120 }
            long r6 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0120 }
            java.lang.Long r6 = java.lang.Long.valueOf(r6)     // Catch:{ all -> 0x0120 }
            java.lang.String r5 = r5.format(r6)     // Catch:{ all -> 0x0120 }
            r4.append(r5)     // Catch:{ all -> 0x0120 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0120 }
            r13.print(r4)     // Catch:{ all -> 0x0120 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0120 }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x0120 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0120 }
            kotlin.sequences.Sequence r4 = kotlin.collections.CollectionsKt.asSequence(r4)     // Catch:{ all -> 0x0120 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2 r5 = kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2.INSTANCE     // Catch:{ all -> 0x0120 }
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch:{ all -> 0x0120 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.filter(r4, r5)     // Catch:{ all -> 0x0120 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1     // Catch:{ all -> 0x0120 }
            r5.<init>()     // Catch:{ all -> 0x0120 }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x0120 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.sortedWith(r4, r5)     // Catch:{ all -> 0x0120 }
        ...
        L_0x0070:
            ...
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r5 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r5     // Catch:{ all -> 0x0120 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r5.info     // Catch:{ all -> 0x0120 }
            java.util.List r7 = r6.lastObservedStackTrace()     // Catch:{ all -> 0x0120 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r8 = INSTANCE     // Catch:{ all -> 0x0120 }
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x0120 }
            java.lang.Thread r10 = r6.lastObservedThread     // Catch:{ all -> 0x0120 }
            java.util.List r8 = r8.enhanceStackTraceWithThreadDumpImpl(r9, r10, r7)     // Catch:{ all -> 0x0120 }
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x0120 }
            java.lang.String r10 = "RUNNING"
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r10)     // Catch:{ all -> 0x0120 }
            if (r9 == 0) goto L_0x00b2
            if (r8 != r7) goto L_0x00b2
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x0120 }
            r9.<init>()     // Catch:{ all -> 0x0120 }
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x0120 }
            r9.append(r10)     // Catch:{ all -> 0x0120 }
        ...
        L_0x00b6:
            ...
            kotlin.coroutines.Continuation<T> r5 = r5.delegate     // Catch:{ all -> 0x0120 }
            r10.append(r5)     // Catch:{ all -> 0x0120 }
            java.lang.String r5 = ", state: "
            r10.append(r5)     // Catch:{ all -> 0x0120 }
            r10.append(r9)     // Catch:{ all -> 0x0120 }
            java.lang.String r5 = r10.toString()     // Catch:{ all -> 0x0120 }
            r13.print(r5)     // Catch:{ all -> 0x0120 }
            boolean r5 = r7.isEmpty()     // Catch:{ all -> 0x0120 }
            if (r5 == 0) goto L_0x00ff
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0120 }
            r5.<init>()     // Catch:{ all -> 0x0120 }
            java.lang.String r7 = "\n\tat "
            r5.append(r7)     // Catch:{ all -> 0x0120 }
            java.lang.String r7 = "Coroutine creation stacktrace"
            java.lang.StackTraceElement r7 = kotlinx.coroutines.internal.StackTraceRecoveryKt.artificialFrame(r7)     // Catch:{ all -> 0x0120 }
            r5.append(r7)     // Catch:{ all -> 0x0120 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0120 }
            r13.print(r5)     // Catch:{ all -> 0x0120 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0120 }
            java.util.List r6 = r6.getCreationStackTrace()     // Catch:{ all -> 0x0120 }
            r5.printStackTrace(r13, r6)     // Catch:{ all -> 0x0120 }
            goto L_0x0070
        L_0x00ff:
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0120 }
            r5.printStackTrace(r13, r8)     // Catch:{ all -> 0x0120 }
            goto L_0x0070
        L_0x0106:
            kotlin.Unit r13 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0120 }
        L_0x0108:
        ...
        L_0x0114:
            ...
            java.lang.IllegalStateException r4 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0120 }
            java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x0120 }
            r4.<init>(r13)     // Catch:{ all -> 0x0120 }
            throw r4     // Catch:{ all -> 0x0120 }
        L_0x0120:
            r13 = move-exception
        L_0x0121:
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            obj = Result.m5428constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m5428constructorimpl(ResultKt.createFailure(th));
        }
    ...
    public final java.util.List<kotlinx.coroutines.debug.internal.DebugCoroutineInfo> dumpCoroutinesInfo() {
        ...
        L_0x001c:
            ...
            boolean r4 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0069 }
            if (r4 == 0) goto L_0x005d
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0069 }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x0069 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0069 }
            kotlin.sequences.Sequence r4 = kotlin.collections.CollectionsKt.asSequence(r4)     // Catch:{ all -> 0x0069 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$lambda-12$$inlined$sortedBy$1 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$lambda-12$$inlined$sortedBy$1     // Catch:{ all -> 0x0069 }
            r5.<init>()     // Catch:{ all -> 0x0069 }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x0069 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.sortedWith(r4, r5)     // Catch:{ all -> 0x0069 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfo$$inlined$dumpCoroutinesInfoImpl$1 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfo$$inlined$dumpCoroutinesInfoImpl$1     // Catch:{ all -> 0x0069 }
            r5.<init>()     // Catch:{ all -> 0x0069 }
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch:{ all -> 0x0069 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.mapNotNull(r4, r5)     // Catch:{ all -> 0x0069 }
            java.util.List r4 = kotlin.sequences.SequencesKt.toList(r4)     // Catch:{ all -> 0x0069 }
        L_0x0051:
        ...
        L_0x005d:
            ...
            java.lang.IllegalStateException r5 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0069 }
    ...
    public final java.util.List<kotlinx.coroutines.debug.internal.DebuggerInfo> dumpDebuggerInfo() {
        ...
        L_0x001c:
            ...
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x0069 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.sortedWith(r4, r5)     // Catch:{ all -> 0x0069 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpDebuggerInfo$$inlined$dumpCoroutinesInfoImpl$1 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpDebuggerInfo$$inlined$dumpCoroutinesInfoImpl$1     // Catch:{ all -> 0x0069 }
            r5.<init>()     // Catch:{ all -> 0x0069 }
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch:{ all -> 0x0069 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.mapNotNull(r4, r5)     // Catch:{ all -> 0x0069 }
            java.util.List r4 = kotlin.sequences.SequencesKt.toList(r4)     // Catch:{ all -> 0x0069 }
