...
public final class DelayKt {
    ...
    public static final Object m6913delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6914toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6914toDelayMillisLRDsOJo(long j) {
        if (Duration.m6748compareToLRDsOJo(j, Duration.Companion.m6851getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6767getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
