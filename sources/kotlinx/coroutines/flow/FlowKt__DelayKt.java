...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m6960debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m6914toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m6961sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m6914toDelayMillisLRDsOJo(j));
    }
}
