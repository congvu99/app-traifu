...
public final class ContextualSerializer<T> implements KSerializer<T> {
    ...
    public ContextualSerializer(KClass<T> kClass, KSerializer<T> kSerializer, KSerializer<?>[] kSerializerArr) {
        ...
        this.descriptor = ContextAwareKt.withContext(SerialDescriptorsKt.buildSerialDescriptor$default("kotlinx.serialization.ContextualSerializer", SerialKind.CONTEXTUAL.INSTANCE, new SerialDescriptor[0], (Function1) null, 8, (Object) null), this.serializableClass);
    }
