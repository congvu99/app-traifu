...
public class PluginGeneratedSerialDescriptor implements SerialDescriptor, CachedNames {
    ...
    public PluginGeneratedSerialDescriptor(String str, GeneratedSerializer<?> generatedSerializer2, int i) {
        ...
        this.childSerializers$delegate = LazyKt.lazy(new PluginGeneratedSerialDescriptor$childSerializers$2(this));
        this.typeParameterDescriptors$delegate = LazyKt.lazy(new PluginGeneratedSerialDescriptor$typeParameterDescriptors$2(this));
        this._hashCode$delegate = LazyKt.lazy(new PluginGeneratedSerialDescriptor$_hashCode$2(this));
    }
