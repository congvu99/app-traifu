...
public abstract class Json implements StringFormat {
    ...
    public static final class Default extends Json {
        ...
        private Default() {
            super(new JsonConfiguration(false, false, false, false, false, (String) null, false, false, (String) null, false, false, 2047, (DefaultConstructorMarker) null), SerializersModuleKt.getEmptySerializersModule(), (DefaultConstructorMarker) null);
        }
    }
    ...
    public final <T> T decodeFromString(DeserializationStrategy<T> deserializationStrategy, String str) {
        ...
        T decodeSerializableValue = new StreamingJsonDecoder(this, WriteMode.OBJ, jsonLexer).decodeSerializableValue(deserializationStrategy);
        jsonLexer.expectEof();
