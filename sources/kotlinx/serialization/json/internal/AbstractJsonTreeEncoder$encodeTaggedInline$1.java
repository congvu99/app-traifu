...
public final class AbstractJsonTreeEncoder$encodeTaggedInline$1 extends AbstractEncoder {
    ...
    public void encodeInt(int i) {
        putUnquotedString(UInt.m5567toStringimpl(UInt.m5522constructorimpl(i)));
    }

    public void encodeLong(long j) {
        putUnquotedString(ULong.m5645toStringimpl(ULong.m5600constructorimpl(j)));
    }

    public void encodeByte(byte b) {
        putUnquotedString(UByte.m5489toStringimpl(UByte.m5446constructorimpl(b)));
    }

    public void encodeShort(short s) {
        putUnquotedString(UShort.m5749toStringimpl(UShort.m5706constructorimpl(s)));
    }
}
