...
public final class _PathKt {
    ...
    public static final Path toPath(Buffer buffer, boolean z) {
        ...
        int i2 = 0;
        while (true) {
            if (!buffer.rangeEquals(0, SLASH) && !buffer.rangeEquals(0, BACKSLASH)) {
                break;
            }
        ...
        boolean z2 = i2 >= 2 && Intrinsics.areEqual((Object) byteString2, (Object) BACKSLASH);
        if (z2) {
        ...
        while (!buffer.exhausted()) {
            ...
            if (indexOfElement2 == -1) {
                ...
                byteString = buffer.readByteString(indexOfElement2);
                buffer.readByte();
            }
            if (Intrinsics.areEqual((Object) byteString, (Object) DOT_DOT)) {
                if (!z3 || !arrayList.isEmpty()) {
                    if (!z || (!z3 && (arrayList.isEmpty() || Intrinsics.areEqual(CollectionsKt.last(arrayList), (Object) DOT_DOT)))) {
                        arrayList.add(byteString);
                    } else if (!z2 || arrayList.size() != 1) {
                        CollectionsKt.removeLastOrNull(arrayList);
                    }
                }
            } else if (!Intrinsics.areEqual((Object) byteString, (Object) DOT) && !Intrinsics.areEqual((Object) byteString, (Object) ByteString.EMPTY)) {
                arrayList.add(byteString);
            }
        }
