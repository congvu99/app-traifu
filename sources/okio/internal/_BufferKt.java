...
public final class _BufferKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x0096, code lost:
        r0.setSize$okio(r17.size() - ((long) r5));
     */
    ...
    public static final long commonReadHexadecimalUnsignedLong(okio.Buffer r15) {
        ...
        L_0x0079:
            ...
            java.lang.String r0 = okio._UtilKt.toHexString((byte) r10)
    ...
    public static final long commonIndexOf(Buffer buffer, byte b, long j, long j2) {
        ...
        if (z) {
            ...
            if (segment == null) {
                ...
                while (size < j6) {
                    byte[] bArr = segment.data;
                    int min = (int) Math.min((long) segment.limit, (((long) segment.pos) + j6) - size);
                ...
                while (j5 < j6) {
                    byte[] bArr2 = segment.data;
                    int min2 = (int) Math.min((long) segment.limit, (((long) segment.pos) + j6) - j5);
                    for (int i2 = (int) ((((long) segment.pos) + j3) - j5); i2 < min2; i2++) {
                        if (bArr2[i2] == b2) {
            ...
            if (j >= 0) {
                ...
                if (segment == null) {
                    ...
                    while (j4 < size3) {
                        ...
                        int min = (int) Math.min((long) segment3.limit, (((long) segment3.pos) + size3) - j4);
                        Segment segment5 = segment4;
                        int i = (int) ((((long) segment5.pos) + j5) - j4);
                        if (i < min) {
                            while (true) {
                                int i2 = i + 1;
                                if (bArr[i] == b && rangeEquals(segment5, i2, internalArray$okio, 1, size2)) {
                    ...
                    while (j7 < size5) {
                        ...
                        long j9 = size5;
                        int min2 = (int) Math.min((long) segment6.limit, (((long) segment6.pos) + size5) - j7);
                        int i3 = (int) ((((long) segment6.pos) + j8) - j7);
                        if (i3 < min2) {
                            while (true) {
                                int i4 = i3 + 1;
                                if (bArr2[i3] == b2) {
                                    if (rangeEquals(segment6, i4, internalArray$okio2, 1, size4)) {
                                        return ((long) (i3 - segment6.pos)) + j7;
                                    }
                                }
                                if (i4 >= min2) {
                                    break;
                        ...
                        j7 += (long) (segment6.limit - segment6.pos);
                        segment6 = segment6.next;
                        Intrinsics.checkNotNull(segment6);
                        size5 = j9;
                        j8 = j7;
                    }
    ...
    public static final boolean commonRangeEquals(Buffer buffer, long j, ByteString byteString, int i, int i2) {
        ...
        while (true) {
            int i4 = i3 + 1;
            if (buffer.getByte(((long) i3) + j) != byteString.getByte(i3 + i)) {
                return false;
            }
            if (i4 >= i2) {
                return true;
