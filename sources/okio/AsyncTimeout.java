    ...
    private static final class Watchdog extends Thread {
        ...
        public void run() {
            ...
            L_0x0000:
                ...
                okio.AsyncTimeout$Companion r1 = okio.AsyncTimeout.Companion     // Catch:{ all -> 0x0021 }
                okio.AsyncTimeout r1 = r1.awaitTimeout$okio()     // Catch:{ all -> 0x0021 }
                okio.AsyncTimeout r2 = okio.AsyncTimeout.head     // Catch:{ all -> 0x0021 }
                if (r1 != r2) goto L_0x0017
                okio.AsyncTimeout$Companion r1 = okio.AsyncTimeout.Companion     // Catch:{ all -> 0x0021 }
                r1 = 0
                okio.AsyncTimeout.head = r1     // Catch:{ all -> 0x0021 }
    ...
    public static final class Companion {
        ...
        public final AsyncTimeout awaitTimeout$okio() throws InterruptedException {
            ...
            if (access$remainingNanos > 0) {
                long j = access$remainingNanos / AnimationKt.MillisToNanos;
                AsyncTimeout.class.wait(j, (int) (access$remainingNanos - (AnimationKt.MillisToNanos * j)));
                return null;
            }
