...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer readFrom(InputStream inputStream) throws IOException {
        Intrinsics.checkNotNullParameter(inputStream, MetricTracker.Object.INPUT);
    ...
    public final byte m7133deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m7134deprecated_size() {
        return this.size;
    }
    ...
    public long indexOf(byte b, long j, long j2) {
        ...
        if (z) {
            ...
            if (size() - j4 < j4) {
                ...
                while (j3 < j7) {
                    byte[] bArr = segment.data;
                    int min = (int) Math.min((long) segment.limit, (((long) segment.pos) + j7) - j3);
                    i = (int) ((((long) segment.pos) + j4) - j3);
                    while (i < min) {
                        if (bArr[i] != b2) {
                            i++;
                        }
            ...
            while (j3 < j7) {
                ...
                int min2 = (int) Math.min((long) segment.limit, (((long) segment.pos) + j7) - j3);
                ...
                j6 = j3 + ((long) (segment.limit - segment.pos));
                segment = segment.next;
                Intrinsics.checkNotNull(segment);
                j4 = j6;
            }
                ...
                if (segment == null) {
                    ...
                    if (segment != null) {
                        ...
                        while (j3 < size4) {
                            ...
                            long j5 = j4;
                            int min = (int) Math.min((long) segment3.limit, (((long) segment3.pos) + size4) - j3);
                            int i = (int) ((((long) segment3.pos) + j5) - j3);
                            if (i < min) {
                                while (true) {
                                    int i2 = i + 1;
                                    if (bArr[i] == b && _BufferKt.rangeEquals(segment3, i2, internalArray$okio, 1, size3)) {
                    ...
                    if (segment != null) {
                        ...
                        while (j7 < size6) {
                            byte[] bArr2 = segment.data;
                            long j9 = size6;
                            int min2 = (int) Math.min((long) segment.limit, (((long) segment.pos) + size6) - j7);
                            int i3 = (int) ((((long) segment.pos) + j8) - j7);
                            if (i3 < min2) {
                                while (true) {
                                    int i4 = i3 + 1;
                                    if (bArr2[i3] == b2 && _BufferKt.rangeEquals(segment, i4, internalArray$okio2, 1, size5)) {
                                        return ((long) (i3 - segment.pos)) + j7;
                                    }
                                    if (i4 >= min2) {
                                        break;
                                    }
    ...
    public boolean rangeEquals(long j, ByteString byteString, int i, int i2) {
        ...
        if (i2 > 0) {
            ...
            while (true) {
                int i4 = i3 + 1;
                if (getByte(((long) i3) + j) != byteString.getByte(i3 + i)) {
                    return false;
                }
                if (i4 >= i2) {
                    break;
